          ...
          return (
            ...
            (e.prototype.renderer = function () {
              ...
              for (
                ...
                (n = i[t]), (r = new l.TrendLineRenderer()).setData(n), r.setHitTest(this._hitTestResult), e.append(r);
              return e;
            }),
              ...
              (this._data = []),
                ...
                !e ||
                  ...
                  (0 !== (i = this._provider.graphics().vertlines()).size &&
                    null !== (o = this._model.timeScale().visibleBarsStrictRange()) &&
                    ...
                    i.forEach(function (i, o) {
                      ...
                      if (B.visible.value())
                        for (u = 0, c = i; u < c.length; u++)
                          for (_ = (v = c[u]).indexes, w = 0, f = v.items; w < f.length; w++)
                            (T = _[(m = f[w]).index]) === s.REMOVE_INDEX_MAGIC_NUMBER ||
                              T < l ||
                              h < T ||
                              ((R = t.indexToCoordinate(T) + 1),
                              (g = m.extendBottom
                                ? e.height()
                                : e.priceToCoordinate(Object(n.ensureDefined)(m.startPrice), a)),
                              (y = m.extendTop ? 0 : e.priceToCoordinate(Object(n.ensureDefined)(m.endPrice), a)),
                              (E = new r.Point(R, g)),
                              (x = new r.Point(R, y)),
                              p._data.push({
                                points: [E, x],
