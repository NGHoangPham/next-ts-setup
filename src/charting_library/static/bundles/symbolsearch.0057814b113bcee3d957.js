  ...
  ['symbolsearch'],
  {
    ...
    m5UM: function (t, e, i) {
      ...
      (function (e) {
        ...
        var a, l, c, p, u, h, d, g, f, _, m, y, v, b, S, E, I, x, T, w, C, k, R, L;
        i('jgM0'),
          i('HBUj'),
          (a = i('PT1i').linking),
          (l = i('qdOW')),
          ...
          (L = (function () {
            function t(i) {
              ...
              for (
                ...
                M[o].immediate ? $(this._inputElement).on(M[o].name, n) : $(this._inputElement).on(M[o].name, s);
            ...
            return (
              ...
              (t.registerAutoFocus = function (e) {
                if ((e instanceof jQuery && (e = e.data('symbol-search-instance')), !(e instanceof t)))
                  throw new TypeError(
              ...
              (t.prototype._moveSelection = function (t, e) {
                var i, n, s, o, r, a, l, c;
                this.$list &&
                  ((n = (i = this.$list.find('table.symbol-edit-popup')).find('tr:not(.hidden)')),
                  (o =
                    0 !== (s = i.find('tr.symbol-edit-popup-active').removeClass('symbol-edit-popup-active')).length
                      ? n.index(s)
                      : -1) !== (r = 1 === t ? (s.get(0) === n.get(-1) ? 0 : o + t) : Math.max(-1, o + t)) &&
                    (a = n.get(r)) &&
                    ...
                    A.isRoot(l)
                      ...
                      : (delete this._selectedGroupRoot, this._highlightItem(l, !0, e))));
              }),
              ...
              (t.prototype._onKeyDown = function (t) {
                (t.keyCode !== g.DOWN_ARROW && t.keyCode !== g.UP_ARROW) ||
                  ...
                  !this._selectedGroupRoot ||
                    (t.keyCode !== g.LEFT_ARROW && t.keyCode !== g.RIGHT_ARROW) ||
                    (this._groupToggleCollapsed(this._selectedGroupRoot, t.keyCode === g.LEFT_ARROW),
                    t.preventDefault());
              }),
              (t.prototype._onKeyPress = function (t) {
                if (t.keyCode === g.DOWN_ARROW || t.keyCode === g.UP_ARROW) {
                  ...
                  this._moveSelection(t.keyCode === g.DOWN_ARROW ? 1 : -1), t.preventDefault();
                }
                t.keyCode === g.ENTER &&
                  (this._selectedGroupRoot
              ...
              (t.prototype._eventListener = function (t, i) {
                ...
                e.enabled('uppercase_instrument_names') && (c = c.toUpperCase()),
                  ...
                  (s = !1),
                  this._state.value !== c &&
                    (this._state.hasOwnProperty('value') && this._onValueChanged && this._onValueChanged(c),
                    (this._state.value = c),
                    (n = !0),
                    this._inputParserMixin && this._inputParserMixin.parse()),
                  this._fixIntervalCase(),
                  (o = this._limitInputSelectionValue('selectionStart')),
                  this._state.selectionStart !== o && ((this._state.selectionStart = o), (s = !0)),
                  (r = this._limitInputSelectionValue('selectionEnd')),
                  this._state.selectionEnd !== r && ((this._state.selectionEnd = r), (s = !0)),
                  this._state.selectionDirection !== l.selectionDirection &&
                    ((this._state.selectionDirection = l.selectionDirection), (s = !0)),
                  (n || (s && this._inputParserMixin)) &&
                    (this._onSelectionChanged(void 0, i),
                    (a = !1),
                    this._getInputValue() !== this._state.value && (this._setInputValue(this._state.value), (a = !0)),
                    (a ||
              ...
              (t.prototype._onSelectionChanged = function (t, e) {
                ...
                !o && (this._isSpreadInInput() || (this._inputParserMixin && !0 !== e))
                  ? this._inputParserMixin.onSelectionChanged(i)
                  : this.$list &&
                    ((this._state._selectedTicker = null),
                    (n = this._state.value),
                    this._isSpreadInInput() && this._state.contextToken && (n = this._state.contextToken.value),
                    i(n, this.getExchangeFilter(), this._state.typeFilter, n, this._state.tradableFilter));
              }),
              ...
              (t.prototype._doGetSuggestList = function () {
                ...
                this._clearSearchTimeout(),
                  ...
                  this._showLoading(),
                  (l = this),
                  ChartApiInstance.searchSymbols(e, i, n, a, N, !1, t, o, r, function (t) {
                    e !== (l._state.contextTicker || '') ||
                      i !== (l._state.contextExchange || l.getExchangeFilter() || '') ||
                      n !== (l._state.typeFilter || '') ||
                      (n === d.types.QUANDL && (t = l._processQuandlResponse(t)),
              ...
              (t.prototype._getSuggestList = function () {
                this._clearSearchTimeout(),
                  (this._searchTimeout = setTimeout(this._doGetSuggestList.bind(this), t.prototype.searchRequestDelay));
              }),
              ...
              (t.prototype._renderSuggestList = function (i) {
                ...
                if (this.$list)
                  if (
                    ...
                    (r = new RegExp(o.replace(' ', '|'), 'i' + (o.length > 1 ? 'g' : ''))),
                    ...
                    for (
                      (a = document.createElement('table')).setAttribute('class', 'symbol-edit-popup'),
                        l = {},
                      ...
                      (d = i[u]),
                        c.append(d),
                        p || d.ticker !== s.contextTicker || d.exchange !== s.contextExchange || (p = d),
                      ...
                      $(a)
                        .on('click', 'tr', function (t) {
                          if (!t.isDefaultPrevented()) {
                            ...
                            e &&
                              e.full_name &&
                              (n._isSpreadInInput() ? n._highlightItem(e, !0, !1) : n.accept(e.full_name, e.ticker));
                          }
                        })
                        .appendTo(this.$list);
                  } else
              ...
              (t.prototype._getElementByItem = function (t) {
                return this._renderedResponse && this.$list
                  ? this.$list.get(0).querySelector('tr[data-item-ticker="' + (t.ticker || t.full_name) + '"]')
                  : null;
              }),
              (t.prototype._highlightItem = function (t, e, i) {
                ...
                o.highlightedItem &&
                  ...
                  (s = this._getElementByItem(o.highlightedItem)) &&
                    ($(s).addClass('symbol-edit-popup-active'), this._scrollHighlightIntoView()),
              ...
              (t.prototype._replaceCurrentSymbol = function (t) {
                ...
                if (o.highlightedItem) {
                  if (
                    ...
                    if (!(s = this._inputParserMixin.replaceCurrentSymbol(e)).ok) return;
                    (i = s.newValue), (n = s.newCaretPos), (o.keepListFor = s.keepListFor);
                  } else
                    (this._state._selectedTicker = e.ticker || e.symbol),
                      (o.keepListFor = this._state._selectedTicker),
                      (n = (i = !0 === t && e.full_name && this._inputParserMixin ? e.full_name : e.symbol).length);
              ...
              (t.prototype._onResponse = function (t) {
                t.length > 0 && this._state.typeFilter === d.types.QUANDL && this._showNotification();
              }),
              (t.prototype._showNotification = function () {
                ...
                TVSettings.getBool('symboledit.show_quandl_notification', !0) &&
                  ((t =
                    ...
                    '</a>'),
                  (e = $('<div class="symbol-edit-notification">').prependTo(this.$list)).html(t),
              ...
              (t.prototype._getUnhideSymbolSearchGroups = function () {
                ...
                return (
                  i &&
                    ((t = i.metainfo().configFlags.supportUnhideSymbolSearchGroups),
              ...
              (t.createSuggestListRow = function (e, i, n, s) {
                ...
                return (
                  ...
                  (h = s.nameContent || u),
                  e.broker_symbol &&
                    (h = h + ' (' + (c ? e.broker_symbol.replace(i, '<strong>$&</strong>') : e.broker_symbol) + ')'),
                  (p.innerHTML = h),
                  ...
                  (d.innerHTML = !c || i.test(e.symbol) ? g : g.replace(i, '<strong>$&</strong>')),
                  ...
                  s.typeContent
                    ? (m = s.typeContent)
                    : (e.params && ~e.params.indexOf('eod') && (m = '<i class="eod">eod</i>&nbsp;'),
                      (y = r(n, e.type)),
                  ...
                  (b = v.getElementsByTagName('svg')[0]) && b.setAttribute('class', 'flag'),
                  a.appendChild(p),
                  a.appendChild(d),
                  a.appendChild(_),
                  a.appendChild(v),
              ...
              (t.showDialog = function (e) {
                ...
                if (((e = e || {}), (n = 'Symbol Search'), !_.get(n)))
                  return (
                    ...
                    _.positionDialog(s),
                    (r = (o = s.find('._tv-dialog-content').addClass('symbol-search-dialog')).find('.results')),
                    ...
                    a.focus(),
                    S() &&
                      (e.ignoreInterval || ((c = t.getInputValueGetter(a)), (p = t.getInputValueSetter(a))),
                      (l = SymbolSearchInputParserMixin.addSpreadActions(o.find('.spread-actions'), a, c, p))),
                    (u = new t({
                      input: a,
              ...
              (t.bindToInput = function (n, s) {
                ...
                return (
                  ...
                  (w = s.spreadActions && $(s.spreadActions).eq(0)) &&
                    w.size() &&
                    S() &&
                    (s.ignoreInterval || ((C = t.getInputValueGetter(n.get(0))), (k = t.getInputValueSetter(n.get(0)))),
                    (T = SymbolSearchInputParserMixin.addSpreadActions(w, n.get(0), C, k))),
                  (R = new t({
                    input: n,
                      ...
                      b ||
                        ...
                        (n = (function (t, e) {
                          var n,
                            ...
                            p,
                            u,
                            h = $('<div class="symbol-edit-popup">').appendTo(e),
                          ...
                          return (
                            ...
                            (r = 0),
                            (a = Math.max(0, Math.min(o.left + r, $(window).width() - h.outerWidth()))),
                            h.css('left', a + 'px'),
                        ...
                        b.on('click', '*', r),
                        b.on('mousedown', '*', r),
                        'function' == typeof s.onPopupOpen && s.onPopupOpen(n.popup)),
                    ...
                    callback: function (t, e) {
                      o(),
                        ('function' == typeof _ && _(t, e)) ||
                          ('function' == typeof d && d(t, e), 'function' == typeof f && f(t, e)),
                  ...
                  n.on('blur', function (t) {
                    ...
                    TradingView.isMobile.iOS() && F && ((F = !1), (A = !0)),
                      TradingView.isMobile.iOS() && A && null === t.relatedTarget
                        ? ((r = function (t) {
              ...
              (A.prototype.append = function (e) {
                  ...
                  for (
                    i = e.symbol,
                      ...
                      c = t.createSuggestListRow(e, this._tickerRegExp, this._translationCache, {
                        nameContent:
                          '<div>' + (N ? i : i.replace(this._tickerRegExp, '<strong>$&</strong>')) + '</div>',
                        typeContent: r(this._translationCache, e.type) + (e.exchange && ' - ' + o(e)),
                    ...
                    (a = e.contracts[s]),
                      (l = t.createSuggestListRow(a, this._tickerRegExp, this._translationCache)),
                ...
                (p = e.ticker || e.full_name), (this._itemsByTicker[p] = e), c.setAttribute('data-item-ticker', p);
              }),
              ...
              (t.detachStoreInterval = function (e) {
                ...
                return i ? ((D = i.detached), (P = b(D)), i.rest) : (t.resetStoredInterval(), e);
              }),
