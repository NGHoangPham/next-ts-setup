    ...
    cbq4: function (e, t, n) {
      ...
      function o(e) {
        return l.createElement(
          'tr',
          { className: _.row },
          l.createElement('td', null, l.createElement('div', { className: _.line })),
          l.createElement(
            'td',
            null,
            l.createElement('div', { className: _.line }),
            e.hint ? l.createElement('div', { className: _.hint }, e.hint) : null
          )
        );
      }
      function s(e) {
      ...
      var a, l, c, u, p, h, m, d, _, f, v, b, S, y, C, w, E, k, x, N, M, g, O, I, T, D, H, P, A, j;
      n.r(t),
        (a = n('mrSG')),
        (l = n('q1tI')),
        (c = n('i8i4')),
          ...
          function t() {
            ...
            return (
              (t._handleMouseOver = function (e) {
                ...
                void 0 === (s = o && o.firesTouchEvents) && (s = Modernizr.touch),
                s) ||
            ...
            (t.prototype.render = function () {
              return l.createElement(
                ...
                l.createElement(
                  ...
                  l.createElement('td', { className: m(f.iconCell), 'data-icon-cell': !0 }, this._icon()),
                  l.createElement(
                    'td',
                    null,
                    l.createElement(
                      ...
                      l.createElement(
                        'span',
                        {
                          className: m(f.label, this.props.checked && f.checked),
                          'data-label': !0,
                        },
                        this.props.label
                      ),
                      ...
                      !this.props.hasSubItems && this.props.shortcutHint
                        ? l.createElement('span', { className: f.shortcut }, this.props.shortcutHint)
                        : null
                    )
                  )
                ),
                l.createElement('tr', { className: f.subMenu }, l.createElement('td', null, this.props.children))
              );
            }),
            ...
            (t.prototype._toolbox = function () {
              return this.props.toolbox
                ? l.createElement(
                    'span',
                    {
                      className: m(f.toolbox, this.props.showToolboxOnHover && f.showToolboxOnHover),
            ...
            return (
              ...
              (n._handleClick = function (e) {
                e.isDefaultPrevented() ||
                  ...
                  (n._hasSubItems()
                    ? n._showSubMenu()
                    : (n.state.doNotCloseOnClick || Object(k.b)(), n.props.action.execute(), n._trackEvent()));
              }),
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e = this.props,
                ...
                s = e.parentStatName,
                r = a.__rest(e, ['isOpened', 'onClose', 'items', 'doNotCloseOn', 'menuStatName', 'parentStatName']);
              return t
                ? l.createElement(
                    p.a,
                    {
        ...
        (j = (function () {
          ...
          return (
            ...
            (e.prototype.hide = function () {
              (this._isShown = !1), this._render(a.__assign({}, this._props, { isOpened: !1 }));
            }),
            ...
            (e.prototype.destroy = function () {
              (this._isShown = !1),
                this._root &&
                  (c.unmountComponentAtNode(this._root), document.body.removeChild(this._root), (this._root = null)),
    ...
    ntfI: function (e, t, n) {
      ...
      n.d(t, 'a', function () {
        ...
        (c = (function (e) {
          function t(t) {
            var n = e.call(this, t) || this;
            return (n._stateChangeTimeout = null), (n.state = { state: l.Initial }), n;
          }
          return (
            o.__extends(t, e),
            (t.prototype.render = function () {
