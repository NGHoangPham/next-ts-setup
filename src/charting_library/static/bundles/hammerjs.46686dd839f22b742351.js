    ...
    yLV6: function (t, e, i) {
      ...
      !(function (s, r, o, a) {
        ...
        function p(t, e, i) {
          var n,
            s = e.prototype;
          ((n = t.prototype = Object.create(s)).constructor = t), (n._super = s), i && et(n, i);
        }
        function f(t, e) {
          return function () {
        ...
        function S(t, e) {
          for (var i, n, s = e[0].toUpperCase() + e.slice(1), r = 0; r < he.length; ) {
        ...
        function w(t, e, i) {
          ...
          (i.isFirst = !!r),
            ...
            (function (t, e) {
              ...
              l > 1 && !u.firstMultiple ? (u.firstMultiple = P(e)) : 1 === l && (u.firstMultiple = !1);
              (i = u.firstInput), (n = u.firstMultiple), (s = n ? n.center : i.center), (r = e.center = D(c));
              (e.timeStamp = fe()),
              ...
              (e.overallVelocityX = o.x),
                ...
                (e.scale = n ? ((p = n.pointers), (f = c), R(f[0], f[1], wt) / R(p[0], p[1], wt)) : 1),
                (e.rotation = n
                  ? (function (t, e) {
                ...
                (function (t, e) {
                  ...
                  e.eventType != gt && (l > ft || c.velocity === a)
                    ? ((o = e.deltaX - c.deltaX),
                      ...
                      (r = O(o, h)),
                      (t.lastInterval = e))
                    : ((i = c.velocity), (n = c.velocityX), (s = c.velocityY), (r = c.direction));
        ...
        function D(t) {
          ...
          for (e = 0, i = 0, n = 0; n < s; ) (e += t[n].clientX), (i += t[n].clientY), n++;
        ...
        function O(t, e) {
          return t === e ? Tt : pe(t) >= pe(e) ? (t < 0 ? yt : Et) : e < 0 ? It : At;
        }
        function R(t, e, i) {
          i || (i = Ct);
          var n = e[i[0]] - t[i[0]],
        ...
        function z() {
          (this.evEl = Dt), (this.evWin = xt), (this.pressed = !1), C.apply(this, arguments);
        }
        function N() {
          (this.evEl = Mt),
            (this.evWin = zt),
        ...
        function L(t) {
          return t & ie ? 'cancel' : t & te ? 'end' : t & Qt ? 'move' : t & Kt ? 'start' : '';
        }
        function H(t) {
          return t == At ? 'down' : t == It ? 'up' : t == yt ? 'left' : t == Et ? 'right' : '';
        }
        function V(t, e) {
          var i = e.manager;
          return i ? i.get(t) : t;
        ...
        function K(t, e) {
          return ((e = e || {}).recognizers = v(e.recognizers, K.defaults.preset)), new Q(t, e);
        }
        function Q(t, e) {
          var i;
          (this.options = et({}, K.defaults, e || {})),
            ...
            (this.oldCssProps = {}),
            (this.element = t),
            (this.input = new ((i = this).options.inputClass || (at ? N : ht ? Y : ot ? F : z))(i, w)),
        ...
        function tt(t, e) {
          ...
          n.style &&
            (c(t.options.cssProps, function (s, r) {
              (i = S(n.style, r)),
                e ? ((t.oldCssProps[i] = n.style[i]), (n.style[i] = s)) : (n.style[i] = t.oldCssProps[i] || '');
            }),
            e || (t.oldCssProps = {}));
        }
        var et,
        ...
        (et =
          'function' != typeof Object.assign
            ? function (t) {
                ...
                for (e = Object(t), i = 1; i < arguments.length; i++)
                  if ((n = arguments[i]) !== a && null !== n) for (s in n) n.hasOwnProperty(s) && (e[s] = n[s]);
                return e;
              }
            : Object.assign),
          (it = l(
          ...
          s.MSPointerEvent &&
            !s.PointerEvent &&
            ((Mt = 'MSPointerDown'), (zt = 'MSPointerMove MSPointerUp MSPointerCancel')),
          p(N, C, {
            handler: function (t) {
              var e = this.store,
                i = !1,
              ...
              s & dt && (0 === t.button || o) ? a < 0 && (e.push(t), (a = e.length - 1)) : s & (mt | gt) && (i = !0),
                a < 0 ||
                  ((e[a] = t),
              ...
              i === dt && (this.started = !0),
                this.started &&
                  ((e = function (t, e) {
                    ...
                    return e & (mt | gt) && (i = b(i.concat(n), 'identifier', !0)), [i, n];
                  }.call(this, t, i)),
                  i & (mt | gt) && e[0].length - e[1].length == 0 && (this.started = !1),
              ...
              var e = Ft[t.type],
                i = function (t, e) {
                  var i,
                    ...
                    a = A(t.touches),
                    h = this.targetIds;
                  if (e & (dt | vt) && 1 === a.length) return (h[a[0].identifier] = !0), [a, a];
                  if (
                  ...
                  for (i = 0; i < s.length; )
                    h[s[i].identifier] && r.push(s[i]), e & (mt | gt) && delete h[s[i].identifier], i++;
                  return r.length ? [b(n.concat(r), 'identifier', !0), r] : void 0;
                }.call(this, t, e);
              i &&
                this.callback(this.manager, e, {
                  pointers: i[0],
          ...
          (k.prototype = {
            set: function (t) {
              t == Vt && (t = this.compute()),
                Ht && this.manager.element.style && Bt[t] && (this.manager.element.style[Lt] = t),
            ...
            compute: function () {
              ...
              return (
                ...
                (function (t) {
                  ...
                  return y(t, Gt)
                    ? Gt
                    : ((e = y(t, Jt)), (i = y(t, Zt)), e && i ? Gt : e || i ? (e ? Jt : Zt) : y(t, jt) ? jt : Ut);
                })(t.join(' '))
              );
            },
            preventDefaults: function (t) {
              ...
              if (this.manager.session.prevented) h.preventDefault();
                ...
                (s = y(e, Jt) && !Bt[Jt]),
                !(
                  (i && ((r = 1 === t.pointers.length), (o = t.distance < 2), (a = t.deltaTime < 250), r && o && a)) ||
                  (s && n)
                ))
              )
                return i || (n && u & bt) || (s && u & St) ? this.preventSrc(h) : void 0;
            },
          ...
          (q.prototype = {
            ...
            dropRecognizeWith: function (t) {
              return u(t, 'dropRecognizeWith', this) ? this : ((t = V(t, this)), delete this.simultaneous[t.id], this);
            },
            requireFailure: function (t) {
              if (u(t, 'requireFailure', this)) return this;
              var e = this.requireFail;
              return -1 === I(e, (t = V(t, this))) && (e.push(t), t.requireFailure(this)), this;
            },
            ...
            recognize: function (t) {
              var e = et({}, t);
              if (!d(this.options.enable, [this, e])) return this.reset(), void (this.state = ne);
          ...
          p(U, q, {
            ...
            process: function (t) {
              var e = this.state,
                ...
                n = e & (Kt | Qt),
                s = this.attrTest(t);
              return n && (i & gt || !s) ? e | ie : n || s ? (i & mt ? e | te : e & Kt ? e | Qt : Kt) : ne;
            },
          }),
          p(j, U, {
            defaults: {
            ...
            directionTest: function (t) {
              ...
              return (
                s & e.direction ||
                  (e.direction & bt
                    ? ((s = 0 === r ? Tt : r < 0 ? yt : Et), (i = r != this.pX), (n = Math.abs(t.deltaX)))
                    : ((s = 0 === o ? Tt : o < 0 ? It : At), (i = o != this.pY), (n = Math.abs(t.deltaY)))),
                (t.direction = s),
            ...
            attrTest: function (t) {
              return (
                U.prototype.attrTest.call(this, t) && (this.state & Kt || (!(this.state & Kt) && this.directionTest(t)))
              );
            },
            emit: function (t) {
          ...
          p(G, U, {
            ...
            attrTest: function (t) {
              return (
                ...
                (Math.abs(t.scale - 1) > this.options.threshold || this.state & Kt)
              );
            },
            emit: function (t) {
              if (1 !== t.scale) {
          ...
          p(J, q, {
            ...
            process: function (t) {
              ...
              if (((this._input = t), !n || !i || (t.eventType & (mt | gt) && !s))) this.reset();
          ...
          p(Z, U, {
            ...
            attrTest: function (t) {
              return (
                this._super.attrTest.call(this, t) && (Math.abs(t.rotation) > this.options.threshold || this.state & Kt)
              );
            },
          }),
          p(B, U, {
            ...
            process: function (t) {
              ...
              if (r && o && s) {
                ...
                if (
                  ...
                  (i = !this.pCenter || R(this.pCenter, t.center) < n.posThreshold),
          ...
          (Q.prototype = {
              ...
              if (!r.stopped)
                for (
                  this.touchAction.preventDefaults(t),
                    i = this.recognizers,
                    (!(n = r.curRecognizer) || (n && n.state & ee)) && (n = r.curRecognizer = null),
                    s = 0;
                  s < i.length;

                )
                  (e = i[s]),
                    r.stopped === re || (n && e != n && !e.canRecognizeWith(n)) ? e.reset() : e.recognize(t),
            ...
            get: function (t) {
              ...
              for (e = this.recognizers, i = 0; i < e.length; i++) if (e[i].options.event == t) return e[i];
              return null;
            },
            add: function (t) {
          ...
          ((void 0 !== s ? s : 'undefined' != typeof self ? self : {}).Hammer = K),
          (n = function () {
            return K;
