    ...
    APlX: function (t, e, o) {
      ...
      (function (t) {
        function n(t) {
          ...
          if (((e = {}), null != t)) for (o in t) Object.prototype.hasOwnProperty.call(t, o) && (e[o] = t[o]);
          ...
          (e.TVModal = (function (e) {
            function o() {
              ...
              return (
                ...
                })(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, i({}, b, r)))).$overlay = $(
                  t.options.overlayTemplate
                )),
                ...
                t.on('error', function (e, o) {
                  t.$modalWrap[0].getBoundingClientRect().height < t.$content[0].getBoundingClientRect().height &&
                      ...
                      return (
                        ...
                        (t = function () {
                          e.focus(),
                            ...
                            $(e.$wrap)
                              .append(e.$overlay.addClass('i-hidden i-closed').css('z-index', e.zIndex))
                              .append(e.$modalWrap.addClass('i-hidden i-closed').css('z-index', e.zIndex)),
                            e.$overlay.removeClass('i-hidden'),
                            setTimeout(function () {
                              e.$overlay.removeClass('i-closed');
                            }, 20),
                            e.options.ajax.url ? (e.ajaxRequest = $.ajax(e.options.ajax)) : e.showContent();
                        }),
                        c.default.isSafari
                          ? setTimeout(function () {
                              return t();
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.opened)
                      return (
                        (this.opened = !1),
                        this._shortCutsLockId && h.enable(this._shortCutsLockId),
                        this._keyboardBinderLockId && g.enable(this._keyboardBinderLockId),
          ...
          function e() {
            ...
            return (
              ...
              ((t = (function (t, e) {
                if (!t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                return !e || ('object' != typeof e && 'function' != typeof e) ? t : e;
              })(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, n({}, f, i)))).$scrollWrap =
                t.$content.hasClass(g) ? t.$content : t.$content.find('.' + g)),
              t.$scrollWrap.length
              ...
              t.options.withScroll &&
                ((t.scroll = new u.SidebarCustomScroll(t.$scrollWrap, t.$scrollWrapInner)),
                    ...
                    : ((this.opened = !0),
                      ...
                      this.$el
                        ...
                        .css(
                          ...
                          (o = s.$el.height()),
                          (n = s.$el.width()),
                          (i = s.options.position) || (i = { top: t / 2 - o / 2, left: e / 2 - n / 2 }),
                          i.top > t - o && (i.top = t - o),
                      ...
                      this._doOpenAnimation().then(function () {
                        s.opened &&
                          ...
                          s.options.draggable &&
                            ...
                            s.$el.find('.js-dialog__drag').addClass('tv-dialog__grab')),
                          s.trigger('afterOpen', [s]));
                      }),
                      h.on('resize.tv-popup-' + this.getDialogId(), function () {
                ...
                value: function () {
                  ...
                  this.$scrollWrap.css({ height: '' }).removeClass('i-scrollable'),
                    ...
                    (this.options.height || t.height > s) &&
                      ((s -= o.height - i.height) < 60 && (s = 60), this.$scrollWrap.css({ height: s })),
                    ...
                    this.$actions && this.$actions.toggleClass('tv-dialog__section--actions_with-border', e);
                },
              },
              {
                key: 'updateScroll',
              ...
              if (Symbol.iterator in Object(t))
                return (function (t, e) {
                  ...
                  try {
                    for (
                      o = t[Symbol.iterator]();
                      !(s = (n = o.next()).done) && (i.push(n.value), !e || i.length !== e);
                      s = !0
                    );
                  } catch (t) {
                    (r = !0), (a = t);
          ...
          (k = (function (e) {
            function o() {
              var e,
                ...
                T,
                j,
                x = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
              if (
                ((function (t, e) {
                  if (!(t instanceof e)) throw new TypeError('Cannot call a class as a function');
                })(this, o),
                ((e = (function (t, e) {
                  if (!t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                  return !e || ('object' != typeof e && 'function' != typeof e) ? t : e;
                })(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this))).manager = (0, h.getRootOverlapManager)(
                  x.ownerDocument
                )),
                (e._id = f++),
                (e.loadingActions = []),
                ...
                (n = !0), (i = !1), (a = void 0);
                try {
                  for (l = Object.entries(e.options.dataset)[Symbol.iterator](); !(n = (c = l.next()).done); n = !0)
                    (u = c.value),
                      (v = (p = s(u, 2))[0]),
                      'string' == typeof (k = p[1]) && e.el.setAttribute('data-' + v, k);
                } catch (t) {
                  (i = !0), (a = t);
                } finally {
                  try {
                  ...
                  e.actions = {},
                    ...
                    C = function (o) {
                      ...
                      c.type || (c.type = 'default'),
                        c.class || (c.class = m[c.type] ? m[c.type] : m.default),
                        'checkbox' === c.type
                          ? ((n = new d.default({
                              labelRight: c.text,
                              name: c.name,
                          ...
                          : (e.actions[c.name] = $(
                              t.render(c.template ? c.template : w[c.type] || w._default, c, c)
                            ).appendTo(e.$actions)),
                        c.method && 'function' == typeof e[c.method] && e.on('action:' + c.name, e[c.method].bind(e)),
                            ...
                            ? ((s = []),
                              ...
                              (a = function (t) {
                                ...
                                -1 !== r.indexOf(o) && s.indexOf(o) && s.push(o),
                                  e._focused && s.length === r.length && ((s = []), e.actionDispatcher(c.name));
                              }),
              ...
              return (
                ...
                e.options.closeButton &&
                  ((T = $(e.options.closeButtonTemplate)).addClass(e.options.closeButtonAddClass || ''),
                  (j = e.$el),
                  1 === e.$el.find('.js-close-button-place').length && (j = e.$el.find('.js-close-button-place')),
                  T.appendTo(j)),
                ...
                e.on('afterOpen', function () {
                  e.options.focusFirstControl &&
                    ...
                    (e.firstFocusControl || e.$el.find('input:not([type="hidden"]), textarea').first()).focus();
                }),
            ...
            return (
              ...
              a(o, [
                ...
                },
                {
                  ...
                  value: function () {
                    for (var t = g.length - 1; t >= 0; t--)
                      g[t].zIndex > this.zIndex && g[t].setZIndex(g[t].zIndex - 1);
                    return this.setZIndex(b + g.length), this.manager.moveToTop(this._id), this;
                  },
                },
                {
                  key: 'isEventOut',
                ...
                },
                {
                  key: 'destroy',
                  value: function () {
                    (this.$wrap = null), this.manager.unregisterWindow(this._id), (g = n.without(g, this));
