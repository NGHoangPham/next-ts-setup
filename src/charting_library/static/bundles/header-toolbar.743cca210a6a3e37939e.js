(window.webpackJsonp = window.webpackJsonp || []).push([
  ['header-toolbar'],
  {
    ...
    KMbc: function (e, t, a) {
        ...
        return s.createElement(
          'div',
          {
            className: u(
              n,
              w.group,
              ((t = {}), (t[w.noMinimalWidth] = i), (t[w.noLeftDecoration] = o), (t[w.noRightDecoration] = r), t)
            ),
            onClick: l,
          },
          a
      ...
      function o(e) {
        return s.createElement(M.a, i.__assign({}, e, { forceInteractive: !0, icon: A }));
      }
      function r(e) {
        return s.createElement(
          'div',
            ...
            return (
              ...
              (o._fixLastGroup = function (e, t, a) {
                if (t === a.length - 1 && s.isValidElement(e) && e.type === n) {
                  var r = void 0 !== o.context.tools.Publish && !o.props.readOnly;
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return s.createElement(
                          ...
                          !m &&
                            s.Children.toArray(
                              [
                                i.SymbolSearch &&
                                  s.createElement(
                                    ...
                                    s.createElement(i.SymbolSearch, {
                                      ...
                                      isActionsVisible: c.allowSymbolSearchSpread,
                                      isExpanded: 2 === A,
                                ...
                                i.DateRange && s.createElement(n, { key: 'range' }, s.createElement(i.DateRange, null)),
                                i.Intervals &&
                                  1 === A &&
                                  s.createElement(
                                    n,
                                ...
                                i.ScalePercentage &&
                                  s.createElement(n, { key: 'percentage' }, s.createElement(i.ScalePercentage, null)),
                                i.ScaleLogarithm &&
                                  s.createElement(n, { key: 'logarithm' }, s.createElement(i.ScaleLogarithm, null)),
                              ].concat(I)
                            ),
                          1 === A
                            ? ((t = s.Children.toArray(
                                [
                                  m && s.createElement(n, { key: 'view-only-badge' }, s.createElement(r, null)),
                                  s.createElement(n, {
                                    key: 'gap',
                                  ...
                                  c.showLaunchInPopupButton &&
                                    i.OpenPopup &&
                                    s.createElement(n, { key: 'popup' }, s.createElement(i.OpenPopup, null)),
                                  !m &&
                                    i.Properties &&
                                    s.createElement(
                                      n,
                                  ...
                                  t = s.Children.map(t, function (t, a) {
                                    ...
                                    if (s.isValidElement(t))
                                      switch ([e - 1, e, e + 1].indexOf(a)) {
                                        case 0:
                                          (n = { noRightDecoration: !0 }), (t = s.cloneElement(t, n));
                                          break;
                                        case 1:
                                          (o = {
                                            noLeftDecoration: !0,
                                          ...
                                          break;
                                        case 2:
                                          (r = { noLeftDecoration: !0 }), (t = s.cloneElement(t, r));
                                      }
                                    return t;
                                  });
                                }),
                            ...
                            : [
                                s.createElement(n, {
                                  key: 'gap',
                                  className: u(F.fill, 2 === A && F.minimalPriority),
                                }),
                                s.createElement(
                                  n,
                                  { key: 'symbol-search-close' },
                                  s.createElement(o, {
                                    className: u(F.iconButton, F.symbolSearchClose),
                                  })
                                ),
                              ]
                        )
                ...
                i.Publish && !m && !M && s.createElement(i.Publish, { id: x.Publish })
              );
            }),
        ...
        (re = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (l._showScrollbarWhen = Object(c.ensureDefined)(t.allowedModes).slice(-1)),
              ...
              (r = (function (e) {
                ...
                var t = e.map(function (e) {
                  return te[e];
                }) || [y.STYLE_CANDLES, y.STYLE_RENKO, y.STYLE_KAGI, y.STYLE_PNF];
                return (
                  Object(f.isOnFeaturePage)() && !m.enabled('charting_library_base') && (t = []),
                  m.enabled('widget') && (t = [y.STYLE_BARS, y.STYLE_CANDLES, y.STYLE_AREA]),
                  t
                );
              ...
              (i = Object(G.mergeResolutions)(s, m.enabled('star_some_intervals_by_default') ? ae : [])),
              ...
              (l._features = {
                ...
                allowSymbolSearchSpread: m.enabled('header_symbol_search') && !m.enabled('charting_library_base'),
          ...
          return (
            ...
            (t.prototype.componentDidUpdate = function (e, t) {
              var a = this.state,
                n = a.isVisible,
                o = a.measureValid;
              n !== t.isVisible && (v.emit('toggle_header', n), this._negotiateResizer()), o || this._setDisplayMode();
            }),
            (t.prototype.render = function () {
              var e,
                t = this,
              ...
              return s.createElement(
                'div',
                {
                  className: u(ee.toolbar, ((e = {}), (e[ee.isHidden] = !h), e)),
            ...
            (t.prototype.addButton = function (e) {
              ...
              return (
                void 0 === e && (e = 'left'),
                (t = new P.a(0)),
                (a = $('<div class="apply-common-tooltip ' + ee.customButton + '">')[0]),
            ...
            (t.prototype._negotiateResizer = function () {
              this.props.resizerBridge.negotiateHeight(
                this.state.isVisible ? Z.HEADER_TOOLBAR_HEIGHT_EXPANDED : Z.HEADER_TOOLBAR_HEIGHT_COLLAPSED
              );
            }),
            (t.prototype._setDisplayMode = function () {
              ...
              -1 === s && (s = r.length - 1), (t = r[s]), this.setState({ measureValid: !0, displayMode: t });
            }),
            (t.childContextTypes = {
        ...
        (ie = (function () {
          function e(e, t) {
            ...
            (this._component = null),
              ...
              (this._container = e),
              l.render(s.createElement(re, i.__assign({}, t, { ref: this._handleRef })), this._container);
          }
          return (
    ...
    tU7i: function (e, t, a) {
      ...
      function n(e) {
        ...
        return r.createElement(
          ...
          m && p && r.createElement('div', { className: i('js-button-text', f.text) }, p),
          g,
          !m && p && r.createElement('div', { className: i('js-button-text', f.text) }, p)
        );
      }
