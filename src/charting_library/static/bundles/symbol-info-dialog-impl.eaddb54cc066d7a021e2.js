  ...
  ['symbol-info-dialog-impl'],
  {
    '1Z/g': function (e, t, n) {
      ...
      (function (e, i) {
        ...
        function l(e) {
          m || ((m = document.createElement('div')), document.body.appendChild(m)), h.render(g.createElement(S, e), m);
        }
        function a(e) {
          var t,
            n = d;
            ...
            return 0 === r.length
              ...
              : ((i = r.reduce(function (e, t) {
                  var n = t.sessionStartDayOfWeek(),
                    i = Math.floor((t.alignedStart() + t.length()) / N.minutesPerDay),
                    r = (function (e, t) {
                    ...
                    a = o ? w[n] : '',
                    c = l ? w[r] : '',
                    u = p(t.alignedStart()) + a + '-' + p(t.alignedStart() + t.length()) + c;
                  return e.push(u), e;
                }, [])),
                e.push(o + i.join(', ')),
                e);
        ...
        function s(e, t) {
          ...
          for (n = 0; n < t.length; n++)
            (i = t[n].propName) in e &&
              ...
              'minmove2' === i && e.minmove2 > 0 && !e.fractional && e.pricescale
                ? ((t[n].value = new y(e.pricescale / r).format(r / e.pricescale)), (t[n].title = $.t('Pip Size')))
          ...
          return (
            (function (e, t) {
              var n, i;
              for (n = 0; n < t.length; n++)
                void 0 === (i = t[n]).visibility || i.visibility(e) || (t.splice(n, 1), n--);
            })(e, t),
            o
          );
        }
        ...
        var m,
          ...
          _ = [N.MONDAY, N.TUESDAY, N.WEDNESDAY, N.THURSDAY, N.FRIDAY, N.SATURDAY, N.SUNDAY],
          ...
          return (
            ...
            (t.prototype.render = function () {
              return r.createElement(
                ...
                r.createElement(l.b, { onClose: this.props.onClose }, window.t('Symbol Info')),
                r.createElement(
                  l.a,
                  null,
                  r.createElement(u.a, {
                  ...
                  r.createElement('div', { className: a.content }, this._renderFields())
                )
              );
            }),
                ...
                ? this.props.fields.map(function (e) {
                    return r.createElement(
                      ...
                      r.createElement(
                        ...
                        r.createElement('span', { className: a.title }, e.title)
                      ),
                      r.createElement(
                        'div',
