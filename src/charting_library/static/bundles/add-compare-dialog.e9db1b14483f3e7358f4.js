      ...
      (function (t, a) {
        ...
        Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          (l =
            ...
            '" autocomplete="off">\n\t</div>'),
          (r = '<div class="tv-compare-tab__predefines js-compare-tab-predefines"></div>'),
          (s =
                ...
                },
                {
                  ...
                  value: function () {
                    function t(t) {
                      ...
                      setTimeout(function () {
                        $(e).is(':checked')
                          ? o._addCompareSymbol(t.data.symbol).then(function (t) {
                              t || $(e).attr('checked', !1);
                            })
        ...
        (e.AddCompareDialog = (function () {
          function t(e) {
            !(function (t, e) {
              ...
              (this._dialog = null),
              (this._compareTab = new n.CompareTab(this._chartWidgetCollection, this)),
              (this._addSymbolTab = new i.AddSymbolTab(this._chartWidgetCollection, this));
          }
          return (
            a(t, [
              {
