  ...
  [15],
  {
          ...
          (n = {
            ...
            createModalDialog: function (t, o) {
              ...
              return (
                ...
                o.width && n.modalDialog.find('._tv-dialog').css({ width: o.width }),
                o.content && n.modalDialog.find('._tv-dialog-content').html(o.content),
                (e = $('.fancybox-overlay')).length &&
                  ((i = e.css('z-index')), $('._tv-dialog-shadowbox').css('z-index', i + 1)),
                o.draggable &&
            ...
            createDialog: function (t, o) {
              var e, d, r, c, u, g;
              return n.isOpen(t)
                ? ((e = n.get(t)).find('._tv-dialog-content').html(''), e.data('new', !1), e)
                  ...
                  (g = {
                    start: function (t, o) {
                      ...
                      for (e = 0; e < n.dialogs.length; e++)
                        (i = n.dialogs[e].dialog.css('z-index')) > s && ((s = i), (l = n.dialogs[e].dialog));
                      o.helper.css('z-index', s), l.css('z-index', a);
                    },
                  }),
                  o.dragHandle ? (g.handle = o.dragHandle) : o.hideTitle || (g.handle = '._tv-dialog-title'),
              ...
              (e = e || {}),
                ...
                t
                  ? ((l = (s = t.prop('ownerDocument')).defaultView),
                    ...
                    (u = $(l).height()),
                    o && o.top && o.left
                      ? ((p = e.forcePosition ? o.left : Math.max(2, Math.min(c - d - 4, o.left)) + 'px'),
                        (g = e.forcePosition ? o.top : Math.max(2, Math.min(u - r - 4, o.top)) + 'px'))
                      : o && o.considerScroll
                      ? ((f = $(s)),
                        (p = Math.round((c - d) / 2 + f.scrollLeft()) + 'px'),
                        (g = Math.round((u - r) / 2 + f.scrollTop()) + 'px'))
                      : ((p = Math.round((c - d) / 2) + 'px'), (g = Math.round((u - r) / 2) + 'px')),
                    e.fadeIn
                      ? t.css({ left: p, top: g }).hide().fadeIn('fast')
                      : e.smooth
                      ? t.animate({ left: p, top: g })
                      : t.css({ left: p, top: g }))
                  : ((t = n.modalDialog), (a = t.find('._tv-dialog')), i(), a.resize(i));
            },
            applyHandlers: function (t, o) {
              ...
              (o = o || {}),
                ...
                t.find('._tv-dialog-title ._tv-dialog-title-close, .js-dialog-close').on('click', function (t) {
                  o.closeHandler && 'function' == typeof o.closeHandler ? o.closeHandler(t) : e();
                }),
                ...
                o.doNotCloseOnEsc ||
                  $(i).bind('keyup.hideDialog', function (o) {
                    if (27 === o.keyCode) return t ? n.destroy(t.data('title')) : n.destroy(), !1;
                  }),
            ...
            showMessage: function (t, o, e) {
              var i, a, s;
              o || (o = $('._tv-dialog')),
                (i = (e = e || {}).isError ? '_tv-dialog-error' : '_tv-dialog-message'),
                (s = (a = o.find('.' + i)).find('.message')),
                e.html ? s.html('string' == typeof e.html ? e.html : t) : s.text(t),
                s.css('width', o.width()).toggleClass('selectable', Boolean(e.selectable)),
                a
            ...
            isOpen: function (t) {
              for (var o = 0; o < n.dialogs.length; o++) if (n.dialogs[o].title === t) return !0;
              return !1;
            },
            get: function (t) {
              for (var o = 0; o < n.dialogs.length; o++) if (n.dialogs[o].title === t) return n.dialogs[o].dialog;
            },
              ...
              if (t && 'string' == typeof t)
                for (e = 0; e < n.dialogs.length; e++)
                  n.dialogs[e].title === t &&
                    ...
                    n.dialogs[e].dialog.find('.apply-common-tooltip').mouseout(),
                ...
                n.modalDialog &&
                  ...
                  (n.modalDialog = null));
              $(i).unbind('keyup.hideDialog'), $(i).unbind('keyup.confirmAndCloseDialog');
            },
    ...
    PVgW: function (t, o, e) {
      ...
      function i(t) {
        return (
          (t = Math.abs(t)),
          !Object(r.isInteger)(t) && t > 1 && (t = parseFloat(t.toString().replace(/^.+\./, '0.'))),
          0 < t && t < 1
            ? Math.pow(
                10,
                null === (i = String(t).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/))
                  ? 0
                  : ((o = i[1] ? i[1].length : 0), (e = i[2] ? parseInt(i[2], 0) : 0), Math.max(0, o - e))
              )
            : 1
        );
        var o, e, i;
      ...
      function n(t, o) {
        ...
        t.trigger('tvticker-beforechange'),
          ...
          (a = 0),
          (a = e.parser ? e.parser(t.val()) : Object(r.isInteger)(n) ? parseInt(t.val(), 10) : parseFloat(t.val())),
          isNaN(a) && (a = 0),
          (s = i(n)),
            ...
            this.each(function () {
              ...
              d ? (n = !0) : (d = { step: Number(l.data('step')) || 1 }),
                ...
                n ||
                  ...
                  (e = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(c).appendTo(o)),
                  (i = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(c).appendTo(o)),
                  ...
                  l.keydown(function (t) {
                    l.is(':disabled') ||
                      (38 === t.keyCode ? e.addClass('i-active') : 40 === t.keyCode && i.addClass('i-active'));
                  }),
                  l.keyup(function (t) {
                    l.is(':disabled') ||
                      (38 === t.keyCode
                        ? (a(l), e.removeClass('i-active'))
                        : 40 === t.keyCode && (s(l), i.removeClass('i-active')));
                  }),
                  l.mousewheel(function (t) {
                    t.deltaY * (t.deltaFactor / 100) > 0 ? e.click() : i.click();
                  }));
            })
          );
        });
              ...
              return (
                ...
                void 0 !== (e = this._windows.get(t))
                  ...
                  : (this.registerWindow(t),
                    ((i = this._document.createElement('div')).style.position = o.position),
