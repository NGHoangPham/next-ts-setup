            ...
            if (
              ...
              !1 !== e.withScroll &&
                (l = $('<div class="js-dialog__scroll-wrap tv-dialog__scroll-wrap">').append(
                  d.addClass('tv-dialog__scroll-wrap-inner')
                )),
              ...
              for (h = 0; h < e.tabs.length; ++h)
                d.append($('<div class="tv-tabbed-dialog__tab-page">').append(e.tabs[h].page));
            return (
              (p = e.tabStateSaveKey),
              (u = e.activeTab),
        ...
        (g = (function () {
            ...
            void 0 === i && (i = {}),
              ...
              Modernizr.mobiletouch ||
                ((this._elArrowLeft = this._findOrCreateElement(
                  ...
                  this._elTabs,
                  'append',
                  '<div class="' + (this._options.lArrowClass || '') + ' i-slided">' + f.leftArrow + '</div>'
                )),
                (this._elArrowRight = this._findOrCreateElement(
                  this._options.rArrowClass || '',
                  this._elTabs,
                  'append',
                  '<div class="' + (this._options.rArrowClass || '') + ' i-slided">' + f.rightArrow + '</div>'
                )),
          ...
          return (
            (t.prototype.getTabsArray = function () {
              ...
              if (!this._options.sliderClass) return Array.prototype.slice.call(s);
              for (t = [], e = 0; e < s.length; e++)
                (i = s[e]).classList.contains(this._options.sliderClass) || t.push(i);
              return t;
            }),
            ...
            (t.prototype.checkScrollArrows = function (t) {
                ...
                t.classList.remove('i-slided'),
                  $.Velocity &&
                    $.Velocity.animate(
                      t,
                      { translateX: '0%' },
                      { duration: o.dur / 2, easing: 'easeOutCubic', queue: !1 }
                    );
              }
              function i(e, i) {
              ...
              void 0 === t && (t = !1),
                ...
                this._elArrowLeft &&
                  (a >= n
                    ? e(this._elArrowLeft)
                    : (a <= n || this._elScrollWrap.scrollWidth <= r) && i(this._elArrowLeft, u.Left)),
                this._elArrowRight &&
                  (l - a > 1
                    ? e(this._elArrowRight)
                    : (a >= l || this._elScrollWrap.scrollWidth <= r) && i(this._elArrowRight, u.Right));
            }),
            ...
            (t.prototype.setActivePage = function (t, e, i) {
              ...
              if (-1 !== t && (t !== this.index() || i)) {
                var a = this.index();
                s(this.getTabsArray(), this._options.activeTabClass, this._options.inactiveTabClass),
                  s(this.getPagesArray(), this._options.activePageClass, this._options.inactivePageClass),
            ...
            (t.prototype.updateSlider = function (t, e, i) {
              ...
              this._options.noSlider ||
                ...
                (n = a.offsetLeft + parseInt(r.getPropertyValue('padding-left'))),
                (l = this._getElWidth(a)),
                (d = a.querySelector('.js-tabs__slider-pos')) &&
                  ((c = window.getComputedStyle(d)),
                  (n += parseInt(c.getPropertyValue('padding-left')) + d.offsetLeft),
                  (l -= l - this._getElWidth(d))),
                (i = i || -1 === t || (document.all && !window.atob))
                  ? ((this._elSlider.style.left = n + 'px'), (this._elSlider.style.width = l + 'px'))
                  : ((this._animating = !0),
                    s().then(function () {
                      $.Velocity.animate(
                        h._elSlider,
            ...
            (t.prototype.deselect = function (t) {
              ...
              return (
                this._options.activeTabClass && i && i.classList.remove(this._options.activeTabClass),
                (e = this.getElActivePage()),
                this._options.activePageClass && e && e.classList.remove(this._options.activePageClass),
            ...
            (t.prototype._findOrCreateElement = function (t, e, i, s) {
              ...
              if (!n)
                if (
                  (((a = document.createElement('div')).innerHTML = s || '<div class="' + t + '"></div>'),
                  ...
                  for (o = Array.prototype.slice.call(e.childNodes), r = 0; r < o.length; r++) n.appendChild(o[r]);
                  e.appendChild(n);
                }
              return n;
            }),
            ...
            (t.prototype._bindEvents = function () {
              ...
              this.getTabsArray().forEach(this._bindTabEvents.bind(this)),
                      ...
                      p.IS_RTL && i.reverse(),
                        ...
                        s().then(function () {
                          $.Velocity.animate(e._elScrollWrap, 'scroll', {
                            ...
                            offset: Math.floor(a - n - e._getElWidth(e._elArrowLeft)),
                            queue: !1,
                          });
                        });
                    },
                ...
                this._elArrowRight &&
                  this._bindOneEvent({
                    ...
                    listener: function (t) {
                      var i = e.getTabsArray(),
                        r = 0,
                        n = p.IS_RTL ? 0 : e._elScrollWrap.scrollLeft + e._getElWidth(e._elScrollWrap);
                      p.IS_RTL && i.reverse(),
                        i.forEach(function (t) {
                          if (0 === r) {
                            var e = t.offsetLeft + t.offsetWidth;
                        ...
                        s().then(function () {
                          $.Velocity.animate(e._elScrollWrap, 'scroll', {
                            ...
                            duration: o.dur / 2,
                            easing: 'easeInOutCubic',
                            offset: Math.ceil(r - n + e._getElWidth(Object(a.ensureDefined)(e._elArrowRight))),
                            queue: !1,
                          });
                        });
                    },
                ...
                (t = Array.prototype.slice.call(this._elTabs.querySelectorAll('.js-tabs__slider-hover') || []))
                  .length &&
                  t.forEach(function (t) {
            ...
            (t.prototype._hoverSlider = function (t) {
              ...
              s().then(function () {
                $.Velocity.animate(i._elSlider, { left: n }, l), $.Velocity.animate(i._elSlider, { width: a }, l);
              }),
                (e = function () {
                  i.getElActiveTab() === t && i._unhoverSlider(t), t.removeEventListener('mousleave', e);
                }),
            ...
            (t.prototype._unhoverSlider = function (t) {
              ...
              s().then(function () {
                $.Velocity.animate(e._elSlider, { left: n }, c), $.Velocity.animate(e._elSlider, { width: d }, c);
              });
            }),
            t
          );
