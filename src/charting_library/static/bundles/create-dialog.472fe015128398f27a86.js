                ...
                function () {
                  ...
                  return (
                    void 0 === v &&
                      ...
                      ((i = document.createElement('div')).style.width = '100%'),
                      t.appendChild(i),
                      (o = i.offsetWidth),
                ...
                t && 1 == ++c
                  ? ('hidden' !== $(document.body).css('overflow').toLowerCase() &&
                      ...
                      l
                        .css(
                          'padding-right',
                          parseInt(l.css('padding-right').replace('px', '')) + d.getScrollbarWidth() + 'px'
                        )
                        .data('wasScroll', !0)),
                  ...
                  : !t &&
                    ...
                    l.data('wasScroll') &&
                      ...
                      l.css('padding-right', (i < 0 ? 0 : i) + 'px').data('wasScroll', void 0)));
              },
            },
              ...
              var e,
                ...
                a =
                  ...
                  (i = h) === 1 / 0
                    ...
                    : window.matchMedia('(min-width: ' + e + 'px) and (max-width: ' + i + 'px)'));
              a.matches && n(o),
              ...
              return (
                ...
                void 0 !== (i = this._windows.get(t))
                  ...
                  : (this.registerWindow(t),
                    ((o = this._document.createElement('div')).style.position = e.position),
      ...
      (function (t) {
        function o(e, i, o) {
          ...
          this._$wrapper.css('overflow', 'hidden'),
            ...
            (n = this._options.additionalClass ? ' ' + this._options.additionalClass : ''),
            (r = this._options.alwaysVisible ? ' active-always' : ''),
            (this._$scrollBarWrapper = $('<div class="sb-scrollbar-wrap">').appendTo(this._$wrapper)),
            (this._$scrollBar = $('<div class="sb-scrollbar sb-scrollbar-body' + n + r + '"></div>').appendTo(
        ...
        i('nzny'),
          ...
          (o.prototype.updateScroll = function () {
            ...
            return this._touch
              ? this
              : ((t = 1),
                (e = Math.ceil(this._$scrollBar.position().top - this._scroll_margin_top - this._header_height)),
                (i = this.getContainerHeightWithoutHeader()),
                (s = (o = this._$content.outerHeight()) - i - t),
                i <= 0
                  ? this
                  : ((this._scroll_target_top =
                      s <= 0 ? this._header_height : Math.min((-e * o) / i + this._header_height, this._header_height)),
          ...
          (o.prototype.scroll = function (t, e) {
            ...
            return (
              n <= 0 ||
              ((this._scroll_target_top = Math.max(-n + this._header_height, Math.min(this._header_height, i + t * r))),
          ...
          (o.prototype.animateTo = function (t) {
            ...
            return this._touch
              ? this
              : (e = this._$content.outerHeight() - this.getContainerHeightWithoutHeader() - 1) <= 0 ||
          ...
          (o.prototype.scrollTo = function (t, e) {
            ...
            if (
              ...
              this._$content.outerHeight() - (o = this.getContainerHeightWithoutHeader()) - 1 <= 0)
            )
              return !0;
            if (((n = (s = -1 * (i - this._header_height)) + o), (r = 0), 'visible' === e.position)) {
