            ...
            function t(e) {
              ...
              !(function (t, e) {
                ...
                (e.data('scroll') || i.scroll) &&
                  ...
                  (this.scroll = new n.SidebarCustomScroll(this.$scroll, this.$inScroll, {
                    showTopShadow: !1,
                    showBottomShadow: !1,
                  })),
                ...
                (e.data('adaptOnlyInScrollHeight') || i.adaptOnlyInScrollHeight) &&
              ...
              i(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (((p += _), (p += e = parseFloat(d.css('padding-bottom'))), this._adaptOnlyInScrollHeight))
                      return (
                        (i = (o = d.find('.js-dropdown-dummy'))
                          ? parseFloat(o.css('padding-bottom')) + parseFloat(o.css('margin-bottom'))
                          : 0),
                        (s = h.top + h.height + i),
                        void this.$el.find('.tv-dropdown-behavior__scroll').css('maxHeight', u - e - s - c)
                      );
                    (n = h.top + p + c <= u),
                      (r = p + a <= h.bottom),
                      (l = void 0),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.$body.css('marginLeft', 0),
                      ...
                      ((o = this.$body.offset()).right = o.left + this.$body.outerWidth()),
      ...
      o('sgSB'),
        ...
        (i.prototype.getIcon = function (t) {
          ...
          return null !== t && 'loadSvg' === t.type
            ? null === this._icons
              ? null
              : ((e = t.svgId.split('.')), (o = this._icons[e[0]][e[1]]) ? { type: 'svg', svgCode: o } : null)
            : t;
        }),
        ...
        (i.prototype._showSpinner = function () {
          (this.spinner = new r().spin(this._$tabContainer.get(0))), this._$contentWrapper.css('visibility', 'hidden');
        }),
        ...
        (i.prototype._onSourceRemoved = function (t) {
          void 0 !== t && (this._removeSourceFromView(t), this._scroll.updateScrollBar());
        }),
      ...
      (function (e, i) {
        function s(t) {
          this._$filter = $(e.render(n, { filters: this._getActions() }))
            ...
            .tvDropdown();
          var o = this;
          this._$filter.on(Modernizr.mobiletouch ? 'touchend' : 'click', '.js-dropdown-item', function (t) {
          ...
          (s.prototype.applyToGroup = function (t) {
            ...
            for (e = [], o = 0; o < t.length; o++)
              (i = t[o]),
                ...
                (n = TradingView.isInherited(i.datasource.constructor, 'drawings' === this._value ? r : a)),
                (!s && n) || e.push(i);
            return e;
          }),
        ...
        o('fe7E'),
          ...
          (i.prototype.getSourceProperties = function () {
            ...
            for (t = 0; t < this._model.panes().length; t++) {
              for (o = [], i = (e = this._model.panes()[t]).orderedSources(), s = 0; s < i.length; s++)
                (n = i[s]).showInObjectTree() && o.push({ datasource: n, name: n.title() });
        ...
        o('q8W4'),
          ...
          (s.prototype.activateItem = function (t, e, o) {
            (o && o.originalEvent.defaultPrevented) ||
              ...
              this._itemActivateCallback && this._itemActivateCallback(e ? [e] : []));
          }),
          ...
          (s.prototype._showContextMenu = function (t, o) {
            if (e.enabled('objects_tree_context_menu')) {
              var i = this._chartWidget.paneByState(this._chartModel.paneForSource(o));
    ...
    uaE4: function (t, e, o) {
      ...
      o('9IRQ'),
        ...
        (i.prototype._renderViewForSymbol = function (t, e, o) {
          ...
          if (t.next().hasClass(c)) return t.next().toggleClass('i-expanded', o), void this._scroll.updateScrollBar();
          for (i = $('<div class="i-expanded ' + c + '">'), s = this._symbolDrawingsMap[e], n = 0; n < s.length; ++n)
            (r = s[n]),
        ...
        (i.prototype._removeSourceFromView = function (t) {
          ...
          0 !== s.length
            ? (this._selectedSourceIds().includes(t) && this._listAccessor().activateItem(null, null),
            ...
            function (t, i) {
              ...
              if (o !== p) {
                for (
                  ...
                  (d = e[c]).datasource.id() === n ? (l = c) : d.datasource.id() === r && (a = c);
                for (
        ...
        (i.prototype._removeSourceFromView = function (t) {
          ...
          i &&
            ...
            this._selectedSourceIds().length &&
              i &&
              this._scroll.scrollTo(this._getItemForSourceId(this._selectedSourceIds()[0]));
        }),
        (i.prototype._removeSourcesFromView = function (t) {
          this._renderView(
            function () {
          ...
          for (this._reloadItems(), t = this._getItems().groups, e = 0; e < t.length; ++e)
            if ((o = t[e]).children.length)
              for (i = o.children.length - 1; i >= 0; --i)
                (s = o.children[i]),
                  0 !== (n = this._getItemForSourceId(s.datasource.id())).length &&
                    ((r = this.getIcon(s.datasource.getSourceIcon())), this._listAccessor().updateItem(n, s, r));
        }),
