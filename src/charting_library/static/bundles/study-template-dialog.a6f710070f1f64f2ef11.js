            ...
            !(function (e, t) {
              ...
              s &&
                this._checkboxView.$el.append(
                  '<span class="tv-rename-chart-dialog__hint apply-common-tooltip" title=\'' + s + "'></span>"
                );
          }
          return (
            o(e, [
    ...
    IDfV: function (e, t, n) {
      ...
      n.r(t),
        ...
        (h = {
          ...
          confirmDialog: {
            message: window.t("Study Template '{0}' already exists. Do you really want to replace it?"),
          },
        }),
        (m = (function () {
          function e(e) {
              ...
              return r.__awaiter(t, void 0, void 0, function () {
                ...
                return r.__generator(this, function (n) {
                  switch (n.label) {
                    case 0:
                      return (
                        (e = this._chartWidget.model().model().mainSeries().interval()),
                        [4, this._getActualTemplateList()]
                      );
                    case 1:
                      return (t = n.sent()), [4, this._showTemplateSaveRenameDialog(t, e)];
                    case 2:
                      return n.sent(), [2];
                  }
                });
                ...
                o = new s.SaveRenameDialog({
                  ...
                  confirm: {
                    ...
                    getMessage: function (e) {
                      return h.confirmDialog.message.format(Object(i.clean)(e[p]));
                    },
                  },
                });
    ...
    L0Sj: function (e, t, n) {
      ...
      function o(e) {
        var t,
          ...
          f = r.__rest(e, ['className', 'icon', 'clearable', 'onClear', 'size', 'strictLeftDirectionInput']),
          v = i(l.inputWrapper, (((t = {})[n] = Boolean(n)), (t[l.iconed] = Boolean(o)), (t[l.clearable] = p), t));
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e,
                ...
                E = i(
                  c.textInput,
                  this.props.strictLeftDirectionInput && l.textInputLeftDirection,
                  (((e = {})[c.error] = u), (e[c.success] = p), (e[c[d]] = Boolean(d)), e)
                ),
                k = i(c.inputWrapper, (((t = {})[y] = Boolean(y)), (t[c.grouped] = f), (t[c.column] = v), t)),
                S = [],
                O = a.createElement('input', r.__assign({ ref: g, className: E, key: 'textInput', style: b }, w));
              return (
                h &&
                  ((n = {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e = this.props,
                ...
                n = void 0 === t ? 'span' : t,
                a = o.__rest(e, ['click', 'handler', 'mouseDown', 'touchEnd', 'touchStart', 'ctor']);
              return r.createElement(n, o.__assign({}, a, { ref: this._handleScopeRef }));
            }),
            t
          );
        })(r.PureComponent));
    ...
    drvG: function (e, t, n) {
      ...
      function o(e) {
        var t,
          ...
          h = e.className,
          m = void 0 === h ? '' : h,
          f = c(m, s.caret, (((t = {})[s.caretRotate] = o), (t[s.caretSmall] = a), (t[s.caretColorTransition] = u), t));
          ...
          function t(t) {
            ...
            if (
              ...
              (n._handleCaretClick = function () {
                n.state.isOpened ? n._close() : n.props.preventOnFocusOpen ? n._open() : n._focus();
              }),
              (n._handleOutsideClick = function () {
                ...
                t && a !== o ? r && r(a) : n.setState(n._valueToQuery(o)), n._close();
              }),
                ...
                n.props.preventSearchOnEmptyQuery && '' === o
                  ...
                  : ((t = n._suggestions(o)),
                    n.setState({
                      ...
                      active: n.props.allowUserDefinedValues ? void 0 : n._getActiveKeyByValue(o),
                    }));
              }),
              (n._handleItemClick = function (e) {
                var t = e.currentTarget.id;
                n.setState({ queryValue: n._source()[t] }), n._close(), n.props.onChange && n.props.onChange(t);
              }),
              (n._handleKeyDown = function (e) {
                ...
                if (-1 !== _.indexOf(e.which))
                  switch (
                    ...
                    case p.a.DownArrow:
                    case p.a.UpArrow:
                      if (((d = Object.keys(u)), !c && d.length && e.which === p.a.DownArrow)) {
                      ...
                      if (((h = void 0), void 0 === s)) {
                        ...
                        h = 0;
                      } else h = d.indexOf(s) + (e.which === p.a.UpArrow ? -1 : 1);
                      h < 0 && (h = 0),
                        h > d.length - 1 && (h = d.length - 1),
                        (m = d[h]),
                        n.setState({ active: m }),
                        (f = document.getElementById(m)) && n._scrollIfNotVisible(f, n._suggestionsElement);
                      break;
                    case p.a.Escape:
                      n._close(), c || n._blur();
                      break;
                    case p.a.Enter:
                      (v = s),
                        o && (c && v ? n.setState(n._valueToQuery(v)) : (v = l)),
                        void 0 !== v &&
                          (n._close(), c || n._blur(), v !== r ? a && a(v) : n.setState(n._valueToQuery(v)));
                  }
              }),
            ...
            return (n.state = a.__assign({ isOpened: !1, active: t.value }, n._valueToQuery(t.value))), n;
          }
          return (
            a.__extends(t, e),
            (t.prototype.componentWillReceiveProps = function (e) {
              this.setState({
                queryValue: '' === e.value ? '' : this._source()[e.value] || this.state.queryValue,
                active: e.value,
              });
            }),
            (t.prototype.componentWillUnmount = function () {
            ...
            (t.prototype.render = function () {
              ...
              return i.createElement(
                ...
                i.createElement(l.a, {
                  rightComponent: Object.keys(this._suggestions(this.state.queryValue)).length
                    ? i.createElement(
                        'div',
            ...
            (t.prototype._renderSuggestions = function () {
              var e = this,
                ...
                n = Object.keys(t).map(function (n) {
                  var o,
                    r = c(d.suggestion, (((o = {})[d.selected] = e.state.active === n), o));
                  return i.createElement(
                    'li',
                    {
                      id: n,
                ...
                o = i.createElement('li', { className: d.noResults }, window.t('No results found'));
              return !n.length && this.props.noEmptyText
                ? null
                : i.createElement('ul', { className: d.suggestions, ref: this._setSuggestionsRef }, n.length ? n : o);
            }),
            ...
            (t.prototype._getActiveKeyByValue = function (e) {
              var t,
                ...
                c = Object.keys(s);
              for (t = 0, n = c; t < n.length; t++) if (i(e, s[(o = n[t])])) return o;
              return c[0];
            }),
          ...
          function e(t) {
            ...
            !(function (e, t) {
              ...
              (n = i.createElement(l.Autocomplete, {
                ...
                filter: function (e, t) {
                  return '' === e || (e && -1 !== t.toLowerCase().indexOf(e.toLowerCase()));
                },
              })),
          ...
          return (
            r(e, [
              ...
              },
              {
                key: 'select',
                value: function () {
                  this._autocompleteInput.focus(), this._autocompleteInput.select();
                },
              },
              {
                key: 'unmount',
