(window.webpackJsonp = window.webpackJsonp || []).push([
  ['lt-pane-views'],
  {
            ...
            (e.prototype.draw = function (e) {
              ...
              null === this._data ||
                ...
                this._data.fillBackground &&
                  ((e.fillStyle = Object(a.generateColor)(this._data.backcolor, this._data.transparency)), e.fill()),
                e.stroke());
            }),
                  ...
                  Object(r.distanceToSegment)(i, a, e).distance <= 3
                    ...
                    : ((o = this._data.points[2]),
                      Object(r.distanceToSegment)(a, o, e).distance <= 3
                        ...
                        ? new n.HitTestResult(n.HitTestResult.MOVEPOINT)
                        : this._data.fillBackground && Object(s.pointInTriangle)(i, a, o, e)
        ...
        (n.prototype._smoothArray = function (e, t) {
          ...
          for (i = 0; i < e.length; i++) {
            for (n = new r(0, 0), s = 0; s < t; s++)
              (a = Math.max(i - s, 0)), (o = Math.min(i + s, e.length - 1)), (n = (n = n.add(e[a])).add(e[o]));
            l[i] = n.scaled(0.5 / t);
          }
          ...
          return (
            ...
            i && this._source.finished()
              ? ((s = new l()).append(this._poligonRenderer),
                n.points.length > 0 &&
                  ((a = [n.points[0], n.points[n.points.length - 1]]), s.append(new o({ points: a }))),
                s)
          ...
          return (
            ...
            this._source.properties().showLabel.value() &&
              ...
              'right' === h
                ...
                : 'center' === h && (d.x = (d.x + this._model.timeScale().width()) / 2),
              'middle' === a ? (c = -this._source.properties().fontsize.value() / 6) : 'bottom' === a && (c = -4),
              (_ = {
                points: [d],
                text: s.text.value(),
    ...
    '2hKl': function (e, t, i) {
      ...
      function r(e, t, i, n, r) {
        var s,
          ...
          l,
          h,
          d = i.subtract(e).length() + n.subtract(i).length() + t.subtract(n).length(),
          c = 3 / d,
          p = 5;
        for (s = 0; s <= 1; s += c)
          if (
      ...
      function s(e, t, i, n, r) {
        ...
        for (s = 3 / _, a = 500, o = [], l = 1; l <= a * s; l += s)
          (h = e.scaled((1 - l) * (1 - l))),
            ...
            (c = t.scaled(l * l)),
            (p = h.add(d).add(c)),
            o.length > 0 && o[o.length - 1].subtract(p).length() < 2 && (s *= 2),
            o.push(p);
        return o;
      }
      i.r(t),
      ...
      function n(e, t, i, n) {
        ...
        return null !== e && null !== r
          ? Object(l.intersectPolygonAndHalfplane)(
              e,
              Object(s.halfplaneThroughPoint)(Object(s.lineThroughPoints)(t, i), r)
            )
          : null;
      }
      var r, s, a, o, l, h, d, c;
          ...
          return (
            ...
            (e.prototype._visiblePolygon = function () {
              ...
              return Object(s.equalPoints)(i, a) ||
                ...
                (Object(o.distanceToLine)(i, a, l).distance < 1e-6 && Object(o.distanceToLine)(i, a, h).distance < 1e-6)
                ? null
    ...
    '3xLB': function (e, t, i) {
      ...
      inherit(n, s),
        (n.prototype.renderer = function (e, t, i) {
          var n, s, a, o, l, p, f, g, v, w, y, m, x, b, R, S, T, P, L, C, B, k, O, I, M, A, D, E, V;
          return (
            this._invalidated && this._updateImpl(),
            (n = new h()),
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((a = (s = this._source.properties()).extendTop.value()),
                ...
                (C = ''),
                P && L && ((B = (L.valueOf() - P.valueOf()) / 1e3), (C = ', ' + u(new d().format(B)))),
                ...
                s.fillLabelBackground &&
                  ...
                  (v.backgroundTransparency = 1 - s.labelBackgroundTransparency.value() / 100 || 0)),
                s.drawBorder && s.drawBorder.value() && (v.borderColor = s.borderColor.value()),
                (M = 0.5 * (l.x + p.x)),
                (A = p.y),
                (D = new r(M, A)),
                ...
                (V = {
                  x: M + v.backgroundHorzInflate + E.textBgPadding - E.width / E.textBgPadding,
                  y:
                    l.y > p.y
          ...
          a.prototype._updateImpl.call(this),
            ...
            this._source.points().length < 3 ||
              ...
              this._source.properties().extendRight.value() &&
                (this._extendRightPoints = p.extendQuadroBezier(i, t, s, o, l)));
        }),
        (r.prototype.renderer = function (e, t, i) {
          var n, r, s, a;
          return (
            ...
            this._points.length < 2
              ...
              : ((n = [].concat(this._points)),
                this._source._controlPoint && n.push(this._source.pointToScreenPoint(this._source._controlPoint)[0]),
                (r = {}),
                (s = this._source.properties()),
                (r.points = n),
      ...
      (n.prototype.setData = function (e) {
        ...
        (n.prototype.hitTest = function (e) {
          ...
          return (
            ...
            l(e, o(t, t.add(new a(this._data.width, this._data.height)))) ? new d(d.MOVEPOINT) : null
          );
        }),
        ...
        (r.prototype.renderer = function () {
          ...
          if (
            ...
            if (((t = new p()).append(this._marksRenderer), this._anchorsOffset)) {
          ...
          return (
            ...
            this._points.length < 2
              ...
              : ((n = this._source.properties()),
                (r = new l()),
                (s = [this._points[0], this._points[1], this._points.length < 3 ? this._points[1] : this._points[2]]),
                (a = this),
                (o = function (e, t) {
                  return {
                    points: [e],
                ...
                this._points.length >= 4 &&
                  ...
                  (_ = o(p, this._numericFormatter.format(this._BCRetracement))),
          ...
          if (
            ...
            for (
              e = this._source.points()[0],
                ...
                i = this._source.points()[2],
                n = !1,
                (r = this._source.properties()).reverse && r.reverse.value() && (n = r.reverse.value()),
                this._levels = [],
            ...
            if (
              ...
              switch (_.horzLabelsAlign.value()) {
                case 'left':
                  ...
                  break;
                case 'center':
                  ((B = s.add(p).scaled(0.5)).x += C.width / 2), (B.x = Math.round(B.x));
                  break;
                case 'right':
                  _.extendLines.value()
                    ? (B = new r(m - 4, this._levels[R].y))
                    : (((B = new r(m + 4, this._levels[R].y)).x += C.width), (B.x = Math.round(B.x)));
              }
              (k = {
                left: C.left,
                ...
                'middle' === (I = _.vertLabelsAlign.value()) && (O.top -= O.height / 2),
      ...
      function n(e, t, i, n) {
        ...
        return null !== e && null !== r
          ? Object(d.intersectPolygonAndHalfplane)(
              e,
              Object(o.halfplaneThroughPoint)(Object(o.lineThroughPoints)(t, i), r)
            )
          : null;
      }
      function r(e, t, i) {
        return null !== e
          ? Object(d.intersectPolygonAndHalfplane)(
              e,
              Object(o.halfplaneThroughPoint)(((n = t), Object(o.line)(1, 0, -n)), new o.Point(i, 0))
            )
          : null;
        var n;
      }
          ...
          return (
            (e.prototype.setData = function (e) {
              ...
              e.points.length < 4 ||
                ...
                (Object(h.distanceToLine)(i, n, r).distance < 1e-6 && Object(h.distanceToLine)(i, n, s).distance < 1e-6)
                  ? (this._selectedRenderer = null)
                  : null !==
                    Object(d.intersectLines)(Object(o.lineThroughPoints)(i, n), Object(o.lineThroughPoints)(r, s))
          ...
          return (
            ...
            (e.prototype.hitTest = function (e) {
              ...
              for (t = 0, i = this._visiblePolygons(); t < i.length; t++)
                if (((n = i[t]), Object(l.pointInPolygon)(e, n)))
                  return new p.HitTestResult(p.HitTestResult.MOVEPOINT_BACKGROUND);
              return null;
            }),
            (e.prototype._visiblePolygons = function () {
              ...
              return _.width <= 0 || _.height <= 0
                ? []
                : null ===
                  (e = Object(d.intersectLines)(Object(o.lineThroughPoints)(f, g), Object(o.lineThroughPoints)(v, w)))
                ? []
                : ((i = []),
                  null !==
                    (r = n(
                  ...
                  null !==
                    (r = n(
                      (r = s((r = n((r = t), e, (c = g.subtract(f).add(e)), [(p = v.subtract(w).add(e)), p])), _)),
                      p,
                      e,
                      [c, c]
                    )) && i.push(r),
      ...
      (n.prototype.setData = function (e) {
        ...
        (n.prototype.hitTest = function (e) {
          ...
          for (
            ...
            if (
              ((p = (h * l) / (0.5 * Math.PI)),
              null !== (_ = ((_ = this._continiusFib(p + 4 * c)) * i.length()) / 5) && Math.abs(_ - d) < 5)
            )
          ...
          return (
            ...
            this._floatPoints.length < 2
              ...
              : (((r = {}).points = this._floatPoints),
                ...
                (r.linewidth = this._source.properties().linewidth.value()),
                (r.linestyle = this._source.properties().linestyle.value()),
                (r.counterclockwise = this._source.properties().counterclockwise.value()),
              ...
              3 === this._points.length &&
                ...
                s.isLog()
                  ...
                  : ((this._p3.y = this._source.priceScale().priceToCoordinate(i, a)),
                    (this._p4.y = this._source.priceScale().priceToCoordinate(n, a)))));
        }),
        (n.prototype.renderer = function (e, t, i) {
          var n, r, s, o, l;
          return (
            this._invalidated && this._updateImpl(),
            ((n = {}).points = []),
            this._points.length > 1 && (n.points.push(this._points[0]), n.points.push(this._points[1])),
            this._points.length > 2 &&
              null !== this._p3 &&
              null !== this._p4 &&
            ...
            i &&
              ...
              this._p3 && (o.push(this._p3.add(this._p4).scaled(0.5)), (o[o.length - 1].data = o.length - 1)),
    ...
    '9XXR': function (e, t, i) {
      ...
      function n(e, t) {
        ...
        return (
          ...
          (n = i.split('.'))[0].replace(/\B(?=(\d{3})+(?!\d))/g, t) + (n[1] ? '.' + n[1] : '')
        );
      }
      var r;
      i.r(t),
      ...
      (n.prototype.setData = function (e) {
        ...
        (n.prototype.drawTargetLabel = function (e) {
          ...
          if (
            ...
            (this._targetWidth = Math.max(d + c + p, _ + u + g + 2 * f) + 2 * t + 2 * n),
            (this._targetHeight = this._targetFontSize1 + this._targetFontSize2 + 3 * i + 2 * n),
            (w = (v = this._data.points[1]).x + this._targetWidth - e.canvas.width + 5),
            (this._targetRectLeftOffset = Math.max(20, Math.min(this._targetWidth - 15, w))),
            (S = 'up' === this._data.direction ? 'down' : 'up'),
            (T = this.drawBalloon(e, v, this._targetWidth, this._targetHeight, S, this._targetRectLeftOffset)),
            ...
            switch (((e.font = R(this._targetFontSize1, this._font, 'bold')), this._data.status)) {
              case m.AlertStatus.Success:
                (E = $.t('SUCCESS')),
                  (V = y.generateColor(this._data.successBackground, this._data.transparency)),
                  (N = this._data.successTextColor),
                  (z = this._data.successIcon);
                break;
              case m.AlertStatus.Failure:
                (E = $.t('FAILURE')),
                  (V = y.generateColor(this._data.failureBackground, this._data.transparency)),
            ...
            (H = this._targetFontSize1 + 4),
              ...
              'up' === this._data.direction
                ? (b(e, T.x - 1, T.y - H - 2, this._targetWidth + 2, H, 5),
                  ...
                  e.drawImage(z, T.x + F - z.width - 4, T.y - H - 2 + Math.abs(H - z.height) / 2))
                : (b(e, T.x - 1, T.y + this._targetHeight + 2, this._targetWidth + 2, H, 5),
                  e.fill(),
                  (e.fillStyle = N),
                  e.fillText(E, T.x + F + j, T.y + this._targetHeight + 5),
                  e.drawImage(z, T.x + F - z.width - 4, T.y + this._targetHeight + 10 - Math.abs(H - z.height) / 2)),
              e.restore();
          } else e.restore();
        }),
        (n.prototype.drawStartLabel = function (e) {
          ...
          e.save(),
            ...
            (this._sourceHeight = this._sourceFontSize1 + this._sourceFontSize2 + 3 * (t - 1) + 2 * n),
            (h = (l = this._data.points[0]).x + this._sourceWidth - e.canvas.width + 5),
            (this._sourceRectLeftOffset = Math.max(20, Math.min(this._sourceWidth - 15, h))),
            (d = this.drawBalloon(
              e,
              l,
              this._sourceWidth,
            ...
            (e.font = s),
            e.fillText(this._data.sourceLine2, p, _ + this._sourceFontSize1 + i),
            (u = 3),
            e.beginPath(),
        ...
        (n.prototype.targetLabelHitTest = function (e) {
          ...
          return void 0 === this._targetWidth || void 0 === this._targetHeight || void 0 === this._targetRectLeftOffset
            ? null
            : ((t = this._targetHeight + this._arrowHeight),
              ...
              (l = Math.min(a, o)),
              (h = Math.max(a, o)),
              e.x >= s && e.x <= s + this._targetWidth && e.y >= l && e.y <= h ? new c(c.MOVEPOINT) : null);
        }),
        (n.prototype.sourceLabelHitTest = function (e) {
          var t, i, n, r, s, a, o, l;
          return void 0 === this._sourceHeight || void 0 === this._sourceWidth || void 0 === this._sourceRectLeftOffset
            ? null
            : ((t = 'up' === this._data.direction ? 1 : -1),
              ...
              (o = Math.min(s, a)),
              (l = Math.max(s, a)),
              e.x >= r && e.x <= r + this._sourceWidth && e.y >= o && e.y <= l ? new c(c.MOVEPOINT) : null);
        }),
        (n.prototype.hitTest = function (e) {
          var t, i, n, r, s, a, o, l;
          return null === this._data || this._data.points.length < 2
        ...
        (r.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            (n.targetBackColor = this._source.properties().targetBackColor.value()),
            (n.targetStrokeColor = this._source.properties().targetStrokeColor.value()),
            (n.targetTextColor = this._source.properties().targetTextColor.value()),
            (n.sourceBackColor = this._source.properties().sourceBackColor.value()),
            (n.sourceStrokeColor = this._source.properties().sourceStrokeColor.value()),
            (n.sourceTextColor = this._source.properties().sourceTextColor.value()),
            (n.successBackground = this._source.properties().successBackground.value()),
            (n.successTextColor = this._source.properties().successTextColor.value()),
            (n.failureBackground = this._source.properties().failureBackground.value()),
            (n.failureTextColor = this._source.properties().failureTextColor.value()),
            (n.intermediateBackColor = this._source.properties().intermediateBackColor.value()),
            (n.intermediateTextColor = this._source.properties().intermediateTextColor.value()),
            ...
            (r = l(o(this._model._properties.paneProperties.background.value()), 150)),
            (n.centersColor = 'black' === r ? 'white' : 'black'),
            this._renderer.setData(n),
            i ? ((s = new p()).append(this._renderer), this.addAnchors(s), s) : this._renderer
          );
        }),
        (r.prototype._updateImpl = function () {
          ...
          h.prototype._updateImpl.call(this),
            ...
            this._source.points().length < 2 ||
              (this._source.priceScale() &&
                ...
                (this._targetLine1 = T(e.format(n) + ' (' + this._percentageFormatter.format(r) + ')')),
                (s = this._model.timeScale().indexToUserTime(i.index)),
                (a = this._model.timeScale().indexToUserTime(t.index)),
                i.time &&
                  t.time &&
                  ((s = TradingView.isString(i.time) ? new Date(Date.parse(i.time)) : i.time),
                  (a = TradingView.isString(t.time) ? new Date(Date.parse(t.time)) : t.time)),
                (o = this._model.mainSeries().isDWM()),
                (l = d.isSeconds(this._model.mainSeries().interval())),
                a &&
                  s &&
                  ((this._targetLine4 = new g().format(a)),
                  o || (this._targetLine4 = this._targetLine4 + '  ' + new v(l ? '%h:%m:%s' : '%h:%m').format(a)),
                  (c = (a.valueOf() - s.valueOf()) / 1e3),
                  (this._targetLine2 = $.t('in', { context: 'dates' }) + ' ' + P(new w().format(c)))),
                (this._sourceLine1 = e.format(i.price)),
                (this._sourceLine2 = ''),
                (p = this._model.timeScale().indexToUserTime(i.index)) &&
                  ((this._sourceLine2 = new g().format(p)),
                  o || (this._sourceLine2 = this._sourceLine2 + ' ' + new v(l ? '%h:%m:%s' : '%h:%m').format(p))),
          ...
          for (e.font = this.fontStyle(), r = [], s = 0; s < n.length; s++)
            if (((a = n[s]), (o = e.measureText(a).width) <= i)) r.push(a);
              ...
              for (l = a.split(/([-\)\]\},.!?:;])|(\s+)/); l.length; ) {
                ...
                else for (; h > 0 && e.measureText(l.slice(0, 3 * --h - 1).join('')).width > i; );
                if (h > 0) r.push(l.slice(0, 3 * h - 1).join('')), l.splice(0, 3 * h);
                  ...
                  else for (; c > 1 && e.measureText(d.substr(0, --c)).width > i; );
            ...
            this._points[0]
              ? this._points.length < 2
                ...
                : ((n = this._source.properties()),
                  ...
                  n.wordWrap && n.wordWrap.value() && (r.wordWrapWidth = n.wordWrapWidth.value()),
                  ...
                  i
                    ? ((o = new l()).append(this._renderer),
                      ...
                      r.wordWrapWidth &&
                        (((p = new s(h.x + (r.wordWrapWidth >> 1) + d.RoundRadius + d.TextMargins, h.y)).data = 1),
          ...
          return (
            ...
            (e.prototype.draw = function (e) {
              ...
              if (null !== this._data && 0 !== this._points.length) {
                ...
                this._data.filled &&
                  this._data.fillBackground &&
                  ((e.fillStyle = Object(d.generateColor)(this._data.backcolor, this._data.transparency)), e.fill()),
                  this._data.filled && !this._data.skipClosePath && e.closePath(),
                  this._data.linewidth > 0 && e.stroke(),
                  this._points.length > 1 &&
                    (this._data.leftend === l.LineEnd.Arrow &&
                      o.TrendLineRenderer.prototype.drawArrow(this._points[1], this._points[0], e, e.lineWidth),
            ...
            (e.prototype.hitTest = function (e) {
              ...
              for (t = a.CheckMobile.any() ? 24 : 3, i = 1; i < this._points.length; i++)
                if (
                  ((s = this._points[i - 1]), (o = this._points[i]), Object(r.distanceToSegment)(s, o, e).distance <= t)
                )
              ...
              return this._data.filled &&
                ...
                ? this._hittest
                : this._data.filled && this._data.fillBackground && Object(n.pointInPolygon)(e, this._data.points)
                ? this._backHittest
                : null;
            }),
            e
      ...
      inherit(n, r),
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            (n.fillBackground = this._source.properties().fillBackground.value()),
            (n.transparency = this._source.properties().transparency.value()),
            this._renderer.setData(n),
            i ? ((r = new a()).append(this._renderer), this.addAnchors(r), r) : this._renderer
          );
        }),
    ...
    CR3a: function (e, t, i) {
      ...
      inherit(n, s),
        ...
        (r.prototype.renderer = function (e, t, i) {
          function r(e, t, i) {
            ...
            switch (a.horzLabelsAlign.value()) {
              case 'left':
                ...
                break;
              case 'center':
                ((n = e.add(t).scaled(0.5)).x += i.width / 2), (n.x = Math.round(n.x));
                break;
              case 'right':
            ...
            (r = {
              ...
              'middle' === (h = a.vertLabelsAlign.value()) && (o.top -= o.height / 2),
              'bottom' === h && (o.top -= o.height),
              (d = new l(u, r, o)),
              s.append(d);
          }
          var s, a, o, d, p, _, u, f, g, v, w, y, m, x, b, R, S, T, P, L, C, B, k;
          if ((this._invalidated && this._updateImpl(), (s = new h()), this._floatPoints.length < 2))
          ...
          for (
            _ = this._model._fibChannelLabelsCache, u = _.canvas(), f = this, g = this._source.levelsCount(), v = 1;
            v < g;
            v++
          )
            if ((w = a['level' + v]).visible.value()) {
              ...
              (b = this.norm.scaled(w.coeff.value())),
                ...
                (B = new n()).setData(C),
                s.append(B),
                (a.showCoeffs.value() || a.showPrices.value()) && r(R, S, this._cacheState.preparedCells.cells[v - 1]);
            }
          ...
          return (
            null != k &&
              ...
              (a.showCoeffs.value() || a.showPrices.value()) && r(R, S, this._cacheState.preparedCells.cells[k - 1])),
            i && this.addAnchors(s),
            s
          );
        }),
      ...
      inherit(n, r),
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            (n.transparency = this._source.properties().transparency.value()),
            this._renderer.setData(n),
            i ? ((r = new s()).append(this._renderer), this.addAnchors(r), r) : this._renderer
          );
        }),
      ...
      (n.prototype.update = function (e) {
        ...
        (r.prototype.drawTooltipOn = function (e) {
          ...
          for (
            e.save(),
              ...
              p = (d = r.x < 20 || r.x + 20 > this._data.vpWidth) ? null : 'top',
              _ = d ? null : Math.round(r.x),
              h < 10 ? (h = r.y + 13) : (p = 'bottom'),
              l < 10
                ? (l += Math.abs(l - 10))
                : l + a + 10 > this._data.vpWidth && (l -= l + a + 10 - this._data.vpWidth),
              e.fillStyle = f.generateColor(this._data.backgroundColor, this._data.backgroundTransparency),
              e.strokeStyle = this._data.markerColor,
              e.lineWidth = 1,
              e.beginPath(),
              e.moveTo(l, h),
              d || 'top' !== p || (e.lineTo(_ - 7, h), e.lineTo(_, h - 7), e.lineTo(_ + 7, h)),
              e.lineTo(l + a, h),
              e.lineTo(l + a, h + o),
              d || 'bottom' !== p || (e.lineTo(_ + 7, h + o), e.lineTo(_, h + o + 7), e.lineTo(_ - 7, h + o)),
              e.lineTo(l, h + o),
              e.closePath(),
              e.fill(),
              e.stroke(),
            ...
            e.fillText(n[y].replace(/^\s+/, ''), v, w), (w += this._data.fontSize + s);
          e.restore();
        }),
        ...
        (s.prototype.renderer = function (e, t, i) {
          ...
          return (
            this._invalidated && this._updateImpl(),
            (n = new u()),
            (s = (r = this._source.properties()).locked && r.locked.value() ? this._source.fixedPoints() : this._points)
              .length < 1
              ? n
      ...
      inherit(n, s),
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (
            ...
            (u = l(this._points[_ - 1], this._points[_], 0)), (f = new a()).setData(u), r.append(f);
          return (
            this._points.length >= 5 &&
              ((w = !1),
              (y = !1),
              this._intersect1 ? (g = this._intersect1) : ((g = this._points[2]), (w = !0)),
              this._intersect2 ? (v = this._intersect2) : ((v = this._points[4]), (y = !0)),
        ...
        (n.prototype._updateImpl = function () {
          ...
          s.prototype._updateImpl.call(this),
            ...
            this._points.length >= 5 &&
              ...
              (i = this._points[2]),
              (n = this._points[4]),
              null !== (a = r(i, n, e, t)) && ((o = n.subtract(i)), (this._intersect1 = i.add(o.scaled(a)))),
          ...
          if (
            ...
            for (
              ...
              (h = a['level' + l]).visible.value() &&
                ((d = h.coeff.value()),
                (c = h.color.value()),
                (p = []).push(new r(this._center.x - 0.5 * i * d, this._center.y - 0.5 * n * d)),
                p.push(new r(this._center.x + 0.5 * i * d, this._center.y + 0.5 * n * d)),
        ...
        (n.prototype._updateImpl = function () {
          ...
          if (
            ...
            if (((r = e.visibleBarsStrictRange()), n > 0))
              for (a = t.index; a <= r.lastBar(); a += n) this._lines.push({ x: e.indexToCoordinate(a) });
            else for (a = t.index; a >= r.firstBar(); a += n) this._lines.push({ x: e.indexToCoordinate(a) });
        }),
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            i &&
              (2 === this._source.points().length
                ? ((g = [].concat(this._points)), n.append(this.createLineAnchor({ points: g })))
                : n.append(
    ...
    'Ht/7': function (e, t, i) {
      ...
      inherit(n, p),
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (
            n = this.isAnchorsRequired() ? 0 : 1, s = new f(), p = this._source.properties(), v = 0;
            v < this._wave.length;
            v++
          )
          ...
          for (
            y = 1,
              this._points.length > 2 && ((m = this._points[2]), (x = this._points[1]), (y = g.sign(m.y - x.y))),
              b = [],
              R = 0,
              this._model.lineBeingCreated() === this._source && (R = 1),
              S = 'black' === h(a(this._model.backgroundColor()), 150) ? 'white' : 'black',
              T = p.color.value(),
              v = 0;
            ...
            v < n ||
              ...
              'circle' === P.decoration &&
                ...
                1 === y ? (C.y += 13 + P.fontIncrease / 2) : (C.y -= 14 + P.fontIncrease / 2),
                (B = (12 + P.fontIncrease) / 2 + 2),
                (k = {
                  points: [(m = C.subtract(new r(B, B))), (x = C.add(new r(B, B)))],
          ...
          if (i) {
            for (M = [], A = 0; A < b.length; A++)
              ((D = this._points[A].clone()).y = b[A].points[0].y), (D.data = A), M.push(D);
            this._model.lineBeingCreated() === this._source && M.pop(), s.append(this.createLineAnchor({ points: M }));
          }
          return s;
        }),
        (n.prototype._updateImpl = function () {
          ...
          if (
            ...
            for (s = this._source.ownerSource().firstValue(), a = this._source.points(), o = 1; o < a.length; o++)
              (l = a[o - 1]),
                (h = a[o]),
      ...
      (n.prototype.setData = function (e) {
        ...
        (n.prototype.draw = function (e) {
          ...
          null !== this._data &&
            ...
            ((t = e.measureText(this._data.label)).height = this._data.fontSize),
            ...
            (e.fillStyle = _.generateColor(this._data.backgroundColor, this._data.transparency)),
            e.fill(),
            (e.strokeStyle = this._data.borderColor),
            (e.lineWidth = 2),
            e.stroke(),
        ...
        (n.prototype.hitTest = function (e) {
          ...
          return null !== this._data && 0 !== this._data.points.length && this._measureCache.padding
            ? ((t = this._data.points[0].x - (this._measureCache.padding.left + 20)),
              ...
              (n = o(new a(t, i), new a(t + this._measureCache.innerWidth, i + this._measureCache.innerHeight))),
        ...
        (r.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            this._renderer.setData(n),
            i && 1 === n.points.length
              ? ((r = new p()).append(this._renderer), r.append(new d({ points: n.points })), r)
              : this._renderer
          );
        }),
        (t.BalloonPaneView = r);
              ...
              : ((n = this._source.properties()),
                ...
                4 === this._points.length &&
                  ...
                  this._intersectPoint
                    ? ((h = [this._startPoint1, this._startPoint2, this._intersectPoint]),
                      ((p = {}).points = h),
                    ...
                    : this._intersectPoint1 &&
                      ...
                      ((h = [this._startPoint1, this._startPoint2, this._intersectPoint2, this._intersectPoint1]),
                      ((p = {}).filled = !0),
                      (p.fillBackground = !0),
                      (p.points = h),
                      (p.color = n.color.value()),
      ...
      (n.prototype.setData = function (e) {
        ...
        (n.prototype.draw = function (e) {
          ...
          null === this._data ||
            ...
            ((s =
              (t = this._data.width) -
              (r = (i = this._bodyWidth(e)) + (n = this._quantityWidth(e)) + this._cancelButtonWidth())),
        ...
        (n.prototype.hitTest = function (e) {
          ...
          if (this._adapter._blocked && e.x >= this._cache.left && e.x < this._cache.right) return new o(o.CUSTOM, {});
      ...
      function n(e, t, i, n) {
        return null !== e
          ? Object(o.intersectPolygonAndHalfplane)(
              e,
              Object(s.halfplaneThroughPoint)(Object(s.lineThroughPoints)(t, i), n)
            )
          : null;
      }
        ...
        (p = (function () {
          ...
          return (
            ...
            (e.prototype._extendAndHitTestLineSegment = function (e, t, i) {
              ...
              return null !== r && Object(a.distanceToSegment)(r[0], r[1], e).distance <= n
                ? this._hittestResult
                : null;
            }),
    ...
    Ni7V: function (e, t, i) {
      ...
      function r(e, t, i) {
        h.call(this, e, t),
          (this._image = _('price_label', TradingView.wrapUrl('/static/images/price_label.png'))),
          (this._rendererCache = {}),
              ...
              return this._data.points.length < 2
                ...
                : ((t = this._data.points[0]),
                  ...
                  a < 1 || o < 1
                    ? null
                    : ((d = (i.y - t.y) / (i.x - t.x)),
                      (c = (h = new s.Point(h.x, h.y / d)).x * h.x + h.y * h.y - n * n),
        ...
        (n.prototype._updateImpl = function () {
          ...
          if (
            ...
            !(this._source.points().length < 2) &&
              ...
              (t = this._source.points()[1]),
              (i = !1),
              (n = this._source.properties()).reverse && n.reverse.value() && (i = n.reverse.value()),
              (this._levels = []),
            ...
            if (
              ...
              switch (f.horzLabelsAlign.value()) {
                case 'left':
                  ...
                  break;
                case 'center':
                  ((L = a.add(p).scaled(0.5)).x += P.width / 2), (L.x = Math.round(L.x));
                  break;
                case 'right':
                  f.extendLines.value()
                    ? (L = new r(w - 4, this._levels[x].y))
                    : (((L = new r(w + 4, this._levels[x].y)).x += P.width), (L.x = Math.round(L.x)));
              }
              (C = {
                left: P.left,
                ...
                'middle' === (k = f.vertLabelsAlign.value()) && (B.top -= B.height / 2),
      ...
      inherit(n, r),
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (
            ...
            (_ = c(this._points[p - 1], this._points[p], 0)), (u = new s()).setData(_), r.append(u);
          return (
            this._retrace1 &&
              ((_ = c(this._points[1], this._points[3], 70, 1)),
              (u = new s()).setData(_),
              r.append(u),
              (f = l(this._points[1].add(this._points[3]).scaled(0.5), this._numericFormatter.format(this._retrace1))),
            ...
            this._retrace2 &&
              ...
              (u = new s()).setData(_),
              r.append(u),
              (f = l(this._points[5].add(this._points[3]).scaled(0.5), this._numericFormatter.format(this._retrace2))),
          ...
          if (
            ...
            for (o = 1; o <= 11; o++)
              (l = r['level' + o]).visible.value() &&
                ...
                r.showCoeffs.value() && ((p.text = h), (p.y = this._source.priceScale().height())),
                this._levels.push(p));
        }),
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (
            ...
            if (
              (w > 0 &&
                ...
                ((y = this._levels[w - 1]),
                (a = new r(y.x, 0)),
                (h = new r(this._levels[w].x, this._source.priceScale().height())),
                ((m = {}).points = [a, h]),
              ...
              switch (_.vertLabelsAlign.value()) {
                case 'top':
                  ...
                  break;
                case 'middle':
                  (b = new r(this._levels[w].x, 0.5 * this._levels[w].y)), (S = 0);
                  break;
                case 'bottom':
    ...
    UcQu: function (e, t, i) {
      ...
      inherit(n, s),
        (n.prototype.renderer = function (e, t, i) {
          var n, s, a, o, l, d, u, v, w, y, m, x, b, R, S, T, P, L, C, B, k, O, I, M, A, D, E, V, N, z, H, W, F;
          return (
            this._invalidated && this._updateImpl(),
            (n = new h()),
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((s = this._source.properties()).fillBackground &&
                ...
                (S = (100 * (R = (b = this._source.points()[1].price) - x)) / x),
                ...
                (k = ''),
                C && B && ((O = (B.valueOf() - C.valueOf()) / 1e3), (k = ', ' + g(new c().format(O)))),
                ...
                (a = {}),
                b > x
                  ? (((D = u.clone()).y -= 2 * s.fontsize.value()), (D.x = 0.5 * (d.x + u.x)), (a.points = [D]))
                  : (((D = u.clone()).x = 0.5 * (d.x + u.x)), (D.y += 0.7 * s.fontsize.value()), (a.points = [D])),
                (E = 0),
                (V = 10),
                (a.text = A),
                ...
                s.fillLabelBackground &&
                  ...
                  (a.backgroundTransparency = 1 - s.labelBackgroundTransparency.value() / 100 || 0)),
                s.drawBorder && s.drawBorder.value() && (a.borderColor = s.borderColor.value()),
                (N = 0.5 * (d.x + u.x)),
                (z = u.y),
                (H = new r(N, z)),
                ...
                (F = {
                  x: N + a.backgroundHorzInflate + W.textBgPadding - W.width / W.textBgPadding,
                  y:
                    d.y > u.y
    ...
    VghZ: function (e, t, i) {
      ...
      inherit(n, s),
        (n.prototype.renderer = function (e, t, i) {
          var n, s, a, o, l, d, u, f, g, v, w, y, m, x, b, R, S, T, P, L, C, B, k, O, I, M, A, D;
          return (
            this._invalidated && this._updateImpl(),
            (n = new h()),
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((a = (s = this._source.properties()).extendLeft.value()),
                ...
                (T = (100 * (S = (R = this._source.points()[1].price) - b)) / b),
                ...
                (g = {}),
                R > b
                  ? (((C = d.clone()).y -= 2 * s.fontsize.value()), (C.x = 0.5 * (l.x + d.x)), (g.points = [C]))
                  : (((C = d.clone()).x = 0.5 * (l.x + d.x)), (C.y += 0.7 * s.fontsize.value()), (g.points = [C])),
                (B = 0),
                (k = 10),
                (g.text = L),
                ...
                s.fillLabelBackground &&
                  ...
                  (g.backgroundTransparency = 1 - s.labelBackgroundTransparency.value() / 100 || 0)),
                s.drawBorder && s.drawBorder.value() && (g.borderColor = s.borderColor.value()),
                (O = 0.5 * (l.x + d.x)),
                (I = d.y),
                (M = new r(O, I)),
                ...
                (D = {
                  x: O + g.backgroundHorzInflate + A.textBgPadding - A.width / A.textBgPadding,
                  y:
                    l.y > d.y
            ...
            (t.prototype.renderer = function (e, t, i) {
              ...
              return (
                ...
                (r = this._getPoints()).length < 2
                  ...
                  : ((s = r[0]),
                    (a = r[1]),
                    (h = (o = this._getSource()).isReversed()) && ((a = r[0]), (s = r[1])),
                    (d = a.x - s.x),
                    (c = a.y - s.y),
                    (p = s),
                    (_ = a),
            ...
            (t.prototype._prepareLabels = function (e, t) {
              ...
              m &&
                ...
                null !== s &&
                  ...
                  ((h = this._getLabelData(o, l)).horzAlign = a > 0 ? 'right' : 'left'),
                  ...
                  ((_ = this._getLabelData(d, c)).horzAlign = a > 0 ? 'left' : 'right'),
                  ...
                  null !== (u = i.getScaleRatio()) &&
                    ...
                    ((v = this._getLabelData(y, g)).horzAlign = a > 0 ? 'left' : 'right'),
          ...
          a.prototype._updateImpl.call(this),
            ...
            this._source.points().length < 2 ||
              ...
              this._source.properties().showPriceRange.value() &&
                ...
                (l = this._source.ownerSource().formatter().format(d) + ' (' + new c().format(100 * p) + ') '),
              ...
              this._source.properties().showBarsRange.value() &&
                ((h = ''), (f = r.index - e.index), (h += $.t('{0} bars').format(g(f))), o.push('barsRange')),
              (this._label =
                [g(l), h]
                  .filter(function (e) {
                    return e;
          ...
          return (
            ...
            this._secondPoint &&
              ...
              s &&
                ...
                (c = {
                  points: [(h = this._source.getPointByPosition(l, r.points[0], this._middlePoint, r.points[1]))],
                  text: this._label,
              ...
              a && this._middlePoint && n.append(new p({ points: [this._middlePoint] })),
        ...
        (r.prototype._updateImpl = function () {
          ...
          a.prototype._updateImpl.call(this),
            ...
            this._source.points().length < 4 ||
              ...
              (t = this._source.pointToScreenPoint(this._source.points()[1])[1]),
              (i = this._source.pointToScreenPoint(this._source.points()[2])[1]),
              (r = (n = this._source.pointToScreenPoint(this._source.points()[3])[1]).subtract(e)),
              ...
              this._source.properties().extendRight.value() &&
                (this._extendRightPoints = p.extendQuadroBezier(n, t, l, h, d)));
        }),
        (r.prototype.renderer = function (e, t, i) {
          var n, r, s, a;
          return (
            ...
            this._points.length < 2
              ...
              : ((n = [].concat(this._points)),
                this._source._controlPoints &&
                  (n.push(this._source.pointToScreenPoint(this._source._controlPoints[0])[0]),
                  n.push(this._source.pointToScreenPoint(this._source._controlPoints[1])[0])),
                (r = {}),
                (s = this._source.properties()),
                (r.points = n),
                (r.color = s.linecolor.value()),
        ...
        (l = (function () {
          ...
          return (
            (e.prototype.priceToCoordinate = function (e) {
              ...
              return null === n
                ? null
                : null === (i = null !== (t = this._source.ownerSource()) ? t.firstValue() : null)
                ? null
          ...
          return (
            ...
            (t.prototype.renderer = function () {
              ...
              return (
                ...
                null !== (t = this._getSource().priceScale()) && (e.height = t.height()),
            ...
            (e.prototype.draw = function (e) {
              ...
              null !== this._data &&
                ...
                this._data.fillBack &&
                  ...
                  (e.fillStyle = Object(r.generateColor)(this._data.color, this._data.transparency, !0)),
                  e.fill()),
                e.beginPath(),
          ...
          return (
            ...
            this._points.length < 2
              ...
              : ((n = this._source.properties()),
                ...
                s.length >= 3 &&
                  ((p = c(s[1], s[2], 0)), this._lineRendererPoints12.setData(p), r.append(this._lineRendererPoints12)),
                4 === s.length &&
                  ((p = c(s[2], s[3], 0)), this._lineRendererPoints23.setData(p), r.append(this._lineRendererPoints23)),
                ...
                this._points.length >= 3 &&
                  ...
                  (_ = l(u, this._numericFormatter.format(this._ABRetracement))),
                  this._abLabelRenderer.setData(_),
                  r.append(this._abLabelRenderer)),
                this._points.length >= 4 &&
                  ...
                  (_ = l(u, this._numericFormatter.format(this._CDRetracement))),
                  this._cdLabelRenderer.setData(_),
                  r.append(this._cdLabelRenderer)),
                i && this.addAnchors(r),
                r)
          ...
          return n === this._data.dir || this._data.fullCircles
            ? ((t = e.subtract(this._data.center).length()),
              ...
              Math.abs(t - this._data.radius) < i
                ? this._hittest
                : this._data.hittestOnBackground && Math.abs(t) <= this._data.radius + i
                ? this._backHittest
                : null)
            : null;
        }),
      ...
      inherit(n, s),
        (n.prototype.renderer = function (e, t, i) {
          ...
          if ((this._invalidated && this._updateImpl(), this._pattern && 2 === this._source.points().length)) {
            if (
              !(n = this._source.points()[0].index < this._source.points()[1].index ? this._points[0] : this._points[1])
            )
              return new c();
            if (
              ((s = parseInt(this._source.properties().mode.value(), 10)),
              (a = Math.abs((this._points[0].x - this._points[1].x) / (this._pattern.length - 1))),
              s === _.Bars || s === _.OpenClose)
            ) {
              for (
                l = new c(), g = (f = s === _.Bars ? ['high', 'low'] : ['open', 'close'])[0], v = f[1], w = 0;
                ...
                (y = Math.round(n.x + w * a + 0.5)),
                  ...
                  (R = new o()).setData(b),
                  l.append(R);
              return i && l.append(this.createLineAnchor({ points: this._points })), l;
            }
            return (
              (l = new c()),
              ((b = {}).barSpacing = a),
              ...
              (b.histogramBase = 0),
              (b.lineIndex = 0),
              (b.lineColor = p.generateColor(this._source.properties().color.value(), 10)),
            ...
            !this._source.priceScale() ||
              ...
              (this._source._pattern && this._source._pattern.length > 0 && 2 === this._source.points().length
                ? ((e = this._source.priceScale()),
                  ...
                  (h = this._source.points()[0].index > this._source.points()[1].index ? 1 : 0),
                  (d = this._points[h]),
                  (c = d.x),
                  (p = Math.abs((this._points[0].x - this._points[1].x) / (this._source._pattern.length - 1))),
                  (_ = {
                    0: function (e) {
                      return {
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (
            s = {
              ...
              a = this._floatPoints[2].subtract(this._floatPoints[1]).scaled(0.5),
            ...
            (v = 'level' + g),
              (w = this._source.properties()[v]).visible.value() &&
                ((m = (y = this._medianPoint.addScaled(a, w.coeff.value())).add(o)),
                (b = (x = this._medianPoint.addScaled(a, -w.coeff.value())).add(o)),
                u &&
                  (((R = {}).p1 = y),
                  (R.p2 = m),
        ...
        (r.prototype.renderer = function (e, t, i) {
          ...
          for (
            a = {
              ...
              n.append(this._sideRenderer),
              o = this._floatPoints[2].subtract(this._floatPoints[1]).scaled(0.5),
            ...
            (w = 'level' + v),
              (y = this._source.properties()[w]).visible.value() &&
                ((x = (m = this._medianPoint.addScaled(o, y.coeff.value())).add(l)),
                (R = (b = this._medianPoint.addScaled(o, -y.coeff.value())).add(l)),
                f &&
                  (((r = {}).p1 = m),
                  (r.p2 = x),
          ...
          for (
            ...
            (y = 'level' + w),
              (m = this._source.properties()[y]).visible.value() &&
                ((b = (x = this._medianPoint.addScaled(o, m.coeff.value())).add(l)),
                (S = (R = this._medianPoint.addScaled(o, -m.coeff.value())).add(l)),
                f &&
                  (((s = {}).p1 = x),
                  (s.p2 = b),
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            this._source.properties().showLabel.value() &&
              ...
              'middle' === o ? (c = -this._source.properties().fontsize.value() / 6) : 'bottom' === o && (c = -4),
              (_ = {
                points: [d],
                text: a.text.value(),
            ...
            1 === this._points.length &&
              i &&
              (((u = new r(this._model.timeScale().width() / 2, this._points[0].y)).data = 0),
        ...
        (n.prototype.draw = function (e) {
          ...
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            (o = i.subtract(t)),
              ...
              (y = c(m, y)),
              (m = h(1, u / (2 * r))),
              (y = c(m, y)).y < 0 ? (this._data.clockwise = !0) : (this._data.clockwise = !1),
              e.save(),
              e.beginPath(),
              e.translate(t.x, t.y),
              e.rotate(w),
                      ...
                      : ((f = n.points[1]),
                        ...
                        2 === n.points.length
                          ...
                          : (o.push(g),
                            ...
                            (L = c(C, L)),
                            (C = h(1, R / (2 * w))),
                            ((B = (L = c(C, L)).y >= 0 ? new s(v.x, v.y) : new s(b.x, b.y)).data = 2),
                            o.push(B),
    ...
    dMkl: function (e, t, i) {
      ...
      inherit(n, s),
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (this._invalidated && this.udpateImpl(), n = new h(), r = 1; r < this._points.length; r++)
            (s = {
    ...
    eg8N: function (e, t, i) {
      ...
      inherit(n, s),
        (n.prototype.renderer = function (e, t, i) {
          ...
          if ((this._invalidated && this._updateImpl(), (s = new h()), this._points.length < 2))
            return i && this.addAnchors(s), s;
          for (
            d = this._points[0],
              p = this._points[1],
        ...
        (n.prototype._updateImpl = function () {
          ...
          if (
            ...
            for (
              e = this._source.points()[0],
                t = this._source.points()[1],
                n = (i = this._source.properties()).reverse && i.reverse.value(),
                this._hlevels = [],
            ...
            for (
              this._vlevels = [], u = n ? e.index - t.index : t.index - e.index, f = n ? t.index : e.index, l = 1;
              l <= 7;
              l++
            )
            ...
            if (((this._hfans = []), (this._vfans = []), i.fans.visible.value()))
              for (l = 1; l <= 7; l++)
                (g = Math.round(f + i['hlevel' + l].coeff.value() * u)),
                  ...
                  this._hfans.push(this._model.timeScale().indexToCoordinate(g)),
                  ...
                  : ((f = this),
                    (g = function (e, t, i, r, s, a) {
                      ...
                      f._source.properties().showPrices.value() &&
                        ...
                        t.setData(o),
                        n.append(t));
                    })(this._p1LabelRenderer, this._p2LabelRenderer, r, s, this._price1, this._price2),
                    this._trendLineRendererPoints43.setData(u(o, a)),
                    n.append(this._trendLineRendererPoints43),
                    g(this._p3LabelRenderer, this._p4LabelRenderer, a, o, this._price3, this._price3),
                    i &&
                      ((v = [r, s, a, o]),
            ...
            this._source.points().length < 2 ||
              (this._source.priceScale() &&
                ...
                3 === this._source.points().length &&
                  ...
                  (this._price3 = this._source.priceScale().formatPrice(n.price, i)),
                  (s = t.price - e.price),
                  (this._price4 = this._source.priceScale().formatPrice(n.price + s, i)))));
        }),
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            this._points.length < 2
              ...
              : ((r = this._points[0]),
                ...
                n.append(this._trendLineRendererPoints12),
                v(this._p1LabelRenderer, this._p2LabelRenderer, r, s, this._price1, this._price2),
                2 === this._points.length
                  ? (this.addAnchors(n), n)
                  : (this._trendLineRendererPoints43.setData(f(o, a)),
                    n.append(this._trendLineRendererPoints43),
                    v(this._p3LabelRenderer, this._p4LabelRenderer, a, o, this._price3, this._price4),
                    i &&
                      ((w = [r, s, a, o]),
            ...
            (e.prototype.draw = function (e) {
              if (
                ...
                if (
                  ...
                  t.addColorStop(0, Object(r.generateColor)(this._data.color1, this._data.transparency)),
                    t.addColorStop(1, Object(r.generateColor)(this._data.color2, this._data.transparency)),
                    (e.fillStyle = t);
            ...
            (e.prototype.hitTest = function (e) {
              ...
              return null === this._data
                ...
                : ((i = (t = e.subtract(this._data.center)).length()),
                  ...
                  Math.max(n, r) <= this._data.p1.subtract(this._data.p2).length())
                    ? this._hitTest
                    : this._data.fillBackground &&
                      i <= this._data.radius &&
                      ((s = this._data.p1.subtract(this._data.center).normalized()),
                      (a = this._data.p2.subtract(this._data.center).normalized()),
                      (o = t.normalized()),
                      (l = s.dotProduct(a)),
                      (h = o.dotProduct(s)),
                      (d = o.dotProduct(a)),
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (
            d = {
              ...
              n.append(this._sideRenderer),
              c = 0,
              p = this._floatPoints[2].subtract(this._floatPoints[1]).scaled(0.5),
              _ = this._source.properties().fillBackground.value(),
              u = this._source.properties().transparency.value(),
              f = 0;
            f <= 8;
            ...
            0 === this._points.length
              ...
              : ((n = new h()),
                ...
                2 === this._points.length
                  ...
                  : 3 === this._points.length &&
                    ((v = l.subtract(a)),
                    (y = (w = new r(v.y, -v.x).normalized().scaled(this._distance)).scaled(-1)),
                    (c = a.add(w)),
                    (p = l.add(w)),
                    (_ = a.add(y)),
                    (u = l.add(y)),
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            !(n = this._source.priceScale()) || n.isEmpty()
              ? null
              : ((s = {}),
                (c = (l = this._source.properties()).locked && l.locked.value()),
                ...
                l.fillBackground &&
                  ...
                  (s.backgroundTransparency = 1 - l.backgroundTransparency.value() / 100 || 0)),
                l.drawBorder && l.drawBorder.value() && (s.borderColor = l.borderColor.value()),
                l.wordWrap && l.wordWrap.value() && (s.wordWrapWidth = l.wordWrapWidth.value()),
                (s.bold = l.bold && l.bold.value()),
                (s.italic = l.italic && l.italic.value()),
                (s.highlightBorder = this._model.selection().isSelected(this._source)),
                c ||
                  !l.fixedSize ||
                  l.fixedSize.value() ||
                  ((s.scaleX = this._source._model.timeScale().barSpacing() / this._source._barSpacing),
                ...
                this.isAnchorsRequired() && 1 === s.points.length && !this._noSelection
                  ...
                  ? ((r = new u()).append(this._renderer),
                    ...
                    2 === this._points.length
                      ...
                      : ((h = n.points[2]),
                        ...
                        r.append(this.createLineAnchor({ points: [g, v, w, y] })),
                        r))
                  : this._renderer)
          );
        }),
    ...
    ocVb: function (e, t, i) {
      ...
      inherit(n, s),
        ...
        (n.prototype._statLabelData = function () {
          var e, t, i, n, s, a, o, l, h, p, _, f, w, y, m, x, b, R, S, T, P, L, C, B, k;
          return (
            this._labelDataInvalidated &&
              ...
              (n = this._source.properties()).showPriceRange.value() &&
                ...
                (f = this._model.mainSeries().symbolInfo()) &&
                  ...
                  ((this._pipFormatter = new c(f.pricescale, f.minmov, f.type, f.minmove2)),
              ...
              (w || y || m) &&
                ((o = ''),
                w && ((p = i.index - t.index), (o += $.t('{0} bars').format(g(p)))),
                y &&
              ...
              n.showAngle.value() &&
                ...
                P instanceof r &&
                  ...
                  ((B = B.normalized()), (C = Math.acos(B.x)), B.y > 0 && (C = -C)),
                'number' != typeof C ||
                  TradingView.isNaN(C) ||
          ...
          return (
            ...
            this._invalidated
              ...
              ? (((r = {}).points = this._points),
                ...
                n.append(this._trendRenderer),
                (s = this.isAnchorsRequired() || this._source.properties().alwaysShowStats.value()),
                (l =
                ...
                s &&
                  ...
                  (d = this._source.getPointByPosition(h, this._points[0], this._middlePoint, this._points[1])),
                  (c = {
                    left: 0,
                  ...
                  (g = new a(f, c, _)),
                  n.append(g)),
                l && this._middlePoint && n.append(new p({ points: [this._middlePoint] })),
                i && this.addAnchors(n),
                n)
              : n
          );
    ...
    piZW: function (e, t, i) {
      ...
      (n.prototype.draw = function (e) {
        ...
        (r.prototype.renderer = function (e, t, i) {
          ...
          for (w = w = v.indexToCoordinate(h + d), m = h + d; w < v.width(); m += d)
        ...
        (n.prototype.draw = function (e) {
          ...
          this._drawArrow(e, a, l),
            0 !== (t = this._textWidth(e)) &&
              ...
              (s = 'buy' === this._adapter.getDirection() ? l + i + n : l - i - n - r),
                ...
                0 === (a = (r = this._source).points()).length
                  ...
                  : ((o = r._adapter),
                    ...
                    !isFinite(h.y) || h.y < 0 || h.y > e || h.x < 0
                      ...
                      : ((d = { points: [new s(h.x, h.y)] }), (this._renderer = new n(d, o)), this._renderer)))
          );
        }),
          ...
          return (
            ...
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((s = this),
                ...
                (l = this._points[g.ActualEntry] ? this._points[g.ActualEntry].x : this._points[g.Close].x),
                (h = this._points[g.ActualClose] ? this._points[g.ActualClose].x : this._points[g.Close].x),
                ...
                this._pl < 0 &&
                  ...
                  (y.backcolor = a.stopBackground.value()),
                  (y.fillBackground = !0),
                  (x = 100 - 100 * (1 - (m = 0.01 * a.stopBackgroundTransparency.value()) * m * m)),
                  (y.transparency = x),
                ...
                this._pl > 0 &&
                  ...
                  (y.backcolor = a.profitBackground.value()),
                  (y.fillBackground = !0),
                  (b = 100 - 100 * (1 - (m = 0.01 * a.profitBackgroundTransparency.value()) * m * m)),
                  (y.transparency = b),
                ...
                this._points[g.ActualEntry] &&
                  ...
                  (w = this._isClosed ? this._points[g.ActualClose] : new r(this._closeBar, this._closeLevel)),
                  ((y = {}).points = [p, w]),
                ...
                this._points[1] && void 0 !== this._pl && (D = this._source.ownerSource().formatter().format(this._pl)),
                a.compact.value()
                  ? ((A += D ? D + ' ~ ' : ''), (A += a.qty.value() + '\n'), (A += E))
                  : ((V = this._isClosed ? this.i18nCache.closed : this.i18nCache.open),
                    (A += D ? this.i18nCache.pnl.format(V, D) + ', ' : ''),
                    (A += this.i18nCache.qty.format(a.qty.value()) + '\n'),
                    (A += this.i18nCache.ratio.format(E) + ' ')),
                (N = a.linecolor.value()),
                this._pl < 0 ? (N = a.stopBackground.value()) : this._pl > 0 && (N = a.profitBackground.value()),
                ...
                (z = this._model.mainSeries().symbolInfo()) &&
                  ...
                  ((this._pipFormatter = new _(z.pricescale, z.minmov, z.type, z.minmove2)),
                ...
                S(this._stopLabelRenderer, M, A, a.stopBackground.value(), T < P ? 'bottom' : 'top', T < P ? -12 : -1),
          ...
          if (
            ...
            for (this._levels = [], r = t ? t.index - e.index : 1, a = 1; a <= 11; a++)
              (o = i['level' + a]).visible.value() &&
                ...
                i.showLabels.value() && ((h.text = o.coeff.value()), (h.y = this._source.priceScale().height())),
                this._levels.push(h));
        }),
        (n.prototype.renderer = function (e, t, i) {
            ...
            if (
              ...
              switch (s.vertLabelsAlign.value()) {
                case 'top':
                  ...
                  break;
                case 'middle':
                  (m = new r(this._levels[h].x, 0.5 * this._levels[h].y)), (b = 0);
                  break;
                case 'bottom':
            ...
            (e.prototype.draw = function (e) {
              if (null !== this._data && 0 !== this._data.points.length && !(this._data.linewidth <= 0)) {
                ...
                t < 0 ||
                  ...
                  (e.strokeStyle = this._data.color),
                  (e.lineWidth = this._data.linewidth),
                  void 0 !== this._data.linestyle && Object(r.setLineStyle)(e, this._data.linestyle),
