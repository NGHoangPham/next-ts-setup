  ...
  ['ds-property-pages'],
  {
      ...
      inherit(o, a),
        (o.prototype.prepareLayout = function () {
          ...
          (this._res = $('<div>')),
            ...
            this.bindControl(
              new s(a, this._linetool.properties().showLabel, !0, this.model(), 'Change Horz Line Text Visibility')
            ),
            this.bindControl(
              new p(
                y,
            ...
            this.bindControl(new d(T, this._linetool.properties().text, null, !0, this.model(), 'Change Text')),
            this.bindControl(
              new s(n, this._linetool.properties().showPrice, !0, this.model(), 'Change Horz Line Price Visibility')
            ),
            this.bindControl(
              new h(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Horz Line Color')
            ),
            this.bindControl(
              new p(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Horz Line Style')
            ),
            this.bindControl(
              new c(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Horz Line Width')
            ),
            this.bindControl(
              new p(r, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new p(u, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new h(l, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new s(C, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new s(g, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            this.loadData();
        }),
      ...
      inherit(o, l),
        (o.prototype.prepareLayout = function () {
          var e,
            ...
            s = $('<table class="property-page" cellspacing="0" cellpadding="0">').data({
        ...
        (n.prototype.prepareLayout = function () {
          ...
          (this._widget = $('<div>')),
            ...
            (l = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(n).add(a))),
            ...
            this.bindBoolean(l, c.candleStyle.drawBorder, 'Change Candle Border Visibility'),
            ...
            this.bindControl(new p(h, c.transparency, !0, this.model(), 'Change Guest Feed Transparency'));
        }),
          ...
          return (
            ...
            (e.prototype.selectItemByValue = function (e) {
              var t,
                ...
                o,
                n = null;
              for (t = 0, i = this.items; t < i.length; t++) (o = i[t].selectAndReturnIfValueMatch(e)) && (n = o);
              return n;
            }),
      ...
      inherit(o, l),
        ...
        (o.prototype.prepareLayoutImpl = function (e, t, i, o) {
          ...
          for (o = o || {}, l = {}, b = this, C = 0; C < e.inputs.length; C++) {
            (m = (T = e.inputs[C]).id),
              (f = e.name === w(y.STYLE_RENKO) || e.name === w(y.STYLE_KAGI) || e.name === w(y.STYLE_PB)),
            ...
            if (
              !((e.name === w(y.STYLE_RENKO) && 'wicks' === m) || (e.name === w(y.STYLE_RANGE) && 'range' === m)) &&
              (!f || 'source' !== m)
            ) {
              if (
                ((v = $('<tr/>')),
                (S = this._labelToId(m)),
                e.name === w(y.STYLE_RANGE) && 'phantomBars' === m && (k = $('<table><tr></tr></table>')).appendTo(v),
                T.isHidden || v.appendTo(t),
                e.name === w(y.STYLE_RANGE) && 'phantomBars' === m && (v = k.find('tr')),
                (x = $('<td' + (o.nameColspan ? ' colspan = "' + o.nameColspan + '"' : '') + '/>')).addClass(
                  'propertypage-name-label'
                ),
                x.html(g(L, S)),
                (e.name === w(y.STYLE_RANGE) && 'phantomBars' === m) || x.appendTo(v),
                (B = $('<td' + (o.valueColspan ? ' colspan = "' + o.valueColspan + '"' : '') + '/>')).appendTo(v),
                (P = null),
                T.options)
              )
                for (P = $("<select id='" + S + "' />"), R = 0; R < T.options.length; R++)
                  (E = T.options[R]), $("<option value='" + E + "'>" + $.t(E) + '</option>').appendTo(P);
              else (F = 'bool' === T.type ? 'checkbox' : 'text'), (P = $("<input id='" + S + "' type='" + F + "' />"));
              P.appendTo(B),
                (e.name === w(y.STYLE_RANGE) && 'phantomBars' === m) || P.css('width', '100px'),
                e.name === w(y.STYLE_RANGE) && 'phantomBars' === m && x.appendTo(v),
                (D = 'Change ' + L),
                T.options
                  ? this.bindControl(new c(P, i.inputs[m], null, !0, this.model(), D))
                  : 'integer' === T.type
                  ? ((I = [p(T.defval)]),
                    T.min && I.push(r(T.min)),
                    T.max && I.push(s(T.max)),
                    this.bindControl(new h(P, i.inputs[m], I, !1, this.model(), D)),
                    P.addClass('ticker'))
                  : 'float' === T.type
                  ? ((I = [d(T.defval)]),
                    T.min &&
                      ((((e.id === w(y.STYLE_RENKO) || e.id === w(y.STYLE_PNF)) && 'boxSize' === T.id) ||
                        (e.id === w(y.STYLE_KAGI) && 'reversalAmount' === T.id)) &&
                        null !== (A = this._model.model().mainSeries().symbolInfo()) &&
                        (W = A.minmov / A.pricescale),
                      I.push(r(W || T.min))),
                    T.max && I.push(s(T.max)),
                    (V = new h(P, i.inputs[m], I, !1, this.model(), D)).addFormatter(a),
                    this.bindControl(V),
                    P.addClass('ticker'))
                  : 'text' === T.type
                  ? this.bindControl(new h(P, this._property.inputs[m], null, !1, this.model(), D))
                  : 'bool' === T.type && this.bindControl(new u(P, i.inputs[m], !0, this.model(), D)),
                P.change(n),
                (l[T.id] = v);
            }
          }
        ...
        (o.prototype._prepareSeriesStyleLayout = function (e, t, i, o) {
          var a,
            ...
            We = null;
          this._isHiLoChartsAvailable() && (We = this._hiloTbody = $('<tbody>').appendTo(i)),
            (a = this._baselineTbody = $('<tbody>').appendTo(i)),
            this._isShowStyleSwitcher() &&
              ((d = this.addLabeledRow(ke, 'Style')),
              (g = $(document.createElement('td')).appendTo(d)).addClass('property-wide-select'),
              (l = $(document.createElement('select'))),
              $('<option value=' + y.STYLE_BARS + '>' + $.t('Bars') + '</option>').appendTo(l),
              $('<option value=' + y.STYLE_CANDLES + '>' + $.t('Candles') + '</option>').appendTo(l),
              $('<option value=' + y.STYLE_HOLLOW_CANDLES + '>' + $.t('Hollow Candles') + '</option>').appendTo(l),
              this._isJapaneseChartsAvailable() &&
                $('<option value=' + y.STYLE_HEIKEN_ASHI + '>' + $.t('Heikin Ashi') + '</option>').appendTo(l),
              $('<option value=' + y.STYLE_LINE + '>' + $.t('Line') + '</option>').appendTo(l),
              $('<option value=' + y.STYLE_AREA + '>' + $.t('Area') + '</option>').appendTo(l),
              $('<option value=' + y.STYLE_BASELINE + '>' + $.t('Baseline') + '</option>').appendTo(l),
              this._isHiLoChartsAvailable() &&
                $('<option value=' + y.STYLE_HILO + '>' + $.t('High-Low') + '</option>').appendTo(l),
              l.css('width', '100px').appendTo(g),
              this.switchStyle(),
              this.bindControl(new c(l, o.style, parseInt, !0, this.model(), 'Change Series Style'))),
            ...
            (k = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(f).add(v))),
            (S = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(m).add(L))),
            (x = $("<input type='checkbox'/>")),
            (B = this.addLabeledRow(Se, 'Color Bars Based on Previous Close', x)),
            ...
            this.bindControl(new b(w, o.candleStyle.upColor, !0, this.model(), 'Change Candle Up Color')),
            this.bindControl(new b(_, o.candleStyle.downColor, !0, this.model(), 'Change Candle Down Color')),
            this.bindControl(new u(S, o.candleStyle.drawWick, !0, this.model(), 'Change Candle Wick Visibility')),
            this.bindControl(new b(m, o.candleStyle.wickUpColor, !0, this.model(), 'Change Candle Wick Up Color')),
            this.bindControl(new b(L, o.candleStyle.wickDownColor, !0, this.model(), 'Change Candle Wick Down Color')),
            this.bindControl(new u(k, o.candleStyle.drawBorder, !0, this.model(), 'Change Candle Border Visibility')),
            this.bindControl(new b(f, o.candleStyle.borderUpColor, !0, this.model(), 'Change Candle Up Border Color')),
            this.bindControl(
              new b(v, o.candleStyle.borderDownColor, !0, this.model(), 'Change Candle Down Border Color')
            ),
            this.bindControl(
              new u(
                x,
            ...
            (I = this.createColorPicker()),
            (W = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(D).add(I))),
            (A = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(E).add(F))),
            ...
            $('<td>').append(F).appendTo(B),
            this.bindControl(new b(P, o.hollowCandleStyle.upColor, !0, this.model(), 'Change Hollow Candle Up Color')),
            this.bindControl(
              new b(R, o.hollowCandleStyle.downColor, !0, this.model(), 'Change Hollow Candle Down Color')
            ),
            this.bindControl(
              new u(A, o.hollowCandleStyle.drawWick, !0, this.model(), 'Change Hollow Candle Wick Visibility')
            ),
            this.bindControl(
              new b(E, o.hollowCandleStyle.wickUpColor, !0, this.model(), 'Change Hollow Candle Wick Up Color')
            ),
            this.bindControl(
              new b(F, o.hollowCandleStyle.wickDownColor, !0, this.model(), 'Change Hollow Candle Down Wick Color')
            ),
            this.bindControl(
              new u(W, o.hollowCandleStyle.drawBorder, !0, this.model(), 'Change Hollow Candle Border Visibility')
            ),
            this.bindControl(
              new b(D, o.hollowCandleStyle.borderUpColor, !0, this.model(), 'Change Hollow Candle Up Border Color')
            ),
            this.bindControl(
              new b(I, o.hollowCandleStyle.borderDownColor, !0, this.model(), 'Change Hollow Candle Down Border Color')
            ),
            (V = $("<input type='checkbox'/>")),
            (B = this.addLabeledRow(xe, 'Color Bars Based on Previous Close', V)),
            ...
            this.bindControl(new b(O, o.barStyle.upColor, !0, this.model(), 'Change Bar Up Color')),
            this.bindControl(new b(M, o.barStyle.downColor, !0, this.model(), 'Change Bar Down Color')),
            this.bindControl(
              new u(V, o.barStyle.barColorsOnPrevClose, !0, this.model(), 'Change Color Bars Based on Previous Close')
            ),
            this.bindControl(new u(z, o.barStyle.dontDrawOpen, !0, this.model(), 'Change HLC Bars')),
            this.bindControl(new u(q, o.barStyle.thinBars, !0, this.model(), 'Change Thin Bars')),
            o.hiloStyle &&
              ((Y = this.createColorPicker()),
              (N = this.createColorPicker()),
              (H = this.createColorPicker()),
              (G = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(N))),
              (j = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(H))),
              ...
              this.bindControl(new b(Y, o.hiloStyle.color, !0, this.model(), 'Change High-Low Bodies Color')),
              this.bindControl(new u(G, o.hiloStyle.showBorders, !0, this.model(), 'Change Show High-Low Borders')),
              this.bindControl(new b(N, o.hiloStyle.borderColor, !0, this.model(), 'Change High-Low Border Color')),
              this.bindControl(new u(j, o.hiloStyle.showLabels, !0, this.model(), 'Change Show High-Low Labels')),
              this.bindControl(new b(H, o.hiloStyle.labelColor, !0, this.model(), 'Change High-Low Labels Color')),
              this.bindControl(
                new c(U, o.hiloStyle.fontSize, parseInt, !0, this.model(), 'Change High-Low Labels Font Size')
              )),
            (K = T()),
            (B = this.addLabeledRow(De, 'Price Source')),
            $('<td colspan="3">').append(K).appendTo(B),
            (Q = this.addLabeledRow(De, 'Type')),
            (X = $('<td colspan="3">').appendTo(Q)).addClass('property-wide-select'),
            (Z = $(document.createElement('select'))),
            $('<option value=' + y.STYLE_LINE_TYPE_SIMPLE + '>' + $.t('Simple') + '</option>').appendTo(Z),
            $('<option value=' + y.STYLE_LINE_TYPE_MARKERS + '>' + $.t('With Markers') + '</option>').appendTo(Z),
            $('<option value=' + y.STYLE_LINE_TYPE_STEP + '>' + $.t('Step') + '</option>').appendTo(Z),
            Z.appendTo(X),
            ...
            this.bindControl(new c(K, o.lineStyle.priceSource, null, !0, this.model(), 'Change Price Source')),
            this.bindControl(new c(Z, o.lineStyle.styleType, parseInt, !0, this.model(), 'Change Line Type')),
            this.bindControl(new b(J, o.lineStyle.color, !0, this.model(), 'Change Line Color')),
            this.bindControl(new C(ee, o.lineStyle.linewidth, !0, this.model(), 'Change Line Width')),
            o.haStyle &&
              ...
              (re = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(ae).add(le))),
              (se = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(oe).add(ne))),
              (pe = $("<input type='checkbox'/>")),
              (B = this.addLabeledRow(Be, $.t('Color Bars Based on Previous Close'), pe)),
              ...
              this.bindControl(new b(te, o.haStyle.upColor, !0, this.model(), 'Change Heikin Ashi Up Color')),
              this.bindControl(new b(ie, o.haStyle.downColor, !0, this.model(), 'Change Heikin Ashi Down Color')),
              this.bindControl(new u(se, o.haStyle.drawWick, !0, this.model(), 'Change Heikin Ashi Wick Visibility')),
              this.bindControl(new b(oe, o.haStyle.wickUpColor, !0, this.model(), 'Change Heikin Ashi Wick Up Color')),
              this.bindControl(
                new b(ne, o.haStyle.wickDownColor, !0, this.model(), 'Change Heikin Ashi Wick Down Color')
              ),
              this.bindControl(
                new u(re, o.haStyle.drawBorder, !0, this.model(), 'Change Heikin Ashi Border Visibility')
              ),
              this.bindControl(
                new b(ae, o.haStyle.borderUpColor, !0, this.model(), 'Change Heikin Ashi Up Border Color')
              ),
              this.bindControl(
                new b(le, o.haStyle.borderDownColor, !0, this.model(), 'Change Heikin Ashi Down Border Color')
              ),
              this.bindControl(
                new u(pe, o.haStyle.barColorsOnPrevClose, !0, this.model(), 'Change Color Bars Based on Previous Close')
              )),
            this._isJapaneseChartsAvailable() && n.enabled('japanese_chart_styles'),
            (de = T()),
            ...
            this.bindControl(new c(de, o.areaStyle.priceSource, null, !0, this.model(), 'Change Price Source')),
            this.bindControl(new b(he, o.areaStyle.linecolor, !0, this.model(), 'Change Line Color')),
            this.bindControl(new C(ce, o.areaStyle.linewidth, !0, this.model(), 'Change Line Width')),
            this.bindControl(
              new b(be, o.areaStyle.color1, !0, this.model(), 'Change Line Color', o.areaStyle.transparency)
            ),
            this.bindControl(
              new b(ue, o.areaStyle.color2, !0, this.model(), 'Change Line Color', o.areaStyle.transparency)
            ),
            (Ce = T()),
            (B = this.addLabeledRow(a, window.t('Price Source'))),
            $('<td colspan="3">').appendTo(B).append(Ce),
            this.bindControl(new c(Ce, o.baselineStyle.priceSource, null, !0, this.model(), 'Change Price Source')),
            ...
            this.bindControl(new b(ge, o.baselineStyle.topLineColor, !0, this.model(), 'Change Top Line Color')),
            this.bindControl(new C(ye, o.baselineStyle.topLineWidth, !0, this.model(), 'Change Top Line Width')),
            ($e = this.createColorPicker()),
            (we = this.createLineWidthEditor()),
            (B = this.addLabeledRow(a, window.t('Bottom Line'))),
            $('<td>').appendTo(B).append($e),
            $('<td>').appendTo(B).append(we),
            this.bindControl(new b($e, o.baselineStyle.bottomLineColor, !0, this.model(), 'Change Bottom Line Color')),
            this.bindControl(new C(we, o.baselineStyle.bottomLineWidth, !0, this.model(), 'Change Bottom Line Width')),
            (Te = this.createColorPicker()),
            ...
            this.bindControl(
              new b(Te, o.baselineStyle.topFillColor1, !0, this.model(), 'Change Fill Top Area Color 1'),
              o.baselineStyle.transparency
            ),
            this.bindControl(
              new b(_e, o.baselineStyle.topFillColor2, !0, this.model(), 'Change Fill Top Area Color 2'),
              o.baselineStyle.transparency
            ),
            ...
            this.bindControl(
              new b(me, o.baselineStyle.bottomFillColor1, !0, this.model(), 'Change Fill Bottom Area Color 1'),
              o.baselineStyle.transparency
            ),
            this.bindControl(
              new b(Le, o.baselineStyle.bottomFillColor2, !0, this.model(), 'Change Fill Bottom Area Color 2'),
              o.baselineStyle.transparency
            ),
            ...
            (ve = [p(o.baselineStyle.baseLevelPercentage.value()), s(100), r(0)]),
            this.bindControl(new h(fe, o.baselineStyle.baseLevelPercentage, ve, !0, this.model(), 'Change Base Level'));
        }),
        (o.prototype._addThinBarsEditorRow = function (e) {
          ...
          return (
            ...
            i.change(function () {
              i.is(':checked') ? m('GUI', 'Style', 'Enable thin bars') : m('GUI', 'Style', 'Disable thin bars');
            }),
            i
          );
        }),
    ...
    '11dv': function (e, t, i) {
      ...
      (function (t) {
        ...
        var n, a, l, r, s, p, d, h, c, b, u, C, g, y, w, T, _, m, L, f, v, k, S, x, B, P, R, E;
        i('YFKU'),
          (n = i('04K5')),
          (a = i('QloM')),
          (l = i('DxCR')),
          ...
          (o.prototype.prepareLayout = function () {
            ...
            t.enabled('chart_property_page_style') &&
              ...
              this.bindControl(
                new c(F, this._seriesProperty.showPriceLine, !0, this.model(), 'Change Price Price Line')
              ),
              (I = $('<input type="checkbox">')),
              (W = this.addLabeledRow(r, window.t('Show Label on Price Scale'), I)),
              ...
              this.bindControl(
                new u(V, this._seriesProperty.priceLineColor, !0, this.model(), 'Change Price Line Color')
              ),
              ...
              t.enabled('chart_property_page_scales') &&
                ...
                $('<td>').append(this._scaleBindings.autoScale.control).prependTo(M),
                (this._scaleBindings.lockScale = {}),
                (this._scaleBindings.lockScale.control = $("<input type='checkbox'/>")),
                (q = this.addLabeledRow(O, window.t('Lock'), this._scaleBindings.lockScale.control)),
                $('<td>').append(this._scaleBindings.lockScale.control).prependTo(q),
                (Y = function (e) {
                ...
                (N = this.addLabeledRow(O, window.t('Percent'), this._scaleBindings.percentage.control)),
                $('<td>').append(this._scaleBindings.percentage.control).prependTo(N),
                ...
                (H = this.addLabeledRow(O, window.t('Indexed to 100'), this._scaleBindings.indexedTo100.control)),
                $('<td>').append(this._scaleBindings.indexedTo100.control).prependTo(H),
                (this._scaleBindings.log = {}),
                (this._scaleBindings.logDisabled = {}),
                (this._scaleBindings.log.control = $('<input type="checkbox">')),
                (G = this.addLabeledRow(O, window.t('Logarithmic'), this._scaleBindings.log.control)),
                ...
                (U = this.addLabeledRow(O, window.t('Scale Price Chart Only'), j)),
                $('<td>').append(j).prependTo(U),
                this.bindControl(
                  new c(j, this._property.scalesProperties.scaleSeriesOnly, !0, this.model(), 'Scale Series Only')
                ),
                (this._scaleBindings.invertScale = {}),
                (K = $("<input type='checkbox'/>")),
                (this._scaleBindings.invertScale.control = K),
                (Q = this.addLabeledRow(O, window.t('Invert Scale'), this._scaleBindings.invertScale.control)),
                K.change(function () {
                  x('GUI', 'Scales', 'Invert Scale');
                }),
                $('<td>').append(this._scaleBindings.invertScale.control).prependTo(Q),
                (X = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                  'layout-tab',
                  a.TabNames.scales
                )),
                (Z = $('<input type="text" class="ticker ticker--longer-sign_8">')),
                (J = this.addLabeledRow(X, window.t('Top Margin'), Z)),
                $('<td>').appendTo(J).append(Z),
                $('<td>%</td>').appendTo(J),
                (ee = [d(this._property.paneProperties.topMargin.value())]).push(p(25)),
                ee.push(s(0)),
                this.bindControl(new h(Z, this._property.paneProperties.topMargin, ee, !0, this.model(), 'Top Margin')),
                (te = $('<input type="text" class="ticker ticker--longer-sign_8">')),
                (ie = this.addLabeledRow(X, window.t('Bottom Margin'), te)),
                $('<td>').appendTo(ie).append(te),
                $('<td>%</td>').appendTo(ie),
                (oe = [d(this._property.paneProperties.bottomMargin.value())]).push(p(25)),
                oe.push(s(0)),
                this.bindControl(
                  new h(te, this._property.paneProperties.bottomMargin, oe, !0, this.model(), 'Bottom Margin')
                ),
                t.enabled('chart_property_page_right_margin_editor') &&
                  ...
                  $('<td>' + window.t('bars', { context: 'margin' }) + '</td>').appendTo(ae),
                  (le = this._chart.timeScale()),
                  (re = [d(le.defaultRightOffsetProperty().value())]).push(p(~~le.maxRightOffset())),
                  re.push(s(0)),
                  this.bindControl(new h(ne, le.defaultRightOffsetProperty(), re, !0, this.model(), 'Right Margin'))),
                (se = $('<input type="text" class="ticker ticker--longer-sign_8">')),
                (ae = this.addLabeledRow(X, window.t('Price/Bar Ratio'), se)),
                (pe = !0),
                (de = function (e) {
                  this._undoModel.setScaleRatioProperty(this._property, e, this._undoText),
                    pe && (x('GUI', 'Scales', 'Edit scale ratio value'), (pe = !1));
                }),
                ...
                this.bindControl(be),
                (ue = $('<table class="property-page" cellspacing="0" cellpadding="2" width="100%">').data(
                  'layout-tab',
                  a.TabNames.scales
                )),
                t.enabled('countdown') &&
                  ((Ce = $("<input type='checkbox'>")),
                  (ge = this.addLabeledRow(ue, window.t('Countdown To Bar Close'), Ce)),
                  $('<td>').append(Ce).prependTo(ge),
                  this.bindControl(
                    new c(Ce, this._seriesProperty.showCountdown, !0, this.model(), 'Change Show Countdown')
                  )),
                (ye = $('<input type="checkbox">')),
                ($e = this.addLabeledRow(ue, window.t('Indicator Last Value'), ye)),
                ...
                (Te = this.addLabeledRow(ue, window.t('Symbol Name Label'), we)),
                ...
                (me = this.addLabeledRow(ue, window.t('Indicator Name Label'), _e)),
                ...
                $('<td>').append(this._scaleBindings.alignLabels.control).prependTo(Le),
                this._bindScaleProperties(),
                (fe = $('<div class="property-page-column-2">').append(O).append(X)),
                (ve = $('<div class="property-page-column-2">').append(ue)),
                (v = $('<div>').css('min-width', '620px').data('layout-tab', a.TabNames.scales)).append(fe).append(ve),
                (this.scalesTab = v),
                ...
                (ke = $('<tr>')),
                $('<td>' + window.t('Price Scales Placement') + '</td>').appendTo(ke),
                g.append(ke),
                ...
                this.bindControl(
                  new C(Be, this._seriesProperty.minTick, null, !0, this.model(), 'Change Decimal Places')
                )),
              t.enabled('chart_property_page_background') &&
                ((Ee = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
                ...
                this.bindControl(
                  new u(Fe, this._property.paneProperties.background, !0, this.model(), 'Change Chart Background Color')
                ),
                ...
                this.bindControl(
                  new u(Me, this._property.scalesProperties.textColor, !0, this.model(), 'Change Scales Text Color')
                ),
                ...
                this.bindControl(
                  new u(Ne, this._property.scalesProperties.lineColor, !0, this.model(), 'Change Scales Lines Color')
                ),
                ...
                $('<td>').append(Ke).appendTo(this.addRow(Ee).prepend('<td/><td/>')),
                this.bindControl(
                  new b(
                    Ke,
                ...
                null !== (Qe = this._model.watermarkSource()) &&
                  ...
                  this.bindControl(new c(Ze, Xe.visibility, !0, this.model(), 'Change Symbol Watermark Visibility')),
                  (et = this.createColorPicker()),
                  $('<td colspan="2">').append(et).appendTo(Je),
                  this.bindControl(new u(et, Xe.color, !0, this.model(), 'Change Symbol Watermark Color'))),
                (tt = $('<table class="property-page">')),
                (it = this.addLabeledRow(tt, window.t('Navigation Buttons'), null, !0)),
                (ot = $(document.createElement('select'))),
                k.availableValues().forEach(function (e) {
                  $(document.createElement('option')).attr('value', e.value).text(e.title).appendTo(ot);
                }),
                $('<td>').append(ot).appendTo(it),
                this.bindControl(
                  new C(ot, k.property(), null, !0, this.model(), 'Change Navigation Buttons Visibility')
                ),
                (nt = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
                ...
                (st = [
                  ...
                  $(document.createElement('option')).attr('value', e.value).text(e.title).appendTo(rt);
                }),
                this.bindControl(
                  new C(
                    rt,
                ...
                lt.find('td').eq(1).append($('<span>').css('margin-left', '30px').append(rt)),
                ...
                B &&
                  ...
                  (ct = this.addLabeledRow(nt, window.t('Show Chart Source Value Only'), ht)),
                ...
                (ut = this.addLabeledRow(nt, window.t('Bar Change Values'), bt)),
                ...
                ($t = this.addLabeledRow(nt, window.t('Indicator Arguments'), yt)),
                (wt = function (e) {
                ...
                this._property.paneProperties.legendProperties.showStudyTitles.listeners().subscribe(this, wt),
                wt(this._property.paneProperties.legendProperties.showStudyTitles),
                ...
                (S = $('<div>').css('min-width', '620px').data('layout-tab', a.TabNames.background))
                  .append(mt)
                  .append(Lt)
                  .append(ft)),
              t.enabled('chart_property_page_timezone_sessions') &&
                ...
                (ae = $('<tr>').appendTo(R)),
                (vt = $('<td>').appendTo(ae)),
                (kt = $('<table cellspacing="0" cellpadding="0">').appendTo(vt)),
              ...
              (l = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">')
                .css({ width: '100%' })
                .data('layout-separated', !0)),
              (P = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                a.TabNames.drawings
              )),
              (this._table = $()
          ...
          (o.prototype._bindScaleProperties = function () {
            var e,
              ...
              a = this,
              l = function (t) {
                (e = { autoScale: t }), this._undoModel.setPriceScaleMode(e, a._series.priceScale(), this._undoText);
              };
            (this._scaleBindings.autoScale.binder = new c(
              ...
              (t = function (t) {
                (e = { percentage: t }), this._undoModel.setPriceScaleMode(e, a._series.priceScale(), this._undoText);
              }),
              ...
              (i = function (t) {
                (e = { indexedTo100: t }), this._undoModel.setPriceScaleMode(e, a._series.priceScale(), this._undoText);
              }),
              ...
              (o = function (t) {
                (e = { log: t }), this._undoModel.setPriceScaleMode(e, a._series.priceScale(), this._undoText);
              }),
              ...
              (n = function (t) {
                (e = { lockScale: t }), this._undoModel.setPriceScaleMode(e, a._series.priceScale(), this._undoText);
              }),
          ...
          (o.prototype.switchStyle = function () {
            if (this._hasSeriesStyleLayout) {
              ...
              this._priceLineTable.css(
                'display',
                this._seriesProperty.style.value() === _.STYLE_HILO ? 'none' : 'table'
              );
            }
          }),
          (o.prototype.onResoreDefaults = function () {
            ...
            t.listeners().fire(t),
              ...
              (e = this._model.model().properties().timezone).listeners().fire(e);
          }),
          ...
          (o.prototype.createSessTable = function (e) {
            ...
            return (
              ...
              this.bindControl(
                new c(n, i.vertlines.sessBreaks.visible, !0, this.model(), 'Change Sessions Breaks visibility')
              ),
              this.bindControl(new u(r, i.vertlines.sessBreaks.color, !0, this.model(), 'Change Session Breaks color')),
              this.bindControl(
                new C(l, i.vertlines.sessBreaks.style, parseInt, !0, this.model(), 'Change Session Breaks style')
              ),
              this.bindControl(new b(s, i.vertlines.sessBreaks.width, !0, this.model(), 'Change Session Breaks width')),
          ...
          (o.prototype.addTimezoneEditorRow = function (e) {
            ...
            for (
              ...
              o += '<option value="' + v[n].id + '">' + v[n].title + '</option>';
            (a = $('<select>' + o + '</select>')).appendTo(i),
              this.bindControl(new C(a, this._property.timezone, null, !0, this.model(), 'Change Timezone'));
          }),
          (o.prototype.addTateFormatEditorRow = function (e) {
            ...
            for (
              ...
              (l = new E(P[a])), (o += '<option value="' + P[a] + '">' + l.format(n) + '</option>');
            (r = $('<select>' + o + '</select>')).appendTo(i),
              (s = new C(r, R, null, !0, this.model(), 'Change Date Format')).disableAffectingSave(),
              this.bindControl(s),
              r.change(function () {
                var e = R.value();
          ...
          (o.prototype._createStudySessRow = function (e, t, i) {
            var o = $("<input type='checkbox' />"),
              ...
              a = m($('<td>').appendTo(n));
            return (
              this.bindControl(new c(o, i.visible, !0, this.model(), 'Change ' + t + ' visibility')),
              this.bindControl(new u(a, i.color, !0, this.model(), t + ' color', i.transparency)),
          ...
          (o.prototype.createTradingTable = function () {
            ...
            return (
              ...
              this.bindControl(
                new b(o, this._property.tradingProperties.lineWidth, !0, this.model(), 'Change Connecting Line Width')
              ),
              (n = L()),
              this.bindControl(
                new C(
              ...
              (r = [d(this._property.tradingProperties.lineLength.value()), p(100), s(0)]),
              this.bindControl(
                new h(
                  l,
    ...
    '1ANp': function (e, t, i) {
      ...
      function n() {
        if (!h) {
          (h = new p.a()).setValue(o(d.getValue('NavigationButtons.visibility'))),
      ...
      function l() {
        ...
        return (
          c ||
            ...
            (t = function () {
              var t = e.value();
              'alwaysOn' !== t && 'alwaysOff' !== t && (t = Modernizr.mobiletouch ? 'alwaysOn' : 'visibleOnMouseOver'),
                c && c.setValue(t);
            }),
            (e = n()).subscribe(c, t),
            t()),
      ...
      i('YFKU'),
        ...
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(
              new l(t, this._linetool.properties().degree, parseInt, !0, this.model(), 'Change Elliott Wave Size')
            ),
            this.bindControl(
              new p(o, this._linetool.properties().showWave, !0, this.model(), 'Change Elliott Labels Background')
            ),
            this.bindControl(
              new s(a, this._linetool.properties().linewidth, parseInt, this.model(), 'Change Elliott Wave Line Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, a),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(new l(t, this._study.properties().font, null, !0, this.model(), 'Change Pivots Font')),
            this.bindControl(
              new l(e, this._study.properties().fontsize, parseInt, !0, this.model(), 'Change Pivots Font Size')
            ),
            this.bindControl(new r(i, this._property.levelsStyle.showLabels, !0, C.model(), 'Show Pivot Labels')),
            ...
            (function (e, t, i, o) {
              var n, a;
              for (n = 0; n < e._childs.length; n++) o(e[(a = e._childs[n])], t[a], i[a], a);
              ...
              C.bindControl(new r(h, e, !0, C.model(), 'Change ' + o)),
                ...
                C.bindControl(new p(l, t, !0, C.model(), 'Change ' + o + ' color')),
                (d = C.createLineWidthEditor()),
                $('<td>').append(d).appendTo(n),
                C.bindControl(new s(d, i, !0, C.model(), 'Change ' + o + ' width')),
      ...
      inherit(o, n),
        ...
        (o.prototype.addLevelEditor = function (e, t, i) {
          ...
          _.appendTo(this._table),
            e
              ? ((o = $('<td>')).appendTo(_),
                (n = $("<input type='checkbox' class='visibility-switch'>")).appendTo(o),
                (a = $('<td>')).appendTo(_),
                (b = $("<input type='text'>")).appendTo(a),
                b.css('width', '70px'),
                this.bindControl(new l(n, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility')),
                this.bindControl(new r(b, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')))
              : ($('<td></td>').appendTo(_), $('<td>' + $.t('Median') + '</td>').appendTo(_)),
            ...
            this.bindControl(new s(C, t.color, !0, this.model(), 'Change Pitchfork Line Color', 0)),
            this.bindControl(new p(T, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style')),
            this.bindControl(new d(y, t.linewidth, !0, this.model(), 'Change Pitchfork Line Width'));
        }),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a;
          for (
          ...
          this.addOneColorPropertyWidget(this._table),
            ...
            this.bindControl(
              new p(a, this._linetool.properties().style, parseInt, !0, this.model(), 'Change Pitchfork Style')
            ),
            this.bindControl(
              new l(
                o,
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            (e = this.createLineWidthEditor()),
            (t = this.createColorPicker()),
            (i = this.addLabeledRow(this._table, $.t('Border'))).prepend('<td>'),
            $('<td>').append(t).appendTo(i),
            ...
            this.bindControl(
              new l(o, this._linetool.properties().fillBackground, !0, this.model(), 'Change Triangle Filling')
            ),
            this.bindControl(
            ...
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Triangle Border Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
    ...
    '5fTj': function (e, t, i) {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a, h, c, b, u, C, g, y, w, T, _, m, L, f, v, k, S, x, B;
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(
              new l(h, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new l(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new r(a, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            ...
            this.bindControl(
              new s(x, this._linetool.properties().showPrices, !0, this.model(), 'Change Disjoint Angle Show Prices')
            ),
            this.bindControl(
              new s(m, this._linetool.properties().extendLeft, !0, this.model(), 'Change Disjoint Angle Extending Left')
            ),
            this.bindControl(
              new s(
                f,
            ...
            this.bindControl(
              new l(i, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Disjoint Angle Style')
            ),
            this.bindControl(
              new p(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Disjoint Angle Width')
            ),
            this.bindControl(
              new l(
                v,
            ...
            this.bindControl(
              new s(g, this._linetool.properties().fillBackground, !0, this.model(), 'Change Disjoint Angle Filling')
            ),
            this.bindControl(
              new r(
                y,
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            this.bindControl(
              new l(t, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Price Text Font Size')
            ),
            this.bindControl(
              new r(
                i,
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function (e, t, i) {
          ...
          b.appendTo(e),
            ...
            p.css('width', '70px'),
            this.bindControl(new l(n, i.visible, !0, this.model(), 'Change Gann Square Line Visibility')),
            this.bindControl(new s(p, i.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')),
            (d = $("<td class='colorpicker-cell'>")).appendTo(b),
            (c = h(d)),
            this.bindControl(new r(c, i.color, !0, this.model(), 'Change Gann Square Line Color', 0));
        }),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a, s, h, u, C, g, y, w, T, _, m, L, f, v, k, S, x, B;
          for (
            this._table = $(document.createElement('table')),
            ...
            (h = 'hlevel' + s), this.addLevelEditor(n, 'Level ' + s, this._linetool.properties()[h]);
          for (s = 1; s <= 7; s++)
            (h = 'vlevel' + s), this.addLevelEditor(a, 'Level ' + s, this._linetool.properties()[h]);
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function (e, t, i, o) {
          ...
          T.appendTo(this._tbody),
            (n = 'control-level-' + i + '-' + o),
            (a = $('<td>')).appendTo(T),
            (c = $("<input type='checkbox' class='visibility-switch' id='" + n + "'>")).appendTo(a),
            ...
            this.bindControl(new l(c, t.visible, !0, this.model(), 'Change Gann Fan Line Visibility')),
            this.bindControl(new r(u, t.color, !0, this.model(), 'Change Gann Fan Line Color', 0)),
            this.bindControl(new s(w, t.linestyle, parseInt, !0, this.model(), 'Change Gann Fan Line Style')),
            this.bindControl(new p(g, t.linewidth, !0, this.model(), 'Change Gann Fan Line Width'));
        }),
        (o.prototype.prepareLayout = function () {
          var e,
            t,
          ...
          this.addOneColorPropertyWidget(this._tbody),
            ...
            $('<td>').append(r).prependTo(s),
            this.bindControl(
              new l(r, this._linetool.properties().showLabels, !0, this.model(), 'Change Gann Fan Labels Visibility')
            ),
            (this._table = b.add(u)),
        ...
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this._linetool.properties().fillBackground &&
              ...
              $('<td>').append(h).appendTo(n)),
            this.bindControl(
              new r(o, this._linetool.properties().linecolor, !0, this.model(), 'Change Time Cycles Color')
            ),
            this.bindControl(
              new l(
                i,
            ...
            this.bindControl(
              new s(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Time Cycles Line Width')
            ),
            a &&
              (this.bindControl(
                new p(a, this._linetool.properties().fillBackground, !0, this.model(), 'Change Time Cycles Filling')
              ),
              this.bindControl(
                new r(
                  h,
    ...
    A3Hk: function (e, t, i) {
      ...
      function o() {
        var e = $('<select />');
        return (
          $('<option value="' + n.LeftToRight + '">' + $.t('Left') + '</option>').appendTo(e),
          $('<option value="' + n.RightToLeft + '">' + $.t('Right') + '</option>').appendTo(e),
          e
        );
      }
      var n, a;
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function (e, t, i) {
          ...
          b.appendTo(e),
            ...
            (c = d(h)),
            this.bindControl(new s(c, i.color, !0, this.model(), 'Change Gann Square Line Color', 0));
        }),
        (o.prototype.addFannEditor = function (e) {
          ...
          n.appendTo($('<td>').appendTo(o)),
            ...
            this.bindControl(
              new s(i, this._linetool.properties().fans.color, !0, this.model(), 'Change Gann Square Angles Color', 0)
            );
        }),
        (o.prototype.prepareLayout = function () {
          ...
          for (
            ...
            (s = 'hlevel' + r), this.addLevelEditor(n, $.t('Level {0}').format(r), this._linetool.properties()[s]);
          for (r = 1; r <= 7; r++)
            (s = 'vlevel' + r), this.addLevelEditor(a, $.t('Level {0}').format(r), this._linetool.properties()[s]);
          this.addFannEditor(n),
            ...
            (g = $('<tr>').appendTo(C)),
            (y = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(
            ...
            this._linetool.properties().reverse &&
              ...
              this.bindControl(
                new l(L, this._linetool.properties().reverse, !0, this.model(), 'Change Gann Box Reverse')
              )),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            $('<td>').append(n).appendTo(i),
            this.bindControl(
              new l(o, this._linetool.properties().fillBackground, !0, this.model(), 'Change Polyline Filling')
            ),
            this.bindControl(
            ...
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Polyline Border Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._block = $('<div>').addClass('property-page')),
            ...
            (u = $('<table cellspacing="0" cellpadding="2">').appendTo(this._block)),
            (C = $(
              "<select><option value='0'>" +
                $.t('Normal') +
                "</option><option value='1'>" +
            ...
            this.bindControl(
              new l(n, this._linetool.properties().linecolor, !0, this.model(), 'Change Curve Line Color')
            ),
            this.bindControl(
              new r(o, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Curve Line Style')
            ),
            this.bindControl(
              new s(i, this._linetool.properties().linewidth, !0, this.model(), 'Change Curve Line Width')
            ),
            this.bindControl(
              new p(c, this._linetool.properties().fillBackground, !0, this.model(), 'Change Curve Filling')
            ),
            this.bindControl(
              new l(
                b,
            ...
            this.bindControl(
              new r(g, this._linetool.properties().rightEnd, parseInt, !0, this.model(), 'Change Curve Line Right End')
            ),
            this.bindControl(
              new p(w, this._linetool.properties().extendLeft, !0, this.model(), 'Change Curve Line Extending Left')
            ),
            this.bindControl(
              new p(_, this._linetool.properties().extendRight, !0, this.model(), 'Change Curve Line Extending Right')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
        ...
        (o.prototype.prepareLayout = function () {
          ...
          for (this._table = h.add(c), e = this._linetool.points(), t = 0; t < e.length; t++)
            (i = $('<tr>')).appendTo(h),
              ...
              this.bindBarIndex(p.bar, l, this.model(), 'Change ' + this._linetool + ' point bar index');
          ...
          g.appendTo(this._table),
            ...
            e
              ? ((a = $('<td>')).appendTo(g),
                ...
                h.css('width', '70px'),
                this.bindControl(new l(h, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')))
            ...
            this.bindControl(new s(b, t.color, !0, this.model(), 'Change Fib Wedge Line Color', 0)),
            this.bindControl(new p(C, t.linewidth, !0, this.model(), 'Change Fib Wedge Width'));
        }),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a;
          for (
    ...
    IfF0: function (e, t, i) {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a, d, h, c, b, u, C, g, y, w, T, _, m, L, f, v, k, S;
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            (e = $('<tbody>').appendTo(this._table)),
            (t = this.createLineWidthEditor()),
            (i = this.createColorPicker()),
            ...
            this.bindControl(new l(h, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(
              new r(
                c,
            ...
            this.bindControl(
              new s(b, this._linetool.properties().fillLabelBackground, !0, this.model(), 'Change Text Background Fill')
            ),
            this.bindControl(
              new r(
                u,
            ...
            this.bindControl(
              new s(C, this._linetool.properties().fillBackground, !0, this.model(), 'Change Text Background Fill')
            ),
            this.bindControl(
              new r(a, this._linetool.properties().borderColor, !0, this.model(), 'Change Text Border Color')
            ),
            ...
            this.bindControl(
              new p(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Date Range Line Width')
            ),
            void 0 !== (w = this._linetool.properties()).extendTop &&
              void 0 !== w.extendBottom &&
              ((T = $('<input type="checkbox">')),
              (_ = $('<input type="checkbox">')),
              this.bindControl(new s(T, this._linetool.properties().extendTop, !0, this.model(), 'Change Extend Top')),
              this.bindControl(
                new s(_, this._linetool.properties().extendBottom, !0, this.model(), 'Change Extend Bottom')
              ),
            ...
            void 0 !== w.extendLeft &&
              ...
              (v = $('<input type="checkbox">')),
              this.bindControl(
                new s(f, this._linetool.properties().extendLeft, !0, this.model(), 'Change Extend Left')
              ),
              this.bindControl(
                new s(v, this._linetool.properties().extendRight, !0, this.model(), 'Change Extend Right')
              ),
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            this.bindControl(
              new l(o, this._linetool.properties().linewidth, !0, this.model(), 'Change Projection Border Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, a),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            this.bindControl(
              new d(t, this._linetool.properties().color, !0, this.model(), 'Change Bars Pattern Color')
            ),
            this.bindControl(
              new p(o, this._linetool.properties().mode, null, !0, this.model(), 'Change Bars Pattern Mode')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
        ...
        (n.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            (p = [s(r.price.value())]),
            this.bindControl(new c(o, r.price, p, !1, this.model(), 'Change ' + this._linetool + ' point price')),
            this.bindBarIndex(r.bar, l, this.model(), 'Change ' + this._linetool + ' point bar index'),
            this.loadData();
        }),
        ...
        (o.prototype.prepareLayout = function () {
          ...
          o.levels._childs))
            (y = o.levels[g]),
              ...
              this.bindControl(new p(T, y.visible, !0, t, 'Change Gann Line Visibility')),
              this.bindControl(new h(m, y.color, !0, t, 'Change Gann Line Color', 0)),
              this.bindControl(new d(f, y.width, !0, t, 'Change Gann Line Width'));
          for (g in ((v = $('<table>')),
          ...
          o.fanlines._childs))
            (S = o.fanlines[g]),
              ...
              (L = $('<td>')).appendTo(x),
              (f = this.createLineWidthEditor()).appendTo(L),
              this.bindControl(new p(T, S.visible, !0, t, 'Change Gann Line Visibility')),
              this.bindControl(new h(m, S.color, !0, t, 'Change Gann Fan Color', 0)),
              this.bindControl(new d(f, S.width, !0, t, 'Change Gann Line Width'));
          for (g in ((P = $('<table>')),
          ...
          o.arcs._childs))
            (E = o.arcs[g]),
              ...
              (L = $('<td>')).appendTo(F),
              (f = this.createLineWidthEditor()).appendTo(L),
              this.bindControl(new p(T, E.visible, !0, t, 'Change Gann Line Visibility')),
              this.bindControl(new h(m, E.color, !0, t, 'Change Gann Arc Color', 0)),
              this.bindControl(new d(f, E.width, !0, t, 'Change Gann Line Width'));
          this.addOneColorPropertyWidget(P),
            ...
            this.bindControl(new p(I, o.arcsBackground.fillBackground, !0, t, 'Change Gann Square Filling')),
            this.bindControl(
              new d(W, o.arcsBackground.transparency, !0, t, 'Change Gann Square Background Transparency')
            ),
            (M = $('<input type="text">')),
            ...
            (N = new b(M, o.scaleRatio, Y, !1, t, O, q)).addFormatter(function (e) {
            ...
            this.bindControl(new p(H, o.showLabels, !0, t, 'Change Gann Square Lables Visibility')),
            ...
            (Q = o.labelsStyle),
            this.bindControl(new c(U, Q.fontSize, parseInt, !0, t, 'Change Text Font Size')),
            this.bindControl(new c(K, Q.font, null, !0, t, 'Change Text Font')),
            this.bindControl(new p(G, Q.bold, !0, t, 'Change Text Font Bold')),
            this.bindControl(new p(j, Q.italic, !0, t, 'Change Text Font Italic')),
            (X = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
      ...
      inherit(o, a),
        (o.prototype.prepareLayout = function () {
          ...
          this.bindControl(new r(n, this._linetool.properties().textColor, !0, this.model(), 'Change Text Color')),
            ...
            this.bindControl(new s(l, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new p(h, this._linetool.properties().text, null, !0, this.model(), 'Change Text')),
            this.bindControl(
              new r(c, this._linetool.properties().markerColor, !0, this.model(), 'Change Marker and Border Color')
            ),
            this.bindControl(
              new r(
                b,
            ...
            $(document.createElement('tr'))
              ...
              .append($(document.createElement('td')).attr({ width: 1 }).append(l))
        ...
        (o.prototype.dialogPosition = function (e, t) {
          ...
          if (e && t) {
            ...
            return (
              ...
              (s = new n(0, 0)),
              r && (s = r._floatPoints[0] || this._linetool._fixedPoints[0] || s),
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function (e, t, i) {
          ...
          _.appendTo(this._table),
            ...
            (T = c()).render().appendTo(w),
            this.bindControl(new s(C, t.color, !0, this.model(), 'Change Pitchfork Line Color'), 0),
            this.bindControl(new p(T, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfan Line Style')),
            this.bindControl(new d(y, t.linewidth, !0, this.model(), 'Change Pitchfan Line Width'));
        }),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n;
          for (
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            this.bindControl(
              new l(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Circle Lines Style')
            ),
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Circle Lines Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
    ...
    NHMx: function (e, t, i) {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          this.bindControl(new r(n, this._linetool.properties().color, !0, this.model(), 'Change Text Color')),
            this.bindControl(
              new s(a, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new s(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new d(b, this._linetool.properties().text, null, !0, this.model(), 'Change Text')),
            this.bindControl(
              new r(
                u,
                this._linetool.properties().backgroundColor,
            ...
            this.bindControl(new r(g, this._linetool.properties().bordercolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new p(C, this._linetool.properties().linewidth, !0, this.model(), 'Change Border Width')),
            this.bindControl(new l(y, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap')),
            this.bindControl(new l(w, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new l(T, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            (e = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
              'layout-tab-open',
              h.Override
            )),
            ...
            $(document.createElement('tr'))
              ...
              .appendTo(e),
            $(document.createElement('tr'))
              .append($(document.createElement('td')).attr({ colspan: 5 }).append(b))
              .appendTo(e),
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          var e,
            ...
            w,
            T,
            _ = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
            m = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">').css({
              width: '100%',
            }),
          ...
          (this._table = _.add(m).add(L)),
            ...
            this.bindControl(new l(e, this._linetool.properties().linecolor, !0, this.model(), 'Forecast Line Color')),
            this.bindControl(new r(t, this._linetool.properties().linewidth, !0, this.model(), 'Forecast Line Width')),
            this.bindControl(new l(e, this._linetool.properties().linecolor, !0, this.model(), 'Forecast Line Color')),
            this.bindControl(new r(t, this._linetool.properties().linewidth, !0, this.model(), 'Forecast Line Width')),
            this.bindControl(
              new l(
            ...
            this.bindControl(
              new l(c, this._linetool.properties().sourceStrokeColor, !0, this.model(), 'Forecast Source Border Color')
            ),
            this.bindControl(
              new l(h, this._linetool.properties().sourceTextColor, !0, this.model(), 'Forecast Source Text Color')
            ),
            this.bindControl(
              new l(
                C,
            ...
            this.bindControl(
              new l(y, this._linetool.properties().targetStrokeColor, !0, this.model(), 'Forecast Target Border Color')
            ),
            this.bindControl(
              new l(g, this._linetool.properties().targetTextColor, !0, this.model(), 'Forecast Target Text Color')
            ),
            this.bindControl(
              new l(b, this._linetool.properties().successBackground, !0, this.model(), 'Forecast Success Back Color')
            ),
            this.bindControl(
              new l(u, this._linetool.properties().successTextColor, !0, this.model(), 'Forecast Success Text Color')
            ),
            this.bindControl(
              new l(w, this._linetool.properties().failureBackground, !0, this.model(), 'Forecast Failure Back Color')
            ),
            this.bindControl(
              new l(T, this._linetool.properties().failureTextColor, !0, this.model(), 'Forecast Failure Text Color')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
    ...
    QxMc: function (e, t, i) {
      ...
      inherit(o, n),
        ...
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a, h, c, b, u, C, g, y, w, T, _, m, L, f, v, k, S, x, B, P, R, E;
          ...
          t.levels._childs))
            (a = t.levels[n]),
              ...
              (C = $('<td>')).appendTo(h),
              (g = this.createLineWidthEditor()).appendTo(C),
              this.bindControl(new l(c, a.visible, !0, this.model(), 'Change Gann Line Visibility')),
              this.bindControl(new s(u, a.color, !0, this.model(), 'Change Gann Line Color', 0)),
          ...
          t.fanlines._childs))
            (T = t.fanlines[n]),
              ...
              (C = $('<td>')).appendTo(_),
              (g = this.createLineWidthEditor()).appendTo(C),
              this.bindControl(new l(c, T.visible, !0, this.model(), 'Change Gann Line Visibility')),
              this.bindControl(new s(u, T.color, !0, this.model(), 'Change Gann Fan Color', 0)),
              this.bindControl(new r(g, T.width, !0, this.model(), 'Change Gann Line Width'));
          for (n in ((L = $('<table>')),
          ...
          t.arcs._childs))
            (v = t.arcs[n]),
              ...
              (C = $('<td>')).appendTo(k),
              (g = this.createLineWidthEditor()).appendTo(C),
              this.bindControl(new l(c, v.visible, !0, this.model(), 'Change Gann Line Visibility')),
              this.bindControl(new s(u, v.color, !0, this.model(), 'Change Gann Arc Color', 0)),
              this.bindControl(new r(g, v.width, !0, this.model(), 'Change Gann Line Width'));
          this.addOneColorPropertyWidget(L),
            ...
            t.reverse &&
              ...
              this.bindControl(new l(E, t.reverse, !0, this.model(), 'Change Gann Square Reverse'))),
            this.bindControl(new l(x, t.arcsBackground.fillBackground, !0, this.model(), 'Change Gann Square Filling')),
            this.bindControl(
          ...
          (o.prototype.prepareLayout = function () {
            ...
            (this._block = $('<table class="property-page">')),
              ...
              t.enabled('seconds_resolution') &&
                ...
                this.bindControl(new l(n, e.seconds, !0, this.model(), 'Change Line Tool Visibility On Seconds')),
                this.bindControl(
                  new r(
                    p,
              ...
              (d = $("<input type='text'>").addClass('ticker-text')),
              $('<td>').append(d).appendTo(i),
              this.bindControl(new l(h, e.minutes, !0, this.model(), 'Change Line Tool Visibility On Minutes')),
              this.bindControl(
                new r(
                  p,
              ...
              (d = $("<input type='text'>").addClass('ticker-text')),
              $('<td>').append(d).appendTo(i),
              this.bindControl(new l(b, e.hours, !0, this.model(), 'Change Line Tool Visibility On Hours')),
              this.bindControl(
                new r(
                  p,
              ...
              (d = $("<input type='text'>").addClass('ticker-text')),
              $('<td>').append(d).appendTo(i),
              this.bindControl(new l(u, e.days, !0, this.model(), 'Change Line Tool Visibility On Days')),
              this.bindControl(
                new r(
                  p,
                  [e.daysFrom, e.daysTo],
              ...
              $('<td>').append(o).appendTo(i),
              this.bindControl(new l(C, e.weeks, !0, this.model(), 'Change Line Tool Visibility On Weeks')),
              (i = $('<tr>').css('height', '29px').appendTo(this._block)),
              (o = $('<label>').append($.t('Months'))),
              (g = $("<input type='checkbox'>").prependTo(o)),
              $('<td>').append(o).appendTo(i),
              this.bindControl(new l(g, e.months, !0, this.model(), 'Change Line Tool Visibility On Months')),
              this.loadData();
          }),
          (o.prototype.widget = function () {
            return this._block;
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            $('<td>').append(n).appendTo(i),
            this.bindControl(
              new r(o, this._linetool.properties().fillBackground, !0, this.model(), 'Change Rectangle Filling')
            ),
            this.bindControl(
              new l(t, this._linetool.properties().color, !0, this.model(), 'Change Rectangle Line Color')
            ),
            this.bindControl(
              new l(
                n,
            ...
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Rectangle Border Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
          ...
          _.appendTo(this._table),
            ...
            e
              ? ((a = $('<td>')).appendTo(_),
                (b = $("<input type='text'>")).appendTo(a),
                b.css('width', '70px'),
                this.bindControl(new l(b, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')))
            ...
            this.bindControl(new s(C, t.color, !0, this.model(), 'Change Pitchfork Line Color', 0)),
            this.bindControl(new p(T, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style')),
            this.bindControl(new d(y, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'));
        }),
        (o.prototype.prepareLayout = function () {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            (n = $('<tr>').appendTo(e)),
            (a = $('<td>').appendTo(n)),
            (h = $("<input type='checkbox' class='visibility-switch'>")).appendTo(a),
            ...
            (n = $('<tr>').appendTo(e)),
            (C = $('<td>').appendTo(n)),
            (g = $("<input type='checkbox' class='visibility-switch'>")).appendTo(C),
            ...
            (_ = this.addEditorRow(w, 'Extend Right', $("<input type='checkbox'>"), 2)),
            (m = this._linetool.properties()),
            this.bindControl(new l(g, m.fillBackground, !0, this.model(), 'Change Parallel Channel Fill Background')),
            this.bindControl(new l(h, m.showMidline, !0, this.model(), 'Change Parallel Channel Show Center Line')),
            this.bindControl(new l(T, m.extendLeft, !0, this.model(), 'Change Parallel Channel Extending Left')),
            this.bindControl(new l(_, m.extendRight, !0, this.model(), 'Change Parallel Channel Extending Right')),
            this.bindControl(new r(o, m.linecolor, !0, this.model(), 'Change Parallel Channel Color')),
            this.bindControl(new s(i, m.linestyle, parseInt, !0, this.model(), 'Change Parallel Channel Style')),
            this.bindControl(new p(t, m.linewidth, !0, this.model(), 'Change Parallel Channel Width')),
            this.bindControl(new r(u, m.midlinecolor, !0, this.model(), 'Change Parallel Channel Middle Color')),
            this.bindControl(
              new s(b, m.midlinestyle, parseInt, !0, this.model(), 'Change Parallel Channel Middle Style')
            ),
            this.bindControl(new p(c, m.midlinewidth, !0, this.model(), 'Change Parallel Channel Middle Width')),
            this.bindControl(
              new r(y, m.backgroundColor, !0, this.model(), 'Change Parallel Channel Back Color', m.transparency)
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            (d = this.createFontEditor()),
            this.bindControl(
              new l(t, this._linetool.properties().color, !0, this.model(), 'Change Pattern Line Color')
            ),
            this.bindControl(
              new l(i, this._linetool.properties().textcolor, !0, this.model(), 'Change Pattern Text Color')
            ),
            this.bindControl(
            ...
            this.bindControl(new s(d, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new p(o, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new p(n, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
      ...
      inherit(o, l),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            (C = [d(this._linetool.properties().stopLevel.value()), p(0), s(1e9)]),
            this.bindControl(
              new c(
                o,
            ...
            (C = [d(this._linetool.properties().profitLevel.value()), p(0), s(1e9)]),
            this.bindControl(
              new c(
                b,
        ...
        (n.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this._riskEdit.data('step', f.getRiskStep(v.riskDisplayMode.value())),
            ...
            this.bindControl(new b(i, v.linecolor, !0, this.model(), 'Change Risk/Reward line Color')),
            this.bindControl(new u(t, v.linewidth, !0, this.model(), 'Change Risk/Reward line width')),
            this.bindControl(
              new b(n, v.stopBackground, !0, this.model(), 'Change stop color', v.stopBackgroundTransparency)
            ),
            this.bindControl(
              new b(a, v.profitBackground, !0, this.model(), 'Change target color', v.profitBackgroundTransparency)
            ),
            this.bindControl(new C(r, v.fontsize, parseInt, !0, this.model(), 'Change Text Font Size')),
            this.bindControl(new C(d, v.font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new b(l, v.textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new g(w, v.compact, !0, this.model(), 'Compact mode')),
            (m = [h(v.accountSize.value()), p(1), s(1e9)]),
            this.bindControl(
              new c(T, v.accountSize, m, !1, this.model(), 'Change ' + this._linetool + ' Account Size')
            ),
            this.bindControl(new C(_, v.riskDisplayMode, null, !0, this.model(), '% / Cash')),
            (L = [
              h(v.risk.value()),
              p(1),
              function (e) {
                ...
                return (
                  (e = 'percents' === i ? (e > 100 ? 100 : e) : e > (t = v.accountSize.value()) ? t : e),
                  f.riskFormatter(i).format(e)
                );
              },
            ]),
            this.bindControl(new c(this._riskEdit, v.risk, L, !1, this.model(), 'Change ' + this._linetool + ' Risk')),
            this.loadData();
        }),
    ...
    Yc1q: function (e, t, i) {
      ...
      inherit(n, l),
        (n.prototype.createOneColorForAllLinesWidget = function () {
          ...
          return (
            this.bindControl(
              new r(s(e), this._linetool.properties().collectibleColors, !0, this.model(), 'Change All Lines Color', 0)
            ),
    ...
    a0Rg: function (e, t, i) {
      ...
      function o() {
        var e = $('<select />');
        return (
          $('<option value="' + a.LineStudyPlotStyle.Line + '">' + $.t('Line') + '</option>').appendTo(e),
          $(
            '<option value="' + a.LineStudyPlotStyle.LineWithBreaks + '">' + $.t('Line With Breaks') + '</option>'
          ).appendTo(e),
          $('<option value="' + a.LineStudyPlotStyle.StepLine + '">' + $.t('Step Line') + '</option>').appendTo(e),
          $('<option value="' + a.LineStudyPlotStyle.Histogram + '">' + $.t('Histogram') + '</option>').appendTo(e),
          $(
            '<option value="' +
          ...
          $('<option value="' + a.LineStudyPlotStyle.Area + '">' + $.t('Area') + '</option>').appendTo(e),
          $(
            '<option value="' + a.LineStudyPlotStyle.AreaWithBreaks + '">' + $.t('Area With Breaks') + '</option>'
          ).appendTo(e),
          $('<option value="' + a.LineStudyPlotStyle.Columns + '">' + $.t('Columns') + '</option>').appendTo(e),
          $('<option value="' + a.LineStudyPlotStyle.Circles + '">' + $.t('Circles') + '</option>').appendTo(e),
          e
        );
      }
      var n, a;
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(
              new s(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Fib Spiral Line Width')
            ),
            (a = $('<input type="checkbox">')),
            (h = this.addLabeledRow(this._table, window.t('Counterclockwise'), a)),
            $('<td>').append(a).prependTo(h),
            this.bindControl(
              new p(a, this._linetool.properties().counterclockwise, !0, this.model(), 'Change Counterclockwise')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function (e, t, i) {
          ...
          _.appendTo(this._table),
            ...
            (T = c()).render().appendTo(w),
            this.bindControl(new r(n, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility')),
            this.bindControl(new d(C, t.color, !0, this.model(), 'Change Pitchfork Line Color', 0)),
            this.bindControl(new p(T, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style')),
            this.bindControl(new s(y, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'));
        }),
        (o.prototype.prepareLayout = function () {
          ...
          this.addOneColorPropertyWidget(this._table),
            (i = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">').css({
              width: '100%',
            })),
            (o = $('<tr>').appendTo(i)),
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          this.bindControl(new s(n, this._linetool.properties().color, !0, this.model(), 'Change Text Color')),
            this.bindControl(
              new r(d, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new r(h, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            ...
            this.bindControl(
              new p(u, this._linetool.properties().fillBackground, !0, this.model(), 'Change Text Background Fill')
            ),
            this.bindControl(new p(C, this._linetool.properties().drawBorder, !0, this.model(), 'Change Text Border')),
            this.bindControl(
              new s(a, this._linetool.properties().borderColor, !0, this.model(), 'Change Text Border Color')
            ),
            this.bindControl(new p(g, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap')),
            this.bindControl(new p(y, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new p(w, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            (e = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            (t = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            (i = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            (this._table = e.add(i).add(t)),
        ...
        (o.prototype.dialogPosition = function (e, t) {
          ...
          return (
            $.each(b.paneWidgets(), function (e, t) {
              if (t._state === c) return (d = $(t.canvasElement()).offset().top), !1;
            }),
            e || (e = {}),
            (o = e.left),
            (n = e.top),
            (a = (this._linetool.paneViews() || [])[0]) && (i = a._floatPoints[0]),
            i && ((o = i.x), (n = i.y + d)),
            (l = $(t).outerHeight()),
            (r = $(window).height()),
            {
              top: (n = n + l + (s = h.properties().fontsize.value()) + p <= r ? n + s + p : n - l - p),
              left: o,
            }
          );
        }),
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">').css({ width: '100%' })),
            ...
            this.bindControl(
              new l(e, this._linetool.properties().text, null, !0, this.model(), 'Change Arrow Mark Text')
            ),
            this.bindControl(
              new s(o, this._linetool.properties().font, null, !0, this.model(), 'Change Arrow Mark Font')
            ),
            this.loadData(),
            setTimeout(function () {
              e.select(), e.focus();
      ...
      inherit(o, a),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            this.bindControl(
              new s(n, this._linetool.properties().showTime, !0, this.model(), 'Change Vert Line Time Visibility')
            ),
            this.bindControl(
              new h(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Vert Line Color')
            ),
            this.bindControl(
              new p(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Vert Line Style')
            ),
            this.bindControl(
              new d(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Vert Line Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            $('<td>').append(n).appendTo(i),
            this.bindControl(
              new l(o, this._linetool.properties().fillBackground, !0, this.model(), 'Change Arc Filling')
            ),
            ...
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Arc Border Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(new l(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new s(a, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            ...
            this.bindControl(
              new r(x, this._linetool.properties().showPrices, !0, this.model(), 'Change Disjoint Angle Show Prices')
            ),
            this.bindControl(
              new r(m, this._linetool.properties().extendLeft, !0, this.model(), 'Change Disjoint Angle Extending Left')
            ),
            this.bindControl(
              new r(
                f,
            ...
            this.bindControl(
              new s(o, this._linetool.properties().linecolor, !0, this.model(), 'Change Disjoint Angle Color')
            ),
            this.bindControl(
              new l(i, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Disjoint Angle Style')
            ),
            ...
            this.bindControl(
              new r(g, this._linetool.properties().fillBackground, !0, this.model(), 'Change Disjoint Angle Filling')
            ),
            this.bindControl(
              new s(
                y,
    ...
    k7QS: function (e, t, i) {
      ...
      inherit(o, n),
        (o.prototype.addLevelEditor = function (e, t) {
          ...
          return (
            c.appendTo(d),
            (i = $("<input type='checkbox' class='visibility-switch'>")).appendTo(c),
            t && i.css('margin-left', '15px'),
            (o = $('<td>')).appendTo(d),
            (n = $("<input type='text'>")).appendTo(o),
            n.css('width', '70px'),
            this.bindControl(new l(n, e.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')),
            (a = $("<td class='colorpicker-cell'>")).appendTo(d),
            (s = h(a)),
            this.bindControl(new r(i, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility')),
            this.bindControl(new p(s, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0)),
            d
          );
        }),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a, l, u, C, g, y, w, T, _, m, L, f, v, k, S, x, B, P, R, E, F, D, I, W, A, V, z, O;
          for (
            this._div = $(document.createElement('div')).addClass('property-page'),
              ...
              e &&
                ...
                (a = h(n)),
                this.bindControl(new p(a, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0)),
                (l = $('<td>').appendTo(i)),
                (u = this.createLineWidthEditor()).appendTo(l),
                this.bindControl(new s(u, e.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width')),
                (C = $('<td>').appendTo(i)),
                (g = c()).render().appendTo(C),
                this.bindControl(
                  new d(g, e.linestyle, parseInt, !0, this.model(), 'Change Fib Retracement Line Style')
                )),
              ...
              l = $('<td>').appendTo(w),
              (u = this.createLineWidthEditor()).appendTo(l),
              this.bindControl(new s(u, y.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width')),
              C = $('<td>').appendTo(w),
              (g = c()).render().appendTo(C),
              this.bindControl(new d(g, y.linestyle, parseInt, !0, this.model(), 'Change Fib Retracement Line Style')),
          ...
          this.addOneColorPropertyWidget(this._table),
            ...
            $('<td>').append(S).appendTo(R),
            (I = $("<table cellspacing='0' cellpadding='0'>").appendTo(this._div)),
            (W = $(
              "<select><option value='left'>" +
                $.t('left') +
                "</option><option value='center'>" +
            ...
            this._linetool.properties().reverse &&
              this.bindControl(
                new r(P, this._linetool.properties().reverse, !0, this.model(), 'Change Fib Retracement Reverse')
              ),
            this.bindControl(
              new d(
                W,
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            this.bindControl(
              new l(c, this._linetool.properties().fillBackground, !0, this.model(), 'Change Pattern Filling')
            ),
            this.bindControl(
            ...
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Pattern Border Width')
            ),
            this.bindControl(
              new p(a, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new p(d, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new l(o, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new l(n, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            (u = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
              .append($(document.createElement('td')).attr({ width: 1 }).append(i))
              .append($(document.createElement('td')).attr({ width: 1 }).append(d))
              .append($(document.createElement('td')).attr({ width: 1 }).append(a))
              .append($(document.createElement('td')).css('vertical-align', 'top').attr({ width: 1 }).append(o))
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(new r(_, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
    ...
    n3Kh: function (e, t, i) {
      ...
      i('PVgW'),
        ...
        (o.prototype.bindBarIndex = function (e, t, i, n) {
          var a = [s(e.value()), l(o.BarIndexPastLimit), r(o.BarIndexFutureLimit)];
        ...
        (o.prototype.createPriceEditor = function (e) {
          ...
          return (
            ...
            e &&
              ...
              (o = this.createStringBinder(s, e, t, !1, this.model(), i)).addFormatter(function (e) {
                return a.format(e);
              }),
              this.bindControl(o)),
            s
          ...
          for (t = 0; t < a.length; t++)
            (i = a[t]),
              (o = this._linetool.properties().points[t]) &&
                ((n = t || l > 1 ? ' ' + (t + 1) : ''), this._createPointRow(i, o, n).appendTo(e));
        }),
        (o.prototype.prepareLayout = function () {
          (this._table = $(document.createElement('table'))),
            this._table.addClass('property-page'),
      ...
      inherit(o, a),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            this.bindControl(
              new s(l, this._linetool.properties().showTime, !0, this.model(), 'Change Cross Line Time Visibility')
            ),
            this.bindControl(
              new s(n, this._linetool.properties().showPrice, !0, this.model(), 'Change Cross Line Price Visibility')
            ),
            this.bindControl(
              new h(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Cross Line Color')
            ),
            this.bindControl(
              new p(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Cross Line Style')
            ),
            this.bindControl(
              new d(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Cross Line Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
        ...
        (o.prototype.addLevelEditor = function (e, t, i) {
          ...
          _.appendTo(this._table),
            ...
            e ||
              ((w = $('<td>')).appendTo(_),
              (T = c()).render().appendTo(w),
              this.bindControl(new r(T, t.linestyle, parseInt, !0, this.model(), 'Change Fib Circle Style'))),
            this.bindControl(new s(n, t.visible, !0, this.model(), 'Change Fib Circle Visibility')),
            this.bindControl(new p(C, t.color, !0, this.model(), 'Change Fib Circle Line Color', 0)),
            this.bindControl(new d(y, t.linewidth, !0, this.model(), 'Change Fib Circle Width'));
        }),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a, l;
          for (
          ...
          this.addOneColorPropertyWidget(this._table),
            ...
            $('<td>').append(n).prependTo(o),
            this.bindControl(
              new s(i, this._linetool.properties().showCoeffs, !0, this.model(), 'Change Fib Circle Levels Visibility')
            ),
            (o = $('<tr>')).appendTo(this._table),
            (a = $("<input type='checkbox' class='visibility-switch'>")),
            $('<td>').append(a).appendTo(o),
    ...
    o6hY: function (e, t, i) {
      ...
      function n(e, t, i) {
        l.call(this, e, t), (this._study = i), (this._property = e), this.prepareLayout();
      }
      var a = i('DxCR'),
        l = a.PropertyPage,
        r = a.GreateTransformer,
      ...
      inherit(o, l),
              ...
              this._study.isLinePlot(n) || this._study.isBarColorerPlot(n) || this._study.isBgColorerPlot(n)
                ...
                ? ((s = { id: l, type: 'ohlc' }),
                  this._study.isOHLCBarsPlot(n)
                    ...
                    : this._study.isOHLCCandlesPlot(n) && this._prepareLayoutForCandlesPlot(n, s))
          ...
          if ((p = this._study.properties().bands) && p.childCount() > 0)
            for (n = 0; n < p.childCount(); n++)
              ((b = p[n]).isHidden && b.isHidden.value()) ||
                ...
                (_ = $('<td/>')).appendTo(T),
                (m = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(_),
                (L = $.t(b.name.value(), { context: 'input' })),
                (f = this.createLabeledCell(L, m).appendTo(T).addClass('propertypage-name-label')),
                (S = $('<td/>')).appendTo(T),
                ...
                (D = $("<input class='property-page-bandwidth' type='text'/>")).appendTo(E),
                (I = [d(b.value.value())]),
                (W = 'Change band'),
                ...
                this.bindControl(new h(F, b.linestyle, parseInt, !0, this.model(), W)),
              ...
              (O = z[n]).isHidden ||
                ...
                O.palette
                  ? ((T = $('<tr class="line"/>')),
                    (_ = $('<td/>')).appendTo(T),
                    (m = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(_),
                    this.bindControl(new c(m, b.visible, !0, this.model(), W + ' visibility')),
                    (M = $.t(V, { context: 'study' })),
                    this.createLabeledCell(M, m).appendTo(T).addClass('propertypage-name-label'),
                    T.appendTo(this._table),
                    (Y = (q = this._findPlotPalette(n, O)).palette),
                    (N = q.paletteProps),
                    this._prepareLayoutForPalette(0, O, Y, N, W))
                  : (T = this._prepareFilledAreaBackground(b.visible, b.color, b.transparency, V, W)).appendTo(
                      this._table
                    ));
          for (H in t.graphics)
            for (G in t.graphics[H])
              (b = this._property.graphics[H][G]), o['_createRow_' + H].call(this, this._table, b);
          1 === (j = this._table.find('.visibility-switch.plot-visibility-switch')).length &&
            ((_ = j.parent()).css('display', 'none'),
            1 === (f = this._table.find('.propertypage-plot-with-palette')).length
              ? f.css('display', 'none')
              : ((f = this._table.find('.propertypage-name-label')).css('padding-left', 0),
                f.find('label').attr('for', ''))),
            (U = this._prepareStudyPropertiesLayout()),
            (this._table = this._table.add(U)),
            k.isScriptStrategy(t) && ((K = this._prepareOrdersSwitches()), (this._table = this._table.add(K))),
            this.loadData();
        }),
        (o.prototype._prepareOrdersSwitches = function () {
          var e,
            ...
            a,
            l,
            r = $('<table class="property-page study-strategy-properties" cellspacing="0" cellpadding="2">'),
            s = 'chart-orders-switch_' + Date.now().toString(36),
            p = $('<tr>').appendTo(r),
            d = $('<input id="' + s + '" type="checkbox">').appendTo($('<td>').appendTo(p));
          return (
            $('<label for="' + s + '">' + $.t('Trades on Chart') + '</label>').appendTo($('<td>').appendTo(p)),
            ...
            $('<label for="' + o + '">' + $.t('Quantity') + '</label>').appendTo($('<td>').appendTo(n)),
            (l = this._study.properties()),
            this.bindControl(new c(d, l.strategy.orders.visible, !0, this.model(), 'Trades on chart visibility')),
            this.bindControl(new c(i, l.strategy.orders.showLabels, !0, this.model(), 'Signal labels visibility')),
            this.bindControl(new b(i, l.strategy.orders.visible, !0, this.model(), 'Signal labels visibility', !0)),
            this.bindControl(new c(a, l.strategy.orders.showQty, !0, this.model(), 'Quantity visibility')),
            this.bindControl(new b(a, l.strategy.orders.visible, !0, this.model(), 'Quantity visibility', !0)),
            r
          );
        }),
        (o.prototype._prepareLayoutForPlot = function (e, t) {
          ...
          L
            ? ((i = $('<tr class="line"/>')).appendTo(this._table),
              ...
              (n = $("<input type='checkbox' class='visibility-switch plot-visibility-switch'/>")).appendTo(o),
            ...
            : ((i = $('<tr class="line"/>')).appendTo(this._table),
              ...
              (b = f()).appendTo(d),
              (g = $('<td>')).appendTo(i),
              (w = $("<input type='checkbox'>")).on('change', this._trackPriceLine.bind(this)).appendTo(g),
              this.createLabeledCell('Price Line', w).appendTo(i),
              this.bindControl(new c(n, _.visible, !0, this.model(), k)),
              this.bindControl(new u(r, _.color, !0, this.model(), k, _.transparency)),
              this.bindControl(new C(p, _.linewidth, !0, this.model(), k, this._study.metaInfo().isTVScript)),
              this.bindControl(new h(b, _.plottype, parseInt, !0, this.model(), k)),
        ...
        (o.prototype._prepareLayoutForBarsPlot = function (e, t) {
          ...
          g.appendTo(this._table),
            ...
            (o = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(i),
        ...
        (o.prototype._prepareLayoutForCandlesPlot = function (e, t) {
          ...
          this._prepareLayoutForBarsPlot(e, t),
            ...
            (r = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(l),
        ...
        (o.prototype._prepareLayoutForShapesPlot = function (e, t) {
          ...
          f.appendTo(this._table),
            ...
            this.createLabeledCell(n, o).appendTo(f).addClass('propertypage-name-label'),
            (a = $('<td/>')).appendTo(f),
            (l = _()).appendTo(a),
            ...
            w
              ...
              : ((f = $('<tr class="line"/>')).appendTo(this._table),
                ...
                p.addClass('colorpicker-cell'),
                (d = y(p)),
                this.bindControl(new u(d, C.color, !0, this.model(), L, C.transparency)));
        }),
        ...
        (o.prototype._prepareLayoutForPalette = function (e, t, i, o, n, a) {
          ...
          i.colors))
            (s = o.colors[r]),
              ...
              (g = y(b)),
              this.bindControl(new u(g, s.color, !0, this.model(), n, x.transparency)),
              !B &&
                this._study.isLinePlot(k) &&
                ((w = $('<td/>')).appendTo(p),
                (T = this.createLineWidthEditor()).appendTo(w),
                this.bindControl(new C(T, s.width, !0, this.model(), n, this._study.metaInfo().isTVScript)),
                (_ = $('<td>')).appendTo(p),
                0 === l &&
                  ((m = f()).appendTo(_),
                  this.bindControl(new h(m, x.plottype, parseInt, !0, this.model(), n)),
                  (L = $('<td>')).appendTo(p),
                  (v = $("<input type='checkbox'>")).on('change', this._trackPriceLine.bind(this)).appendTo(L),
                  this.createLabeledCell('Price Line', v).appendTo(p),
                  this.bindControl(new c(v, x.trackPrice, !0, this.model(), 'Change Price Line')))),
              l++;
        }),
        (o.prototype._trackPriceLine = function () {
          B('GUI', 'Add Price Line', this._study.properties().description.value());
        }),
        (o.prototype._prepareLayoutForArrowsPlot = function (e, t) {
          ...
          b.appendTo(this._table),
            ...
            this.createLabeledCell(n, o).appendTo(b).addClass('propertypage-name-label'),
            (a = $('<td/>')).appendTo(b),
            ...
            this.bindControl(new u(l, d.colorup, !0, this.model(), h, d.transparency)),
            this.bindControl(new u(s, d.colordown, !0, this.model(), h, d.transparency));
        }),
        (o.prototype._findPlotPalette = function (e, t) {
          ...
          if (this._study.isBarColorerPlot(o) || this._study.isBgColorerPlot(o))
            (a = this._study.metaInfo().palettes[t.palette]), (l = this._study.properties().palettes[t.palette]);
          else
            for (i = 0; i < r.length; i++)
              if (r[i].target === n && (this._study.isSelfColorerPlot(i) || this._study.isOHLCColorerPlot(i))) {
        ...
        (o.prototype._prepareStudyPropertiesLayout = function () {
          ...
          return (
            ...
            'Compare@tv-basicstudies' === this._study.metaInfo().id &&
              ...
              $('<td>').append(t).appendTo(i),
              this.bindControl(new h(t, this._study.properties().minTick, null, !0, this.model(), 'Change MinTick'))),
        ...
        (o.prototype._prepareFilledAreaBackground = function (e, t, i, o, n) {
          ...
          return (
            p.appendTo(s),
            (a = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(p),
            this.createLabeledCell(o, a).appendTo(s).addClass('propertypage-name-label'),
            (l = $('<td/>')).appendTo(s),
            l.addClass('colorpicker-cell'),
            (r = y(l)),
        ...
        (o._createRow_horizlines = function (e, t) {
          ...
          $('<td>').append(n).appendTo(i),
            ...
            this.bindControl(new u(a, t.color, !0, this.model(), 'Change ' + o + ' color')),
            this.bindControl(new h(r, t.style, parseInt, !0, this.model(), 'Change ' + o + ' style')),
            this.bindControl(new C(l, t.width, !0, this.model(), 'Change ' + o + ' width'));
        }),
        ...
        (o._createRow_hlines = function (e, t) {
          ...
          $('<td>').append(r).appendTo(a),
            ...
            this.bindControl(new c(r, t.visible, !0, this.model(), 'Change ' + l + ' visibility')),
            this.bindControl(new u(s, t.color, !0, this.model(), 'Change ' + l + ' color')),
            this.bindControl(new h(d, t.style, parseInt, !0, this.model(), 'Change ' + l + ' style')),
            this.bindControl(new C(p, t.width, !0, this.model(), 'Change ' + l + ' width')),
            this.bindControl(new c(b, t.showPrice, !0, this.model(), 'Change ' + l + ' show price')),
            t.enableText.value() &&
              ((a = this.addRow(e)),
              ...
              this.bindControl(new c(i, t.showText, !0, this.model(), 'Change ' + l + ' show text')),
              (o = TradingView.createTextPosEditor()),
              $('<td>').append(o.render()).appendTo(a),
              this.bindControl(new h(o, t.textPos, parseInt, !0, this.model(), 'Change ' + l + ' text position')),
              (n = this.createFontSizeEditor()),
              $('<td colspan="2">').append(n).appendTo(a),
              this.bindControl(new h(n, t.fontSize, parseInt, !0, this.model(), 'Change ' + l + ' font size')));
        }),
        (o._createRow_hhists = function (e, t) {
          ...
          this.bindControl(new u(l, t.valuesColor, !0, this.model(), 'Change ' + b + ' Text Color')),
          t.colors))
            isNumber(parseInt(d, 10)) &&
              ...
              this.bindControl(new u(y[d], t.colors[d], !0, this.model(), 'Change ' + C[d] + ' color')));
        }),
        ...
        (o._createRow_polygons = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            $('<td>').append(n).appendTo(i),
            this.bindControl(new u(n, t.color, !0, this.model(), 'Change ' + o + ' color'));
        }),
        (o._createRow_trendchannels = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            $('<td>').append(n).appendTo(i),
            this.bindControl(new u(n, t.color, !0, this.model(), 'Change ' + o + ' color', t.transparency));
        }),
        (o._createRow_textmarks = function (e, t) {
          var i = this.addLabeledRow(e),
            ...
            p = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>');
          $('<td>').append(o).appendTo(i),
            ...
            $('<td>').append(p).appendTo(i),
            this.bindControl(new u(n, t.color, !0, this.model(), 'Change ' + o + ' color', t.transparency)),
            this.bindControl(new u(a, t.fontColor, !0, this.model(), 'Change ' + o + ' text color', t.transparency)),
            this.bindControl(new h(r, t.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size')),
            this.bindControl(new h(l, t.fontFamily, null, !0, this.model(), 'Change ' + o + ' font')),
            this.bindControl(new c(s, t.fontBold, !0, this.model(), 'Change Text Font Bold')),
        ...
        (o._createRow_shapemarks = function (e, t) {
          ...
          l.attr('type', 'text'),
            ...
            this.bindControl(new g(l, t.size, null, !1, this.model(), 'Change size'));
        }),
      ...
      inherit(o, a),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(
              new b(r, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new b(s, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new h(l, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new c(p, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new c(d, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            this.bindControl(
              new h(o, this._linetool.properties().linecolor, !0, this.model(), 'Change Trend Angle Color')
            ),
            this.bindControl(
              new b(i, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Trend Angle Style')
            ),
            this.bindControl(
              new C(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Trend Angle Width')
            ),
            this.bindControl(
              new c(_, this._linetool.properties().extendRight, !0, this.model(), 'Change Trend Angle Extending Right')
            ),
            this.bindControl(
              new c(m, this._linetool.properties().extendLeft, !0, this.model(), 'Change Trend Angle Extending Left')
            ),
            this.bindControl(
              new c(
                v,
        ...
        (n.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            e &&
              ...
              (a = new u(o, this._linetool.properties().angle, n, !1, this.model(), 'Change angle')).addFormatter(
                function (e) {
                  return new y().format(e);
                }
              ),
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
            ...
            this.bindControl(new s(t, this._linetool.properties().linecolor, !0, this.model(), 'Change Brush Color')),
            this.bindControl(
              new l(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Brush Line Width')
            ),
            this.bindControl(
            ...
            this.bindControl(
              new p(d, this._linetool.properties().leftEnd, parseInt, !0, this.model(), 'Change Trend Line Left End')
            ),
            this.bindControl(
              new p(h, this._linetool.properties().rightEnd, parseInt, !0, this.model(), 'Change Trend Line Right End')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
        ...
        (o.prototype.addLevelEditor = function (e, t, i) {
          ...
          _.appendTo(this._table),
            ...
            e ||
              ...
              (T = c()).render().appendTo(w),
              this.bindControl(
                new r(T, t.linestyle, parseInt, !0, this.model(), 'Change Fib Speed Resistance Arcs Style')
              )),
            this.bindControl(new s(n, t.visible, !0, this.model(), 'Change Fib Speed Resistance Arcs Visibility')),
            this.bindControl(new p(C, t.color, !0, this.model(), 'Change Fib Speed Resistance Arcs Line Color', 0)),
            this.bindControl(new d(y, t.linewidth, !0, this.model(), 'Change Fib Speed Resistance Arcs Width'));
        }),
        (o.prototype.prepareLayout = function () {
          var e, t, i, o, n, a, l;
          for (
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = $(document.createElement('table'))),
            ...
            $('<td>').append(n).appendTo(i),
            this.bindControl(
              new l(o, this._linetool.properties().fillBackground, !0, this.model(), 'Change Ellipse Filling')
            ),
            this.bindControl(
            ...
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Ellipse Border Width')
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
      ...
      inherit(o, n),
        (o.prototype.prepareLayout = function () {
          ...
          (this._table = c.add(b)),
            ...
            $('<td>'),
            this.bindControl(new s(e, this._linetool.properties().text, null, !0, this.model(), 'Change Balloon Text')),
            this.bindControl(new r(t, this._linetool.properties().color, !0, this.model(), 'Change Baloon Text Color')),
            this.bindControl(
              new l(
                i,
            ...
            this.bindControl(
              new r(n, this._linetool.properties().borderColor, !0, this.model(), 'Change Balloon Border Color')
            ),
            this.loadData(),
            setTimeout(function () {
              e.select(), e.focus();
      ...
      inherit(o, l),
        ...
        (o.prototype.prepareLayout = function () {
          ...
          this._prepareSeriesStyleLayout(n, a, l, c),
            ...
            $('<td>').append(i).appendTo(o),
            this.bindControl(new s(i, c.minTick, null, !0, this.model(), 'Change MinTick')),
