  ...
  ['study-market'],
  {
        ...
        i('pfXf'),
                    ...
                    function (t) {
                      var e,
                        ...
                        s = !(
                          ...
                          (this._options.onWidget && (h.isScriptStrategy(t) || i === this._CUSTOM_STUDIES_PACKAGE_NAME))
                        );
                      s &&
            ...
            for (t in this._market.products)
              (e = this._market.products[t]),
                pro.hasPackage(t) &&
                  e.subproduct_ids &&
                  e.subproduct_ids[0] &&
                  ((i = e.subproduct_ids[0].split('$')[1]), (n[i] = t), a.push(ScriptLib.requestPineAddons(i)));
            return (
              (s = this),
              Promise.all(a).then(function (t) {
                return t.reduce(function (t, e) {
                  var i, a;
                  return e && e.length
                    ? ((i = e[0].scriptIdPart.split('_')[0]), (a = []), s._fillScriptsMetainfo(e, a), (t[n[i]] = a), t)
                    : t;
                }, {});
              })
            );
          ...
          (a.prototype._switchPagesContainer = function (t, e) {
            this._options.minimized ||
              ...
              (t === a._breakpointDevice
                ...
                : e === a._breakpointDevice && this._w_pages.detach().appendTo(this._widget.find('.js-right-panel')));
          }),
          (a.prototype.prepareLayout = function () {
            (this._widget = $(
              ...
              (this._loadMore = null),
              this.preparePages(),
              this._options.selectBasicPage && this.selectPage(this._BASIC_STUDIES_PAGE_NAME),
              (this._scroll = new d(this._widget.find('.js-tabs-viewport'), this._w_tabs, { showBottomShadow: !1 }));
            var t =
            ...
            (this._dialog = l({
              ...
              addClass:
                ...
                (this._options.onWidget || this._options.minimized ? 'i-minimized' : ''),
              ...
              this._dialog.$title
                .find('.js-back-button')
                .on(Modernizr.mobiletouch ? 'touchend' : 'click', this.selectPage.bind(this, '')),
              g.on(
                'changeDevice',
                function (t, e) {
                  t === a._breakpointDevice &&
                    ...
                    this.selectPage(''),
                    t === a._breakpointDevice && (this._scroll.scrollToStart(), this._updateDialogTitleText()),
          ...
          (a.prototype._updateDialogTitleText = function () {
            ...
            this._dialog &&
              ...
              'phone-vertical' !== g.device
                ...
                : ((t = this.currentPage()), this._dialog.setTitleText(t.data('fullTitle'))));
          }),
          ...
          (a.prototype._fillScriptsMetainfo = function (t, e) {
            ...
            for (i = 0; i < t.length; i++)
              (s = t[i]), (a = createStudyMetaInfoStub(s, '1')), TradingView.merge(a, h.parseIdString(a.id)), e.push(a);
          }),
          ...
          (a.prototype.addSearchPage = function () {
            ...
            (this._tabs.search = i.$control.data('title', 'search')),
              ...
              this._widget.find('#js-search-placeholder').replaceWith(this._tabs.search),
              this._widget.find('#js-search-results-placeholder').replaceWith(this._pages.search),
          ...
          (a.prototype._onUpKeyHandler = function (t) {
            ...
            t.preventDefault(),
              null !== this._selectedStudy &&
                ((i = (e = this.currentPage().find('.js-study-item')).index(this._selectedStudy)),
                (s = e.eq(i - 1)).length &&
                  i > 0 &&
          ...
          (a.prototype._ensureSelectedItemIsVisible = function () {
            ...
            null !== this._selectedStudy &&
              ...
              e.top - i.top < 0
                ? t.scrollTop(a - n)
                : e.bottom - i.bottom > 0 && t.scrollTop(a - i.height + e.height + n));
          }),
          (a.prototype.search = function (t, e, i) {
            ...
            (this._search_value !== t || e) &&
              ...
              h.done(
                function (e) {
                  var i, n, o, d, l, u, _, p, g, v, f, y, S, m, b, E, C, A, w, P, I, T;
                  if (c._currentAsyncSearchDfd === h) {
                    for (
                      (i = Object.keys(c._studies)).indexOf(c._PUBLISHED_STUDIES_PACKAGE_NAME) < 0 &&
                        i.push(c._PUBLISHED_STUDIES_PACKAGE_NAME),
                        i.sort(),
                        o = (n = [
                      ...
                      (d = n[o]), -1 !== (l = i.indexOf(d)) && (i.splice(l, 1), i.unshift(d));
                    for (u = {}, _ = 0, p = 0; p < i.length; p++) {
                      for (
                        g = i[p], v = [], f = c._studies[g], g === c._PUBLISHED_STUDIES_PACKAGE_NAME && (f = e), o = 0;
                        o < f.length;
                        o++
                      )
                        if (((y = f[o]), r.length))
                          for (S = 0; S < r.length; S++)
                            ((m = r[S].re).lastIndex = 0),
                              (b = r[S].fullMatch),
                              (E = y.shortDescription) && E.toLowerCase() === t.toLowerCase()
                                ? s(v, y, E, 3, !0, b)
                                : E && b.test(E)
                                ? s(v, y, E, 2, !0, b)
                                : ((E = this._getScriptLocalizedName(y)),
                                  b.test(E) ? s(v, y, E, 1, !0, b) : m.test(E) && s(v, y, E, 0, !0, m));
                        else v.push(y);
                      if ((v = c._applyGlobalFilter(v)).length) {
                        switch (((C = g), g)) {
                          ...
                          case c._PUBLISHED_STUDIES_PACKAGE_NAME:
                            ...
                            break;
                          default:
                            g in c._packagesWithTabNames && (C = c._packagesWithTabNames[C]);
                        }
                        C in u || (u[C] = []), (u[C] = u[C].concat(v)), (_ += v.length);
                      }
                    }
                    for (
                      A = this._selectedStudy ? this._selectedStudy.data('study') : null,
                        a.html(''),
                        w = Object.keys(u),
                        o = 0;
                      o < w.length;
                      ...
                      if (
                        ...
                        (P = this._createItemsGroup(v, this._options.minimized ? '' : $.t(C), r)),
                        a.append(P),
                        (this._selectedStudy = null),
                        A && A.pine && A.pine.version < 0)
                      )
                        for (I = this.currentPage().find('.js-study-item'), S = 0; S < I.length; ++S)
          ...
          (a.prototype.addPage = function (t, e) {
            ...
            return (
              ...
              (s = t.toLowerCase()),
              (a = $('<div class="tv-insert-indicator-dialog__page">').data('title', s)),
              ...
              (this._pages[s] = a),
              (this._tabs[s] = n),
              e.withoutTopPadding && a.addClass('tv-insert-indicator-dialog__page--without-top-padding'),
              e.noFlex && a.addClass('tv-insert-indicator-dialog__page--no-flex'),
              e.market
                ? (this._getOrCreateMarketTab().find('.tv-insert-indicator-dialog__tabs').append(n),
          ...
          (a.prototype._getOrCreateMarketTab = function () {
            return (
              this._w_market_tabs ||
                (g.device === a._breakpointDevice && p.setValue('studyMarket.marketTabIsOpen', !1),
                (this._w_market_tabs = this._createGroupTab($.t('Marketplace Add-ons'), 'studyMarket.marketTabIsOpen')),
              ...
              function () {
                ...
                i !== this._parentSource &&
                  ...
                  this._widget.on(
                    ...
                    function (t) {
                      t.which === f.ESC && (this._widget.unbind('keyup.hideDialogStudy'), this.hide());
                    }.bind(this)
                  ),
                  this._clearInput(),
                  this.loadFavorites(),
                    ...
                    function (t) {
                      return (
                        ...
                        !!(
                          ...
                          (this._options.minimized && !n.enabled('study_dialog_search_control'))
                        ) ||
                          (this._search_input.focus(),
          ...
          (a.prototype._showHideBackButton = function () {
            ...
            this._dialog &&
              ...
              this._dialog.$el.find('.js-title-container').toggleClass('i-with-back-button', t && !e && !i));
          }),
          (a.prototype._renderPageStudiesList = function (t) {
            var e,
              i = this._selectedStudy ? this._selectedStudy.data('study') : null,
              s = t.data('studies') || [];
            s.length > 0 &&
              (t.empty(), (e = this._createItemsList()), this.fillStudies(e, s, null, i && i.id), t.append(e));
          }),
          ...
          (a.prototype.selectPage = function (t) {
            ...
            (t = t.toLowerCase()),
              this._currentPageTitle !== t &&
                ('' === t || (t in this._pages && t in this._tabs && ('favorites' !== t || this.hasVisibleFavorites()))
                  ? ((i = (e =
                      this._currentPageTitle ||
                      Object.keys(this._pages).find(function (t) {
                        return t in o._pages && !o._pages[t].hasClass('i-hidden');
                      }))
                      ? this.getPage(e)
                      : void 0),
                    (s = this.getPage(t)) &&
                      (i && (i.addClass('i-hidden'), this._tabs[e].removeClass('i-active')),
                      s.removeClass('i-hidden'),
                      this._tabs[t].addClass('i-active'),
                      s.trigger('show-page'),
                      0 !== (a = this._tabs[t].parents('.tv-insert-indicator-dialog__tabs-group')).length &&
                        ((n = a.find('.js-tab-head')),
                        this._expandCollapseTabs(a, n.data('settings-open-key'), !0, !0))),
                    (this._currentPageTitle = t),
                    this._w_pages.scrollTop(0),
                    p.setValue(this._PAGE_KEY, t),
                    this._selectedStudy &&
                      (this._selectedStudy.removeClass('tv-insert-study-item--selected'), (this._selectedStudy = null)),
          ...
          (a.prototype.attachHandlers = function () {
            ...
            Modernizr.mobiletouch &&
              ...
              n.enabled('items_favoriting') && this._w_pages.on(t, '.js-favorite-icon', this.toggleItem.bind(this)),
            ...
            this._w_pages &&
              ...
              (e = function () {
                var e,
                  ...
                  u = function () {
                    'favorites' === t._currentPageTitle &&
                      t.selectPage(g.device === a._breakpointDevice ? '' : t._BASIC_STUDIES_PAGE_NAME),
                ...
                if (t._tabs.favorites && 0 === l.length) u();
                  ...
                  for (e = $.Deferred(), i = [], s = [], n = 0; n < l.length; n++)
                    if (((r = l[n]), (o = this.getStudyPackageName(r)) !== t._PUBLISHED_STUDIES_PACKAGE_NAME)) {
                      for (d = this._studies[o] || [], h = 0; h < d.length; h++)
                        if (t.favsModel.favId(c(d[h].id)) === t.favsModel.favId(r)) {
                          i.push(d[h]);
                          break;
                        }
                    } else s.push(r);
                    ...
                    e.done(
                      function (t) {
                        0 === t.length ? u() : this._tabs.favorites.show(),
                          ...
                          this._w_pages.find('.js-study-item').find('.js-favorite-icon').removeClass('i-starred'),
          ...
          (a.prototype.sortStudies = function (t) {
            return t.sort(function (t, e) {
              return (t = t.scriptName || t.description_localized || t.description) >
              ...
              e.forEach(function (e) {
                e
                  ? ((a = this.createStudyListItem(e, i)),
                    e.id === s &&
                      ((this._selectedStudy = a), this._selectedStudy.addClass('tv-insert-study-item--selected')))
                  : ((a = document.createElement('div')).className = 'placeholder'),
                  t.append(a);
              }, this);
          }),
          (a.prototype.createStudyListItem = function (t, e) {
            ...
            if (e && N)
              for (
                i = [], e instanceof RegExp ? i.push({ re: e, fuzzyHighlight: !1 }) : $.isArray(e) && (i = e), a = 0;
                a < i.length;
                a++
              )
                if (
                  ...
                  (c = r.exec(N))
                    ...
                    : (!(c = d.exec(N)) && o && (c = o.exec(N)), (i[a].fuzzyHighlight = !0)),
                  c)
                )
                  if (i[a].fuzzyHighlight)
                    for (l = c.index, u = 1; u < c.length; u++) (_ = c[u].length), u % 2 && (U[l] = !0), (l += _);
                  else for (p = 0; p < c[0].length; p++) U[c.index + p] = !0;
            return (
              (v = (g = TradingView.clean(N, !0)).replace(/./g, function (t, e) {
                if (('<' === t ? (t = '&lt;') : '&' === t ? (t = '&amp;') : '"' === t && (t = '&quot;'), U[e])) {
                  if (' ' === t || '-' === t || '/' === t) return (U[e + 1] = !0), t;
              ...
              (E =
                f &&
                [TVScript.Access.ACCESS_CLOSED_NEEDS_AUTH, TVScript.Access.ACCESS_CLOSED_NO_AUTH].indexOf(
                  t.pine.access
                ) >= 0),
              (C = f && TVScript.Access.ACCESS_CLOSED_NEEDS_AUTH === t.pine.access),
              ...
              (k = $(
                s.render(w, {
                  ...
                  isInviteOnly: C,
                  showAccessIcon: A,
                  accessIconClass: P ? 'tv-insert-study-item__green-lock-icon' : 'tv-insert-study-item__red-lock-icon',
                  accessTooltip: P ? D.open : D.closed,
                  author: t.author && t.author.username,
                  likes: t.agreeCount ? t.agreeCount + ' ' + $.t('like', { plural: 'likes', count: t.agreeCount }) : '',
              ...
              T || k.find('.js-show-source-btn').removeClass('js-show-source-btn').addClass('i-empty'),
              k.data('study', t),
              void 0 !== t.isCustomIndicator && k.addClass('custom-indicator'),
              n.enabled('items_favoriting') &&
                ((M = k.find('.js-favorite-icon')).toggleClass('i-starred', !!x), M.attr('title', this.favTitle(!!x))),
          ...
          (a.prototype._insertStudy = function (t) {
            var e,
              ...
              s,
              a = t.id;
            if (b.isPointsBasedStudy(a)) return (e = b.lineToolNameForPointsBasedStudy(a)), void E.tool.setValue(e);
            (i = this._chartWidgetCollection.activeChartWidget.value()) &&
              ((s = this._dialog.focus.bind(this._dialog)),
              i.insertStudy(a, this._parentSource, t.description).then(s).catch(s));
          }),
          ...
          (a.prototype.getStudyPackageName = function (t) {
            var e, i, s, a, n, r;
            if (t)
              return (i = 1 === (e = t.split('@')).length) || (s = h.getPackageName(t)) === this._SCRIPTING_PACKAGE_NAME
                ? ((a = e[0]),
                  i || /^(Strategy)?Script\$/.test(a)
                    ? -1 !== (n = a.indexOf('_'))
                      ? ((r = (s = a.substring(0, n)).indexOf('Script$') >= 0 ? s : 'Script$' + s),
          ...
          (a.prototype._getScriptLocalizedName = function (t) {
            return t.description_localized || $.t(t.scriptName || t.description || ' ', { context: 'study' });
          }),
        ...
        (_ = (function () {
          ...
          return (
            ...
            (t.prototype.favorite = function (t, e) {
              var i, s, n, r;
              (0 !== this._favorites.length && 0 !== Object.keys(this._favoritesExtra).length) || this.loadFavs(),
                (i = this.favId(t)),
                (s = this.favorites()),
                (n = this.favoritesExtra()),
                -1 !== (r = s.indexOf(i)) ? (s.splice(r, 1), delete n[i]) : (s.push(i), void 0 !== e && (n[i] = e)),
                this._updateFavorites(s),
                this._updateFavoritesExtra(n),
                this._saveFavs(s, n),
                a.TVXWindowEvents.emit('StudyFavoritesChanged', JSON.stringify({ favorites: s, favoritesExtra: n }));
            }),
            ...
            (t.prototype._migrate = function (t, e) {
              var i,
                ...
                n = {};
              for (i = 0; i < t.length; i++)
                (s = this.favId(t[i])), -1 === a.indexOf(s) && (a.push(s), (n[s] = e[t[i]]));
    ...
    pfXf: function (t, e, i) {
      ...
      i('UgcK'),
        (function (t) {
          function e(t) {
            t.stop(!0), t.css('background-color', ''), t.removeData(o), t.removeData(d);
          }
          function i(i) {
            var a = i.data(o);
            a &&
          ...
          function s(t) {
            var e = t.css('background-color'),
              ...
              n = s.duration || c,
              r = s.easing || l;
            t.animate({ 'background-color': a }, n, r).animate({ 'background-color': e }, n, r, i.bind(t, t));
          }
          var a,
            n,
            r,
                        ...
                        ? ((i = !0 === i ? 'infinite' : i),
                          (function (t, e, i) {
                            for (var s = 0; s < n.length; s++)
                              n[s] || (e = e.toLowerCase()), t.addEventListener(n[s] + e, i, !1);
                          })(this, 'AnimationEnd', function () {
                            this.style[p] = '';
                          }),
                          document.getElementsByTagName('html')[0].classList.contains('theme-dark')
                            ? (this.style[p] = 'highlight-animation-theme-dark 0.4s ease-in-out ' + i + ' alternate')
                            : (this.style[p] = 'highlight-animation 0.4s ease-in-out ' + i + ' alternate'))
                        : ((e = t(this)).data(o, i), e.data(d, t.extend({}, a || {})), e.is(':animated') || s(e));
                    })
                  );
                case !1:
