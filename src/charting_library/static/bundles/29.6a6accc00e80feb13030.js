  ...
  [29],
  {
        ...
        inherit(i, l),
          (i.prototype._addSessionEditor = function (t, e, o, i) {
            ...
            'session' === o.type
              ? ((n = function (t, e) {
                ...
                (r = $('<table/>')).appendTo(t),
                (a = $('<tr/>')).appendTo(r),
                (l = ['start_hours', 'start_minutes', 'end_hours', 'end_minutes']),
                n.call(this, a, l[0]),
                s.call(this, a, ':', 0),
                n.call(this, a, l[1]),
                s.call(this, a, '-', 4),
          ...
          (i.prototype.prepareControl = function (e, o, i) {
            ...
            if ('resolution' === e.type)
              ...
              (P = $('<input class="symbol-edit single">')),
                ...
                o.attr('colspan', 5);
            else if ('session' === e.type) this._addSessionEditor(o, this._property.inputs[e.id], e, i);
              ...
              if ((p = this._study && this._study.isChildStudy()))
                ...
                (d = b.getChildSourceInputTitles(e, this._study.source().metaInfo(), l)),
                n))
                      ...
                      for (a = 0; a < x.length; ++a)
                        (T = x[a]),
                          ~b.CHILD_STUDY_ALLOWED_PLOT_TYPES.indexOf(T.type) &&
                            (n[v + '$' + a] = m + ': ' + ((C && C[T.id] && C[T.id].title) || T.id));
                (E = (function (t) {
                  return function (e) {
                    var o,
                      i,
                      ...
                      r = null;
                    if (0 === e.indexOf('#')) {
                      if (((o = e.slice(1, e.indexOf('$'))), null === (i = O._model.model().getStudyById(o))))
                        return void w.logError('Can not get Study by id ' + o);
                      if ((i.isStarted() || i.start(null, !0), !(n = i.sourceId())))
                        return void w.logError('Can not get source id for ' + i.metaInfo().id);
                      r = e.replace(/^[^\$]+/, n);
                    }
                    (!~e.indexOf('$') && !~e.indexOf('#')) || O._study.isStarted() || O._study.start(null, !0),
                  ...
                  (L = (function (t) {
                    return function (e) {
                      ...
                      for (o = e.slice(0, e.indexOf('$')), i = O._model.model().allStudies(), n = 0; n < i.length; ++n)
                        if ((s = i[n]).sourceId() === o) {
                          e = e.replace(/^[^\$]+/, '#' + s.id());
                          break;
                        }
              ...
              for (S in ((P = $(document.createElement('select'))), n))
                (k = s[S] || n[S]), $('<option>').attr('value', S).text(k).appendTo(P);
                ...
                ? ((P = $('<select/>')),
                  ...
                  e.options.forEach(function (t) {
                    var e = t,
                      o = (I && I[e]) || e,
                      i = $.t(o, { context: 'input' });
                    $("<option value='" + e + "'>" + i + '</option>').appendTo(P);
                  }))
                : ((P = $('<input/>')), 'bool' === e.type ? P.attr('type', 'checkbox') : P.attr('type', 'text'));
            return (
              P && (P.appendTo(o), P.is(':checkbox') || 'symbol' === e.type || P.css('width', '100px')),
          ...
          (i.prototype.prepareLayoutImpl = function (t, e) {
              ...
              'first_visible_bar_time' !== (p = (n = V[i]).id) &&
                ...
                (n.isHidden ||
                  ...
                  (void 0 === n.groupId &&
                    ...
                    n.options
                      ? this.bindControl(new y(T, this._property.inputs[p], null, !0, this.model(), b, S, k))
                      : 'bar_time' === n.type
                      ? ((I = 10),
                        this.bindControl(
                          new a(T, this._property.inputs[p], !0, this.model(), b, this.model().mainSeries(), I)
                        ),
                        T.addClass('ticker'))
                      : 'integer' === n.type
                      ? ((O = [h(n.defval)]),
                        ...
                        this.bindControl(new v(T, this._property.inputs[p], O, !1, this.model(), b)),
                        T.addClass('ticker'),
                        isFinite(n.step) && n.step > 0 && T.attr('data-step', n.step))
                      : 'float' === n.type
                      ? ((O = [c(n.defval)]),
                        (0 === n.min || n.min) && O.push(d(n.min)),
                        (0 === n.max || n.max) && O.push(u(n.max)),
                        (P = new v(T, this._property.inputs[p], O, !1, this.model(), b)).addFormatter(o),
                        this.bindControl(P),
                        T.addClass('ticker'),
                        isFinite(n.step) && n.step > 0 && T.attr('data-step', n.step))
                      : 'text' === n.type
                      ? this.bindControl(new v(T, this._property.inputs[p], null, !1, this.model(), b))
                      : 'bool' === n.type
                      ? this.bindControl(new m(T, this._property.inputs[p], !0, this.model(), b))
                      : 'resolution' === n.type
                      ? this.bindControl(new y(T, this._property.inputs[p], s, !0, this.model(), 'Change Interval'))
                      : 'symbol' === n.type &&
                        ((E = this._symbolInfoBySymbolProperty.bind(this, this._property.inputs[p])),
            ...
            this._property.offset &&
              ((l = this._property.offset.title ? this._property.offset.title.value() : window.t('Offset')),
              (T = this.addOffsetEditorRow(e, l)),
              (O = [h(this._property.offset.val)]).push(d(this._property.offset.min)),
              O.push(u(this._property.offset.max)),
              this.bindControl(new v(T, this._property.offset.val, O, !1, this.model(), 'Undo ' + l))),
                ...
                $.each(
                  ...
                  function (t, o) {
                    ...
                    this._property.offsets[o.id] &&
                      ((void 0 !== (i = this._property.offsets[o.id]).isHidden && i.isHidden.value()) ||
                        ((n = i.title.value()),
                        (T = this.addOffsetEditorRow(e, n)),
                        (s = [h(i.val)]).push(d(i.min)),
                        s.push(u(i.max)),
                        this.bindControl(new v(T, i.val, s, !1, this.model(), 'Undo ' + n))));
                  }.bind(this)
                );
          }),
    ...
    PVgW: function (t, e, o) {
      ...
      function i(t) {
        return (
          (t = Math.abs(t)),
          !Object(l.isInteger)(t) && t > 1 && (t = parseFloat(t.toString().replace(/^.+\./, '0.'))),
          0 < t && t < 1
            ? Math.pow(
                10,
                null === (i = String(t).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/))
                  ? 0
                  : ((e = i[1] ? i[1].length : 0), (o = i[2] ? parseInt(i[2], 0) : 0), Math.max(0, e - o))
              )
            : 1
        );
        var e, o, i;
      ...
      function n(t, e) {
        ...
        t.trigger('tvticker-beforechange'),
          ...
          (s = 0),
          (s = o.parser ? o.parser(t.val()) : Object(l.isInteger)(n) ? parseInt(t.val(), 10) : parseFloat(t.val())),
          isNaN(s) && (s = 0),
          (r = i(n)),
            ...
            this.each(function () {
              ...
              p ? (n = !0) : (p = { step: Number(a.data('step')) || 1 }),
                ...
                n ||
                  ...
                  (o = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(d).appendTo(e)),
                  (i = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(d).appendTo(e)),
                  ...
                  a.keydown(function (t) {
                    a.is(':disabled') ||
                      (38 === t.keyCode ? o.addClass('i-active') : 40 === t.keyCode && i.addClass('i-active'));
                  }),
                  a.keyup(function (t) {
                    a.is(':disabled') ||
                      (38 === t.keyCode
                        ? (s(a), o.removeClass('i-active'))
                        : 40 === t.keyCode && (r(a), i.removeClass('i-active')));
                  }),
                  a.mousewheel(function (t) {
                    t.deltaY * (t.deltaFactor / 100) > 0 ? o.click() : i.click();
                  }));
            })
          );
        });
