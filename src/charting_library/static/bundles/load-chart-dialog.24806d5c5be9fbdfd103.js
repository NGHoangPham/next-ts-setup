(window.webpackJsonp = window.webpackJsonp || []).push([
  ['load-chart-dialog'],
  {
    ...
    E5yG: function (t, e, i) {
      ...
      var l, a, c, d, u, _, h, p, g, f, v, m, w, y, b, j, S, O, C, L, D, I, x, T, A, F, N, R, E, M, B, H, k, q, z;
      i.r(e),
        (l = i('mrSG')),
        i('YFKU'),
        i('HbRj'),
        ...
        (A = (function () {
          function t(t, e) {
            ...
            (this._itemsData = []),
              ...
              (this._contentSearch = Object(p.ensureNotNull)(this._content.querySelector('.js-content-search'))),
              (this._contentSort = Object(p.ensureNotNull)(this._content.querySelector('.js-content-sort'))),
              (this._contentBody = Object(p.ensureNotNull)(this._content.querySelector('.js-content-body'))),
          ...
          return (
            ...
            (t.prototype._makeItemTemplate = function (t, e, i, n) {
              ...
              for (s = 0, r = Object.values(w); s < r.length; s++)
                (l = r[s]), (A += '<div class="' + L['list-dialog__column'] + '">\n\t\t\t\t' + l + '\n\t\t\t</div>');
              return (
                b
                  ? (A = (function (t, e) {
                      return (
                        '<a href="' + t + '" class="' + L['list-dialog__columns-row'] + ' js-item-link">' + e + '</a>'
                      );
                    })(b, A))
                  : ((c = A), (A = '<div class="' + L['list-dialog__columns-row'] + '">' + c + '</div>')),
                (a = Object(y.b)(
                  '<div class="' +
                    L['list-dialog__row'] +
                    ' ' +
                ...
                a.querySelector('.js-remove-button').addEventListener('click', function (t) {
                  g._isConfirmDialogOpen = !0;
                  !(function (t, e, i) {
                    Object(m.createConfirmDialog)({ content: o(t) }).then(function (t) {
                ...
                a.querySelector('.js-favs').addEventListener('click', function (t) {
            ...
            (t.prototype._prepareHighlight = function (t, e) {
              ...
              if (null !== this._searchRegexp) {
                for (i in t)
                  if (t[i]) {
                    if (((o = t[i]), null === (n = this._searchRegexp.exec(o)))) continue;
                    for (s = '', r = 1; r < n.length; r++)
                      s += r % 2 ? '<span class="' + D['i-match'] + '">$' + r + '</span>' : '$' + r;
            ...
            (t.prototype._render = function () {
              (this._contentBody.innerHTML = ''),
                ...
                this._renderWithOffset(this._getItemsToRender(), 0, this._getMinShownItems());
            }),
            (t.prototype._makeActive = function (t) {
              var e,
                i = this._contentBody.querySelector('.js-item.' + L['list-dialog__row--item-active']);
              null !== i && i.classList.remove(L['list-dialog__row--item-active']),
                null !== (e = this._contentBody.querySelector(".js-item[data-id='" + t + "']")) &&
            ...
            (t.prototype._removeItem = function (t) {
              ...
              this._filterItems(t),
                ...
                this._setItemsToRender(e),
                null !== (i = this._contentBody.querySelector(".js-item[data-id='" + t + "']")) &&
            ...
            (t.prototype._emptyList = function (t) {
              this._contentBody.innerHTML = '<div class="' + L['list-dialog__empty-list'] + '">' + t + '</div>';
            }),
            (t.prototype._sortList = function (t) {
              var e,
                ...
                r = [],
                l = [];
              for (e = 0, i = this._getItemsToRender(); e < i.length; e++) t((o = i[e])) ? r.push(o) : l.push(o);
              (n = this._getCurrentSortObj()) && ((s = n.getPredicate()), l.sort(s), r.sort(s)),
            ...
            (t.prototype._prepareSort = function () {
              ...
              (this._currentSortObj = this._getSort(t.sortField)),
                this._currentSortObj && this._currentSortObj.setIsAscending(t.isAscending);
            }),
            (t.prototype._getMinShownItems = function () {
              return Math.min(this._itemsCount + 50, this._getItemsToRender().length);
            }),
            (t.prototype._renderWithOffset = function (t, e, i) {
              var o,
                n,
                s = document.createDocumentFragment();
              for (o = e; o < i; o++) (n = this._renderItem(t[o])), s.appendChild(n);
            ...
            (t.prototype._getSortData = function () {
              return {
                sortField: g.getValue(this._tvSettingsName + '.sort.field', this._defaultSort.sortField),
                isAscending: g.getBool(this._tvSettingsName + '.sort.asc', this._defaultSort.isAscending),
              };
            }),
            ...
            (t.prototype._setSort = function (t) {
              var e = this._currentSortObj,
                i = this._getSort(t);
              i === e && this._currentSortObj ? this._currentSortObj.inverse() : (this._currentSortObj = i),
            ...
            (t.prototype._search = function (t) {
              this._searchRegexp =
                0 !== t.length
                  ...
                  : null;
              var e = n(this._getItemsData(), Object(p.ensureNotNull)(this._fieldsExtractorFunc), this._searchRegexp);
            ...
            (t.prototype._initSearch = function (t, e) {
              ...
              i.inputChangedDelegate.subscribe(this, this._search), this._contentSearch.appendChild(i.$control[0]);
            }),
              ...
              for (
                ...
                c[a].addEventListener('click', function (t) {
                  var e,
                    ...
                    o = i.dataset.sort;
                  o && d._setSort(o),
                    0 !== (e = l.getElementsByClassName(_)).length && e[0].classList.remove(_),
                    i.classList.add(_),
                    i.classList.toggle('i-dropped', !d._getSortData().isAscending),
                    d._resetScroll(),
                    d._render();
                });
            }),
            (t.prototype._scrollHandler = function (t) {
              ...
              e.clientHeight + e.scrollTop >= e.scrollHeight - j / 2 &&
                this._renderWithOffset(this._getItemsToRender(), this._itemsCount, this._getMinShownItems());
            }),
            (t.prototype._disableContextMenu = function () {
              this._content.addEventListener('contextmenu', function (t) {
                var e,
                  i = t.target.parentElement;
                (null !== i && (e = i) && e.classList.contains('js-item-link')) || t.preventDefault();
              });
            }),
        ...
        (z = (function (t) {
          function e(e, i) {
            ...
            return (
              ...
              e.forEach(function (t) {
                var e;
                t.symbol =
                  0 !== (e = t).symbol.length ? e.symbol + ', ' + Object(u.getTranslatedResolution)(e.interval) : E;
              }),
          ...
          return (
            ...
            (e.prototype._renderItem = function (t) {
              ...
              return this._prepareHighlight(s(t), p), (e = q.format(c)), this._makeItemTemplate(p, g, e, R);
            }),
    ...
    qoI1: function (t, e, i) {
      ...
      function n(t) {
        var e,
          i = s[t];
        if (!(i + 1)) throw (((e = new Error("Cannot find module '" + t + "'")).code = 'MODULE_NOT_FOUND'), e);
        return i;
      }
      var s = {
        './en-gb': 'Oaa7',
    ...
    rMPu: function (t, e, i) {
      t.exports = {
        ...
        'list-dialog__items-list-container': 'list-dialog__items-list-container-3udN82S7-',
        ...
        'list-dialog__row--item-active': 'list-dialog__row--item-active-1KBCgO8t-',
        'list-dialog__column': 'list-dialog__column-19ZOQoKP-',
        'list-dialog__column--header': 'list-dialog__column--header-3SOUE3EQ-',
        'list-dialog__column--header-active': 'list-dialog__column--header-active-g3V-G5Px-',
        ...
        'list-dialog__favorite-icon--starred': 'list-dialog__favorite-icon--starred-3YY_YpZL-',
      };
    },
  },
]);
