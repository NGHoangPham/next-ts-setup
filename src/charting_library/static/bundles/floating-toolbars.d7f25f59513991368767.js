  ...
  ['floating-toolbars'],
  {
    '0ZwQ': function (t, e, o) {
      ...
      function n() {
        ...
        return m
          ? ((t = i()),
            (o = ((e = getComputedStyle(t)).paddingLeft && parseFloat(e.paddingLeft)) || 0),
      ...
      function r() {
        ...
        return m
          ? ((t = i()),
            (o = ((e = getComputedStyle(t)).paddingTop && parseFloat(e.paddingTop)) || 0),
        ...
        (x = (function () {
          ...
          return (
            ...
            (t.prototype.addWidget = function (t, e) {
              ...
              ((i = document.createElement('div')).className = 'tv-floating-toolbar__widget js-widget'),
                i.appendChild(t),
            ...
            (t.prototype._findWrapperForWidget = function (t) {
              ...
              for (e = 0; e < i.length; ++e) if ((o = i.item(e)).contains(t)) return o;
              return null;
            }),
            ...
            (t.prototype._updateAxisOption = function () {
              if (this._options.dragOnlyInsideToolbar) {
                ...
                Object(v.lazyJqueryUI)(a()(this._content)).sortable('option', 'axis', t);
              }
            }),
            ...
            (t.prototype._resizeResponsive = function () {
              ...
              null !== this._responsiveResizeFunction &&
                ('auto' === (t = this._options.layout || 'auto') && (t = this._isVertical ? 'vertical' : 'horizontal'),
                (e = 'vertical' === t ? this._widget.clientHeight : this._widget.clientWidth),
                (o = ('vertical' === t ? r() : n()) - e),
            ...
            (t.prototype._loadPosition = function () {
              var t = Object(p.getJSON)(this._options.positionSettingsKey, this._options.defaultPosition);
            ...
            (b = (function (e) {
              ...
              return (
                ...
                (o.prototype.hide = function () {
                  h.setValue(o._visibilitySettingsKey, !1), e.prototype.hide.call(this);
                }),
                ...
                (o.prototype._onFavoriteRemoved = function (t) {
                  this.removeWidget(this._linetoolsWidgets[t]),
                    ...
                    0 === l.a.favoritesCount() && (this._canBeShownValue.setValue(!1), this.hide());
                }),
                ...
                (o.prototype._createLinetoolWidget = function (e) {
                  ...
                  return (
                    o.addEventListener('click', function (t) {
                      t.preventDefault(), p.tool.value() !== e && p.tool.setValue(e);
                    }),
                ...
                (o.prototype._attachHandlers = function () {
                  ...
                  l.a.favoriteAdded.subscribe(this, this._onFavoriteAdded),
                    l.a.favoriteRemoved.subscribe(this, this._onFavoriteRemoved),
                    ...
                    this.onWidgetsReordered().subscribe(this, function (e, o) {
                      if ((l.a.favoriteMoved.unsubscribe(t, t._onFavoriteMoved), !l.a.moveFavorite(l.a.favorite(e), o)))
                    ...
                    p.tool.subscribe(this._onSelectedLinetoolChanged.bind(this));
                }),
                (o.prototype._loadVisibilityState = function () {
                  var t = l.a.favoritesCount() > 0;
                  this._canBeShownValue.setValue(t),
                    h.getBool(o._visibilitySettingsKey, !0) && t ? this.show() : this.hide();
                }),
              ...
              return (
                ...
                void 0 !== (o = this._windows.get(t))
                  ...
                  : (this.registerWindow(t),
                    ((i = this._document.createElement('div')).style.position = e.position),
        ...
        (c = (function (t) {
          ...
          return (
              ...
              for (e = 0; e < i; ++e)
                if ((o = this._statedWidgets[e]).statedWidget.id === t)
                  return (
                    ...
                    void 0 !== o.clickListener && o.toolbarWidget.removeEventListener('click', o.clickListener),
            ...
            (e.prototype._ensuredGetWidgetDataForId = function (t) {
              var e, o, i;
              for (e = 0, o = this._statedWidgets; e < o.length; e++) if ((i = o[e]).statedWidget.id === t) return i;
              ...
              (i.element.className += 'tv-grouped-floating-toolbar__popup js-popup'),
                ...
                t.statedWidget.states.forEach(function (n, r) {
                  ...
                  s.addEventListener('click', a),
                    ...
                    s.classList.add('tv-grouped-floating-toolbar__sub-widget--slide-left-' + (e - r + 1)),
        ...
        o('m/4m'),
          ...
          (n.prototype.findSourceOnWidget = function (t) {
            ...
            for (e = 0; e < this.activeChartWidget().model().panes().length; e++)
              for (o = this.activeChartWidget().model().panes()[e].orderedSources(), i = 0; i < o.length; i++)
                if (o[i] === t) return o[i];
          }),
          ...
          (n.prototype.showTemplatesOf = function (t) {
            ...
            e.enabled('line_tool_templates') &&
              ((i = t.source) ? ((n = i.getConstructor()), (r = i.properties())) : ((n = t.tool), (r = t.properties)),
              ...
              (a = function (t) {
                i
                  ? (s.activeChartWidget().model().applyLineToolTemplate(i, t, 'Apply Drawing Template'),
                    s.onSourceChanged([i]))
                  : (r.merge(t), r.listeners().fire(this), r.saveDefaults(), s.onToolChanged(n, r));
              }),
              (TradingView.onWidget() && !window.is_authenticated) ||
                ...
                ((this._templatesList = new P(n, a, {
                  ...
                  defaultsCallback: function () {
                    void 0 !== i
                      ? s.activeChartWidget().model().restorePropertiesForSource(i)
          ...
          (n.prototype._createButton = function (t) {
            ...
            return (
              ...
              t.svgIcon &&
                ((o = document.createElement('div')).classList.add('tv-linetool-properties-toolbar__icon'),
                ...
                { button: this._createZOrderButton() },
                {
                  ...
                  isVisibleForSources: function (t) {
                    ...
                    return t.filter(function (t) {
                      ...
                      return !e.activeChartWidget().model().model().isSingleInstanceLineTool(o);
                    }).length;
                  }.bind(this),
                },
          ...
          (n.prototype._getZOrderActions = function () {
            var t = [],
              ...
              l = a.getZOrderMinMax();
            return (
              1 === e.length && e[0].zorder() === l.minZOrder && ((n.disabled = !0), (s.disabled = !0)),
              1 === e.length && e[0].zorder() === l.maxZOrder && ((r.disabled = !0), (i.disabled = !0)),
              t.push(i, n, r, s),
              t
            );
          }),
          ...
          (n.prototype.showPropertiesOf = function (t, e) {
            ...
            if (
              ...
              for (i = {}, n = o.length - 1; n >= 0; --n)
                if (((l = e[(a = o[n]).name]), 'function' != typeof (d = a.showIf) || d(l, e))) {
                  if (!l) continue;
                  if (((this._propertiesVisible = !0), (c = []), 'combobox' !== a.inputType)) {
                  ...
                  a.simple ? a.comboboxOptions.forEach(r.bind(null, c)) : a.comboboxOptions.forEach(s.bind(null, c)),
                    a.propertyProxy && (l = a.propertyProxy(e, this.activeChartWidget().model())),
                    (i[a.name] = l),
                    l.subscribe(this, this._onPropertyChanged.bind(this, a.name, l)),
          ...
          (n.prototype._clearProperties = function () {
            this._currentProperties &&
              (this._clearProeprtiesOnHideTimeoutId &&
                (clearTimeout(this._clearProeprtiesOnHideTimeoutId), (this._clearProeprtiesOnHideTimeoutId = null)),
          ...
          (n.prototype.colorPropertyControl = function (t, e, o) {
            ...
            return (
              ...
              i.after(r),
              this.bindControl(new T(s, t, !0, this.activeChartWidget().model(), null, n.getTransparency(e, o))),
            ...
            return function (o, r) {
              ...
              return (
                ...
                (a = new i(s)).subscribe(this, function (i) {
                  var n = i.value();
                  n < 2
                    ? (r.beginUndoMacro(''), o[t].setValue(n), o[e] && o[e].setValue(!1), r.endUndoMacro())
