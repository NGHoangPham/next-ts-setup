              ...
              r.fn = r.prototype =
                {
                  ...
                  position: function () {
                    var e = this[0],
                      ...
                      n = this.offset(),
                      a = /^(?:body|html)$/i.test(t.nodeName) ? { top: 0, left: 0 } : r(t).offset();
                    return (
          ...
          return (function (e, t, r, n) {
            ...
            function l(e, r, n, a) {
              ...
              function c(t) {
                ...
                return (a = u((r = i + ((t - f[--o]) / (f[o + 1] - f[o])) * S), e, n)) >= b
                  ? (function (t, r) {
                      var a, i;
                      for (a = 0; a < y; ++a) {
                ...
                F.isString(e)
                  ...
                  : (r =
                      F.isArray(e) && 1 === e.length
                        ...
                        : !(!F.isArray(e) || 4 !== e.length) && l.apply(null, e)),
                !1 === r && (r = m.Easings[m.defaults.easing] ? m.defaults.easing : g),
                r
              );
            }
            function c(e) {
              ...
              if (e)
                for (
                  ...
                  if (m.State.calls[a]) {
                    ...
                    for (b = o[6] = t - u, x = Math.min(b / l.duration, 1), w = 0, S = s.length; w < S; w++)
                      if (((P = s[w]), i((V = P.element)))) {
                        ...
                        l.display !== n &&
                          ...
                          'none' !== l.display &&
                          ('flex' === l.display &&
                            ((A = ['-webkit-box', '-moz-box', '-ms-flexbox', '-webkit-flex']),
                        ...
                        P))
                          if (P.hasOwnProperty(E) && 'element' !== E) {
                            if (
                              ((N = P[E]),
                              (O = F.isString(N.easing) ? m.Easings[N.easing] : N.easing),
                              F.isString(N.pattern)
                                ...
                                : 1 === x
                                ? (H = N.endValue)
                                : ((q = N.endValue - N.startValue), (H = N.startValue + q * O(x, l, q))),
                              !f && H === N.currentValue)
                            )
                              continue;
                            (N.currentValue = H),
                              'tween' === E
                                ...
                                : (y.Hooks.registered[E] &&
                                    ((z = y.Hooks.getRoot(E)),
                                    (L = i(V).rootPropertyValueCache[z]) && (N.rootPropertyValue = L)),
                                  (R = y.setPropertyValue(
                                    V,
                                    E,
                                    N.currentValue + (k < 9 && 0 === parseFloat(H) ? '' : N.unitType),
                                    N.rootPropertyValue,
                                    N.scrollData
                                  )),
                                  y.Hooks.registered[E] &&
                                    (y.Normalizations.registered[z]
                                      ? (i(V).rootPropertyValueCache[z] = y.Normalizations.registered[z](
                                          'extract',
                                          null,
                                          R[1]
                                        ))
                                      : (i(V).rootPropertyValueCache[z] = R[1])),
                                  'transform' === R[0] && (C = !0));
                          }
                        l.mobileHA &&
                    ...
                    l.display !== n && 'none' !== l.display && (m.State.calls[a][2].display = !1),
                      l.visibility !== n && 'hidden' !== l.visibility && (m.State.calls[a][2].visibility = !1),
                      l.progress && l.progress.call(o[1], o[1], x, Math.max(0, u + l.duration - t), u, g),
                      1 === x && p(a);
                  }
            ...
            function p(e, t) {
              ...
              for (
                ...
                if (
                  ...
                  t ||
                    o.loop ||
                    ('none' === o.display && y.setPropertyValue(p, 'display', o.display),
                    'hidden' === o.visibility && y.setPropertyValue(p, 'visibility', o.visibility)),
                  (f = i(p)),
                  !0 === o.loop ||
                    (d.queue(p)[1] !== n && /\.velocityQueueEntryFlag/i.test(d.queue(p)[1])) ||
                    (f &&
                      ((f.isAnimating = !1),
                      ...
                      o.mobileHA && ((g = !0), delete f.transformCache.translate3d),
            ...
            var d,
              ...
              k = (function () {
                ...
                for (e = 7; e > 4; e--)
                  if (
                    (((t = r.createElement('div')).innerHTML = '\x3c!--[if IE ' + e + ']><span></span><![endif]--\x3e'),
              ...
              T =
                ('function' != typeof (S = t.performance || {}).now &&
                  ((w = S.timing && S.timing.navigationStart ? S.timing.navigationStart : new Date().getTime()),
                  (S.now = function () {
                ...
                try {
                  ...
                  return function (t, r) {
                    var n,
                      ...
                      o,
                      s = this.length;
                    if (('number' != typeof t && (t = 0), 'number' != typeof r && (r = s), this.slice))
                      return e.call(this, t, r);
                    if (
                      ((a = []), (i = t >= 0 ? t : Math.max(0, s + t)), (o = (r < 0 ? s + r : Math.min(r, s)) - i) > 0)
                    )
                      if (((a = new Array(o)), this.charAt)) for (n = 0; n < o; n++) a[n] = this.charAt(i + n);
              ...
              E = !1;
            if ((e.fn && e.fn.jquery ? ((d = e), (E = !0)) : (d = t.Velocity.Utilities), k <= 8 && !E))
            ...
            if (!(k <= 7))
              return (
                ...
                t.pageYOffset !== n
                  ...
                  : ((m.State.scrollAnchor = r.documentElement || r.body.parentNode || r.body),
                  ...
                  return function e(t, n, a) {
                    ...
                    for (
                      t = parseFloat(t) || 500,
                        ...
                        l.tension = t,
                        l.friction = n,
                        o = (i = null !== a) ? ((c = e(t, n)) / a) * 0.016 : 0.016;
                ...
                (y = m.CSS =
                  {
                    ...
                    Hooks: {
                      ...
                      register: function () {
                        ...
                        for (e = 0; e < y.Lists.colors.length; e++)
                          (t = 'color' === y.Lists.colors[e] ? '0 0 0 1' : '255 255 255 1'),
                          ...
                          for (r in y.Hooks.templates)
                            y.Hooks.templates.hasOwnProperty(r) &&
                              ...
                              'Color' === a[0] &&
                                (a.push(a.shift()),
                                i.push(i.shift()),
                                (y.Hooks.templates[r] = [a.join(' '), i.join(' ')])));
                        for (r in y.Hooks.templates)
                          if (y.Hooks.templates.hasOwnProperty(r))
                            for (o in (a = (n = y.Hooks.templates[r])[0].split(' ')))
                              a.hasOwnProperty(o) && ((s = r + a[o]), (l = o), (y.Hooks.registered[s] = [r, l]));
                      },
                      getRoot: function (e) {
                      ...
                      fixColors: function (e) {
                        return e.replace(/(rgba?\(\s*)?(\b[a-z]+\b)/g, function (e, t, r) {
                          return y.Lists.colorNames.hasOwnProperty(r)
                            ? (t || 'rgba(') + y.Lists.colorNames[r] + (t ? '' : ',1)')
                            : t + r;
                        });
                      },
                      ...
                      extractValue: function (e, t) {
                        ...
                        return a
                          ? ((r = a[0]),
                            (n = a[1]),
                            (t = y.Hooks.cleanRootPropertyValue(r, t)).toString().match(y.RegEx.valueSplit)[n])
                          : t;
                      },
                      injectValue: function (e, t, r) {
                        ...
                        return o
                          ? ((n = o[0]),
                            (a = o[1]),
                            ((i = (r = y.Hooks.cleanRootPropertyValue(n, r)).toString().match(y.RegEx.valueSplit))[a] =
                              t),
                            i.join(' '))
                          : r;
                      },
                      ...
                      registered: {
                        clip: function (e, t, r) {
                          switch (e) {
                            ...
                            case 'extract':
                              var n;
                              return (n = y.RegEx.wrappedValueAlreadyExtracted.test(r)
                                ? r
                          ...
                          switch (e) {
                            ...
                            case 'extract':
                              return (
                                (n = parseFloat(r)) ||
                                  0 === n ||
                                  (n = (a = r.toString().match(/blur\(([0-9]+[A-z]+)\)/i)) ? a[1] : 0),
                                n
                              );
                            case 'inject':
                      ...
                      register: function () {
                        function e(e, t, r) {
                          var n,
                            ...
                            o,
                            s,
                            l = 'border-box' === y.getPropertyValue(t, 'boxSizing').toString().toLowerCase();
                          if (l === (r || !1)) {
                            for (
                              i = 0,
                                s = [
                                  'padding' + (o = 'width' === e ? ['Left', 'Right'] : ['Top', 'Bottom'])[0],
                                  'padding' + o[1],
                                  'border' + o[0] + 'Width',
                                  'border' + o[1] + 'Width',
                                ],
                              ...
                              (a = parseFloat(y.getPropertyValue(t, s[n]))), isNaN(a) || (i += a);
                            return r ? -i : i;
                          }
                          return 0;
                        }
                            ...
                            y.Normalizations.registered[e] = function (t, r, a) {
                              switch (t) {
                                case 'name':
                                  return 'transform';
                                case 'extract':
                                  return i(r) === n || i(r).transformCache[e] === n
                                    ? /^scale/i.test(e)
                                      ? 1
                                      : 0
                                ...
                                case 'inject':
                                  ...
                                  switch (e.substr(0, e.length - 1)) {
                                    ...
                                    case 'scal':
                                    case 'scale':
                                      m.State.isAndroid && i(r).transformCache[e] === n && a < 1 && (a = 1),
                                        (o = !/(\d)$/i.test(a));
                                      break;
                                    case 'skew':
                                    case 'rotate':
                        ...
                        (y.Normalizations.registered.innerWidth = t('width', !0)),
                          (y.Normalizations.registered.innerHeight = t('height', !0)),
                    ...
                    Names: {
                      ...
                      SVGAttribute: function (e) {
                        ...
                        return (
                          (k || (m.State.isAndroid && !m.State.isChrome)) && (t += '|transform'),
                    ...
                    getPropertyValue: function (e, r, a, o) {
                        ...
                        if (k <= 8) g = d.css(e, r);
                          ...
                          if (
                            ...
                            /^(width|height)$/.test(r) &&
                              ...
                              ((a = !0), y.setPropertyValue(e, 'display', y.Values.getDisplayType(e))),
                            (l = function () {
                            ...
                            if (
                              'height' === r &&
                              'border-box' !== y.getPropertyValue(e, 'boxSizing').toString().toLowerCase()
                            )
                              return (
                                (u =
                                  e.offsetHeight -
                          ...
                          (p =
                            ...
                            ('' !== (g = 9 === k && 'filter' === r ? p.getPropertyValue(r) : p[r]) && null !== g) ||
                              (g = e.style[r]),
                            l();
                        }
                        return (
                          'auto' === g &&
                            ...
                            ('fixed' === (f = s(e, 'position')) || ('absolute' === f && /top|left/i.test(r))) &&
                            (g = d(e).position()[r] + 'px'),
                          g
                        );
                      }
                      ...
                      if (
                        (y.Hooks.registered[r]
                          ? ((u = r),
                            (c = y.Hooks.getRoot(u)),
                            a === n && (a = y.getPropertyValue(e, y.Names.prefixCheck(c)[0])),
                            y.Normalizations.registered[c] && (a = y.Normalizations.registered[c]('extract', e, a)),
                            (l = y.Hooks.extractValue(u, a)))
                          : y.Normalizations.registered[r] &&
                            ('transform' !== (p = y.Normalizations.registered[r]('name', e)) &&
                              ((f = s(e, y.Names.prefixCheck(p)[0])),
                              y.Values.isCSSNullValue(f) && y.Hooks.templates[r] && (f = y.Hooks.templates[r][1])),
                            (l = y.Normalizations.registered[r]('extract', e, f))),
                        !/^[\d-]/.test(l))
                      )
                      ...
                      return (
                        y.Values.isCSSNullValue(l) && (l = 0), m.debug >= 2 && console.log('Get ' + r + ': ' + l), l
                      );
                    },
                    setPropertyValue: function (e, r, n, a, o) {
                      ...
                      if ('scroll' === r)
                        ...
                        y.Normalizations.registered[r]('inject', e, n), (c = 'transform'), (n = i(e).transformCache[r]);
                      else {
                        if (
                          (y.Hooks.registered[r] &&
                            ((s = r),
                    ...
                    flushTransformCache: function (e) {
                      var t,
                        ...
                        o = '',
                        s = i(e);
                      (k || (m.State.isAndroid && !m.State.isChrome)) && s && s.isSVG
                        ? ((r = {
                            translate: [
                              (t = function (t) {
                ...
                (b = function () {
                  ...
                  if (
                    (F.isWrapped(this)
                      ...
                      : ((g = !0), (v = 1), (x = W ? arguments[0].elements || arguments[0].e : arguments[0])),
                    ...
                    if (
                      ((k = x.length),
                      (V = 0),
                      !/^(stop|finish|finishAll|pause|resume)$/i.test(w) && !d.isPlainObject(S))
                    )
                      for (S = {}, T = v + 1; T < arguments.length; T++)
                        ...
                        (!/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]))
                          ? F.isString(arguments[T]) || F.isArray(arguments[T])
                            ...
                            : F.isFunction(arguments[T]) && (S.complete = arguments[T])
                          ...
                          d.each(m.State.calls, function (e, t) {
                            ...
                            t &&
                              d.each(t[1], function (e, a) {
                                var i = S === n ? '' : S;
                                return (
                                  (!0 !== i && t[2].queue !== i && (S !== n || !1 !== t[2].queue)) ||
                        ...
                        return (
                          d.each(x, function (e, t) {
                            i(t) &&
                              ...
                              'finishAll' !== w ||
                                (!0 !== S && !F.isString(S)) ||
                                (d.each(d.queue(t, F.isString(S) ? S : ''), function (e, t) {
                                  F.isFunction(t) && t();
                                }),
                              ...
                              d.each(t[1], function (r, a) {
                                ...
                                d.each(x, function (r, n) {
                                  if (n === a)
                                    if (
                                      ((!0 === S || F.isString(S)) &&
                                        (d.each(d.queue(n, F.isString(S) ? S : ''), function (e, t) {
                        ...
                        if (!d.isPlainObject(w) || F.isEmptyObject(w))
                          return F.isString(w) && m.Redirects[w]
                            ? ((l = d.extend({}, S)),
                              (H = l.duration),
                              (O = l.delay || 0),
                              !0 === l.backwards && (x = d.extend(!0, [], x).reverse()),
                              d.each(x, function (e, t) {
                                parseFloat(l.stagger)
                                  ? (l.delay = O + parseFloat(l.stagger) * e)
                                  : F.isFunction(l.stagger) && (l.delay = O + l.stagger.call(t, e, k)),
                                  l.drag &&
                                    ((l.duration = parseFloat(H) || (/^(callout|transition)/.test(w) ? 1e3 : f)),
                                    (l.duration = Math.max(
                                      l.duration * (l.backwards ? 1 - e / k : (e + 1) / k),
                                      0.75 * l.duration,
                                      200
                                    ))),
                                  m.Redirects[w].call(t, t, l || {}, e, k, x, P.promise ? P : n);
                              }),
                              e())
                            : ((j =
                              ...
                              P.promise ? P.rejecter(new Error(j)) : t.console && console.log(j),
                              e());
                        C = 'start';
                    }
                    if (
                          ...
                          (function (e, a) {
                            function o(o) {
                              ...
                              if ('scroll' === C)
                                (f = /^x$/i.test(h.axis) ? 'Left' : 'Top'),
                                  ...
                                  h.container
                                    ? F.isWrapped(h.container) || F.isNode(h.container)
                                      ? ((h.container = h.container[0] || h.container),
                                        (E = (v = h.container['scroll' + f]) + d(e).position()[f.toLowerCase()] + g))
                                      : (h.container = null)
                                    : ((v = m.State.scrollAnchor[m.State['scrollProperty' + f]]),
                                      (T =
                                        m.State.scrollAnchor[
                                          m.State['scrollProperty' + ('Left' === f ? 'Top' : 'Left')]
                                        ]),
                                ...
                                for (N in ('none' === l.opts.display && (l.opts.display = 'auto'),
                                ...
                                (h = d.extend({}, l.opts, h)),
                                (p = d.extend(!0, {}, l ? l.tweensContainer : null))))
                                  p.hasOwnProperty(N) &&
                                    'element' !== N &&
                                    ((H = p[N].startValue),
                                    (p[N].startValue = p[N].currentValue = p[N].endValue),
                                    (p[N].endValue = H),
                                    F.isEmptyObject(S) || (p[N].easing = h.easing),
                                    m.debug &&
                                      console.log('reverse tweensContainer (' + N + '): ' + JSON.stringify(p[N]), e));
                                b = p;
                              } else if ('start' === C) {
                                for (L in ((l = i(e)) &&
                                  l.tweensContainer &&
                                    ...
                                    F.isArray(t)
                                      ? ((n = t[0]),
                                        ...
                                        y.RegEx.isHex.test(t[1])
                                          ? (o = t[1])
                                          : (F.isString(t[1]) && !y.RegEx.isHex.test(t[1]) && m.Easings[t[1]]) ||
                                            F.isArray(t[1])
                                          ? ((i = r ? t[1] : u(t[1], h.duration)), (o = t[2]))
                                          : (o = t[1] || t[2]))
                                      : (n = t),
                                    r || (i = i || h.easing),
                                ...
                                (j = function (a, i) {
                                  ...
                                  if (
                                    ...
                                    if (
                                      (((h.display !== n && null !== h.display && 'none' !== h.display) ||
                                        (h.visibility !== n && 'hidden' !== h.visibility)) &&
                                        /opacity|filter/.test(a) &&
                                        !G &&
                                        0 !== I &&
                                        (G = 0),
                                      h._cacheValues && p && p[a]
                                        ? (G === n && (G = p[a].endValue + p[a].unitType),
                                          (B = l.rootPropertyValueCache[$]))
                                        : y.Hooks.registered[a]
                                        ? G === n
                                          ? ((B = y.getPropertyValue(e, $)), (G = y.getPropertyValue(e, a, B)))
                                          : (B = y.Hooks.templates[$][1])
                                        : G === n && (G = y.getPropertyValue(e, a)),
                                      (g = !1),
                                      (v = function (e, t) {
                                        var r, n;
                                        return (
                                      ...
                                      (x === G.length && w === I.length) ||
                                        (m.debug &&
                                          console.error(
                                            'Trying to pattern match mis-matched strings ["' + I + '", "' + G + '"]'
                                          ),
                                        (o = n)),
                                        o &&
                                          (S.length
                                    ...
                                    if (
                                      (o ||
                                        ((G = (u = v(a, G))[0]),
                                        (f = u[1]),
                                        (I = (u = v(a, I))[0].replace(/^([+-\/*])=/, function (e, t) {
                                          return (g = t), '';
                                        })),
                                        (c = u[1]),
                                        (G = parseFloat(G) || 0),
                                        ...
                                        '%' === c &&
                                          (/^(fontSize|lineHeight)$/.test(a)
                                            ...
                                            : /^scale/.test(a)
                                            ? ((I /= 100), (c = ''))
                                            : /(Red|Green|Blue)$/i.test(a) && ((I = (I / 100) * 255), (c = '')))),
                                      (M = function () {
                                        var n,
                                          a,
                                          i,
                                        ...
                                        return (
                                          ...
                                          u && s
                                            ...
                                            : ((i =
                                              ...
                                              m.CSS.setPropertyValue(i, 'position', o.position),
                                              m.CSS.setPropertyValue(i, 'fontSize', o.fontSize),
                                              m.CSS.setPropertyValue(i, 'boxSizing', 'content-box'),
                                              d.each(
                                              ...
                                              m.CSS.setPropertyValue(i, 'paddingLeft', n + 'em'),
                                              (a.percentToPxWidth = q.lastPercentToPxWidth =
                                                (parseFloat(y.getPropertyValue(i, 'width', null, !0)) || 1) / n),
                                              (a.percentToPxHeight = q.lastPercentToPxHeight =
                                                (parseFloat(y.getPropertyValue(i, 'height', null, !0)) || 1) / n),
                                              (a.emToPx = q.lastEmToPx =
                                                (parseFloat(y.getPropertyValue(i, 'paddingLeft')) || 1) / n),
                                              o.myParent.removeChild(i)),
                                          null === q.remToPx &&
                                            (q.remToPx = parseFloat(y.getPropertyValue(r.body, 'fontSize')) || 16),
                                          null === q.vwToPx &&
                                          ...
                                          (a.vwToPx = q.vwToPx),
                                          (a.vhToPx = q.vhToPx),
                                          m.debug >= 1 && console.log('Unit ratios: ' + JSON.stringify(a), e),
                                          a
                                        );
                                      }),
                                      /[\/*]/.test(g))
                                    ...
                                    (b[a] = {
                                      ...
                                      o && (b[a].pattern = o),
                                      m.debug && console.log('tweensContainer (' + a + '): ' + JSON.stringify(b[a]), e);
                                  } else
                                    m.debug && console.log('Skipping [' + $ + '] due to a lack of browser support.');
                                }),
                                w))
                                  if (w.hasOwnProperty(L))
                                    if (
                                      ...
                                      (M = O(w[L])),
                                      A(y.Lists.colors, R) &&
                                        ((W = M[0]), ($ = M[1]), (B = M[2]), y.RegEx.isHex.test(W)))
                                    )
                                      for (
                                        I = ['Red', 'Green', 'Blue'],
                                        ...
                                        (X = [D[Q]]), $ && X.push($), G !== n && X.push(G[Q]), j(R + I[Q], X);
                                    else j(R, M);
                                b.element = e;
                              }
                              b.element &&
                                ...
                                z.push(b),
                                (l = i(e)) &&
                                  ('' === h.queue && ((l.tweensContainer = b), (l.opts = h)), (l.isAnimating = !0)),
                                V === k - 1
                                  ? (m.State.calls.push([z, x, h, null, P.resolver, null, 0]),
                                    !1 === m.State.isTicking && ((m.State.isTicking = !0), c()))
                                  : V++);
                            }
                            var s,
                              l,
                            ...
                            !1 !== m.mock &&
                              (!0 === m.mock
                                ...
                                : ((h.duration *= parseFloat(m.mock) || 1), (h.delay *= parseFloat(m.mock) || 1))),
                              (h.easing = u(h.easing, h.duration)),
                              h.begin && !F.isFunction(h.begin) && (h.begin = null),
                              h.progress && !F.isFunction(h.progress) && (h.progress = null),
                              h.complete && !F.isFunction(h.complete) && (h.complete = null),
                              h.display !== n &&
                                null !== h.display &&
                                ((h.display = h.display.toString().toLowerCase()),
                                'auto' === h.display && (h.display = m.CSS.Values.getDisplayType(e))),
                              h.visibility !== n &&
                                null !== h.visibility &&
                                (h.visibility = h.visibility.toString().toLowerCase()),
                              (h.mobileHA = h.mobileHA && m.State.isMobile && !m.State.isGingerbread),
                              !1 === h.queue
                                ? h.delay
                      ...
                      ((l = d.extend({}, m.defaults, S)).loop = parseInt(l.loop, 10)),
                      (L = 2 * l.loop - 1),
                      l.loop)
                    )
                      for (R = 0; R < L; R++)
                        (M = { delay: l.delay, progress: l.progress }),
                          R === L - 1 &&
                            ((M.display = l.display), (M.visibility = l.visibility), (M.complete = l.complete)),
                          b(x, 'reverse', M);
                    return e();
                  }
                ...
                (e.Velocity = m),
                e !== t && ((e.fn.velocity = b), (e.fn.velocity.defaults = m.defaults)),
