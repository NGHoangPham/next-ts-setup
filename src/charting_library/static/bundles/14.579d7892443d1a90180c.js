(window.webpackJsonp = window.webpackJsonp || []).push([
  [14],
  {
          ...
          return (
            ...
            (e.prototype.render = function () {
              var t = this.props,
                ...
                d = void 0 !== c && c,
                p = t.className,
                _ = r(p, h.dialog, n && h.rounded, l && h.shadowed, d && h.fullscreen),
    ...
    QpNh: function (t, e, n) {
      ...
      function o(t) {
        var e,
          ...
          u = {};
        for (e = 0, n = a; e < n.length; e++) (r = (o = n[e])[0]), (s = o[1]), (u[r] = s);
        return u;
      }
      function i(t) {
        var e = t[0],
    ...
    WXjp: function (t, e, n) {
      ...
      function i(t) {
        return {
          x: Object(f.clamp)(t.x, 20, document.documentElement.clientWidth - 20),
          ...
          return (
            ...
            (t.prototype._moveDialog = function (t, e) {
              var n = this._dialog.getBoundingClientRect(),
                ...
                r = o(t, n.width, i ? 0 : -1 / 0, i ? window.innerWidth : 1 / 0),
                s = o(e, n.height, i ? 0 : -1 / 0, i ? window.innerHeight : 1 / 0);
              ...
              (this._dialog.style.height = 'auto'),
                ...
                this._isFullscreen
                  ...
                  : ((i = this._options.vertical),
                    ...
                    (s = e - 2 * i),
                    (a = o((r = this._dialog.getBoundingClientRect()).left, r.width, 0, n)),
                    (u = o(r.top, r.height, i, e)),
                    (this._dialog.style.top = '0px'),
                    (this._dialog.style.left = '0px'),
                    (this._dialog.style.transform = 'translate(' + Math.round(a) + 'px, ' + Math.round(u) + 'px)'),
                    (this._dialog.style.height = s < r.height ? s + 'px' : this._initialHeight));
            }),
            (t.prototype.destroy = function () {
    ...
    qoI1: function (t, e, n) {
      ...
      function i(t) {
        var e,
          n = r[t];
        if (!(n + 1)) throw (((e = new Error("Cannot find module '" + t + "'")).code = 'MODULE_NOT_FOUND'), e);
        return n;
      }
      var r = {
        './en-gb': 'Oaa7',
          ...
          return (
            ...
            (n.prototype.render = function () {
              var e,
                ...
                a = n.root;
              return o
                ? ((e = r.createElement(t, i.__assign({}, this.props, { zIndex: 150 }))),
