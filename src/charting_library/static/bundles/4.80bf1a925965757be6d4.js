        ...
        (s = void 0 !== t ? t : this),
          (e.exports = (function (e) {
            ...
            var t = function (e) {
              ...
              for (t = String(e), s = t.length, n = -1, o = '', l = t.charCodeAt(0); ++n < s; )
                0 != (i = t.charCodeAt(n))
                  ? (o +=
                      (i >= 1 && i <= 31) ||
                      127 == i ||
          ...
          e.extend(s.prototype, {
              ...
              function o(s) {
                l.children().each(function (n) {
                  ...
                  if (e(this).is(':selected')) {
                    if (38 == s && n > 0)
                      return (i = e(l.children()[n - 1])), a._changeSelectbox(t, i.val(), i.text()), !1;
            ...
            _changeSelectbox: function (t, s, o) {
              ...
              p ||
                ...
                l.attr('selected', !0),
                r ? r.apply(d.input ? d.input[0] : null, [s, d]) : d.input && d.input.trigger('change'));
            },
                ...
                'object' == typeof b && null !== b
                  ...
                  : (r > 50 && !f.settings.slidesUp
                    ...
                    a.left + i.width() > l
                      ...
                      : i.css('left', '-1px')),
                'fade' === f.settings.effect ? i.fadeIn(f.settings.speed) : i.slideDown(f.settings.speed),
                s.find('#sbToggle_' + f.uid).addClass(f.settings.classToggleOpen),
                s.find('#sbHolder_' + f.uid).addClass(f.settings.classHolderOpen),
                (this._state[f.uid] = !0),
                (f.isOpen = !0),
            ...
            _closeSelectbox: function (t) {
              ...
              i &&
                ...
                s.find('#sbToggle_' + i.uid).removeClass(i.settings.classToggleOpen),
                s.find('#sbHolder_' + i.uid).removeClass(i.settings.classHolderOpen),
                (this._state[i.uid] = !1),
                (i.isOpen = !1),
            ...
            _getOptions: function (t, s, n, o, l) {
              ...
              arguments[0].each(function (t) {
                var s,
                  ...
                  f = e(this),
                  h = e('<li>');
                f.is(':selected') && (n.sbSelector.text(f.text()), i(n, n.sbSelector, f, !0), (n.isSelected = !0)),
                  t === o - 1 && h.addClass('last'),
                  (p = f.text()),
                  (u = f.data('custom-option-text')),
                  (b = void 0 !== u ? u : p),
                  '__separator__' === f.val()
                    ? (s = e('<span>').addClass(n.settings.classSeparator)).appendTo(h)
                    : f.is(':disabled') || c
                    ? ((s = e('<span>', { text: b }).addClass(n.settings.classDisabled)),
