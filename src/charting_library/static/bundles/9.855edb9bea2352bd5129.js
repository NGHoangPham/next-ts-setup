    ...
    DxCR: function (t, e, i) {
      ...
      (function (t) {
        ...
        function c(t, e, i, o, r, n, s) {
          H.call(this, t, e, o, r, n), (this._transformFunction = i), (this._setter = s), this._attachToControl(t, o);
        }
        ...
        function y(e, i, o, r, n, s) {
          function a(t, e) {
            var i = c.control().slider('option', 'min'),
              ...
              r = c._property.value();
            ((i <= r && r <= o) || (i < e.value && e.value < o)) && c.setValueToProperty(e.value);
          }
          function l(t, e) {
            c.setValueToProperty(e.value);
          }
          isNumber(i.value()) ||
            (B.logWarn('Property cannot be binded to control, bad value (expect number): ' + i.value()), (i = new t())),
            H.call(this, e, i, o, r, n);
          var c = this;
          o && (s ? (e.bind('slidechange', a), e.bind('slide', a)) : (e.bind('slidechange', l), e.bind('slide', l))),
            ...
            n &&
              ...
              $(n[0]).on('keyup', function (t) {
                parseInt($(this).val()) < l._transformers[0]
                  ...
                  k.prototype.setValueToProperty.call(l, l._control.slider('values'), 'from');
              }),
              $(n[1]).on('keyup', function (t) {
                parseInt($(this).val()) < l._transformers[0]
                  ...
                  k.prototype.setValueToProperty.call(l, l._control.slider('values'), 'to');
              })),
        ...
        i('jgM0'),
          ...
          (r.prototype.saveData = function () {
            ...
            for (this._model.beginUndoMacro(), t = 0; t < this._bindings.length; t++)
              (e = this._bindings[t]).changed() && this._model.setProperty(e.property(), e.value());
          ...
          (r.prototype.createSeriesMinTickEditor = function () {
            var t,
              e,
              i = "<select><option value='default'>" + $.t('Default') + '</option>',
              o = [
          ...
          (r.prototype.createLabeledCell = function (t, e, i) {
            var o,
              ...
              a = null;
            return (
              'number' == typeof t.valueOf() ? ((a = t), (o = e), (r = i)) : ((o = t), (r = e)),
              (o += ''),
              (n = this._labelToId(o)),
              (s = $('<td>')),
              $('<label>')
          ...
          (r.prototype.addEditorRow = function (t, e, i, o) {
            ...
            return (i.row = this.addLabeledRow(t, e, i, o)), i.appendTo(r.appendTo(i.row)), i;
          }),
          ...
          (p.prototype.value = function () {
            ...
            return this._disabled
              ...
              : ((t = this._control.val()),
                ...
                1e3 *
                  M(this._mainSeries.bars().valueAt(M(this._mainSeries.bars().lastIndex()) - e))[
          ...
          (p.prototype.setValue = function (t) {
            ...
            if (this._disabled || null == t) this._control.attr('disabled', !0);
              ...
              null !==
              (e = this._mainSeries.data().plotValueToTimePointIndex(t / 1e3, TradingView.TIME_PLOT, F.FromRight))
            ...
            if (((t = '' + t), this._control.val(t), this._control.selectbox))
              try {
                (e = this._control.find("[value='" + x(t) + "']")).length > 0 &&
                  ((i = e[0]), this._control.selectbox('change', i.value, i.text));
              } catch (t) {}
          }),
              ...
              this.control().is('.visibility-switch') &&
                ...
                (o = this.control().data('hides'))
                  ...
                  : (r = this.control())
                      ...
                      .filter(function () {
                        var t = $(this);
                        return !t.find('label').length && t.find(':checkbox').attr('id') !== r.attr('id');
                      })
                      .each(function () {
                        var o = $(this),
                          r = o.children();
          ...
          (k.prototype.destroy = function () {
            this._propFrom &&
              this._propTo &&
              (this._propFrom.listeners().unsubscribe(this, H.prototype.propertyChanged),
            ...
            typeof (o = function (t) {
              return t.widget('ui.slider', t.ui.mouse, {
                ...
                _mouseCapture: function (e) {
                  ...
                  return (
                    ...
                    this.handles.each(function (e) {
                      ...
                      (r > i || (r === i && (e === c._lastChangedValue || c.values(e) === u.min))) &&
                        ((r = i), (n = t(this)), (s = e));
                    }),
                    !1 !== this._start(e, s) &&
                ...
                values: function (e, i) {
                  ...
                  for (o = this.options.values, r = arguments[0], n = 0; n < o.length; n += 1)
                ...
                _setOption: function (e, i) {
                  ...
                  switch (
                    ...
                    case 'value':
                      ...
                      break;
                    case 'values':
                      for (this._animateOff = !0, this._refreshValue(), o = r - 1; o >= 0; o--) this._change(null, o);
                      this._animateOff = !1;
                      break;
                    case 'step':
                    case 'min':
                ...
                _handleEvents: {
                  keydown: function (e) {
                    ...
                    switch (
                      ((r = this.options.step),
                      (i = o = this._hasMultipleValues() ? this.values(n) : this.value()),
                      e.keyCode)
                    ) {
                      case t.ui.keyCode.HOME:
                        o = this._valueMin();
        ...
        (function (t) {
          ...
          function o(k) {
            ...
            function V(e) {
              ...
              function o(e) {
                1 == e.which && ((H = !1), j.is('.opened') && t(W).get(0).focus());
              }
              function n(e) {
                var i = (function (e) {
                  var i = e.pageY,
                ...
                I.css({ top: i + 'px' }), (z[2] = c(1 - Math.max(0, Math.min(i, R)) / R)), b();
              }
              function m(e) {
                1 == e.which && ((B = !1), t(U).unbind('mouseup', m), j.is('.opened') && t(W).get(0).focus());
              }
              function b() {
                var t, e;
                L && ((L = !1), j.find('.tvcolorpicker-swatch.active').removeClass('active')),
                  (t = r(p(z), P.val())),
                  s(g(W.val().toUpperCase()), t) || ((e = f(t)), W.data('tvcolorpicker-custom-color', e), $.call(W, e));
              }
              var y,
                k,
                x,
                ...
                G = t('<div class="tvcolorpicker-swatches-area"></div>').appendTo(j);
              return (
                G.append(
                  M.call(this, [
                    'rgb(0, 0, 0)',
                ...
                (y = t('<div class="tvcolorpicker-custom-area"></div>').css({ display: 'none' }).appendTo(j)),
                (k = t('<div class="tvcolorpicker-hsv"></div>').appendTo(y)),
                (x = t('<div class="tvcolorpicker-hs"></div>').appendTo(k)),
                (V = t('<div class="tvcolorpicker-hs-handle"></div>').appendTo(x)),
                (S = t('<div class="tvcolorpicker-hs-area"></div>').appendTo(x)),
                (O = t('<div class="tvcolorpicker-vv">').appendTo(k)),
                (F = t('<div class="tvcolorpicker-v"></div>').appendTo(O)),
                (I = t('<div class="tvcolorpicker-v-handle"></div>').appendTo(F)),
                ...
                S.bind('mousedown', function (e) {
                  1 == e.which && ((H = !0), t(U).bind('mouseup', o), i(e), e.preventDefault());
                }),
                ...
                O.bind('mousedown', function (e) {
                  1 == e.which && ((B = !0), t(U).bind('mouseup', m), n(e), e.preventDefault());
                }),
                ...
                j.append(
                  t(M.call(this, C, { addClass: 'tvcolorpicker-user' })).addClass('tvcolorpicker-user-swatches')
                ),
                t(U.body).append(j),
                (function (e, i, o) {
                  var r,
            ...
            .tvcolorpicker({
              customColors: (function (t) {
                var e,
                  ...
                  o,
                  r = [];
                for (e = 0, i = t; e < i.length; e++) (o = i[e]), null !== Object(s.tryParseRgb)(o) && r.push(o);
                return r;
