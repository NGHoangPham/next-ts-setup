(window.webpackJsonp = window.webpackJsonp || []).push([
  ['chart-widget-gui'],
  {
    ...
    '1ANp': function (t, e, i) {
      ...
      function n() {
        if (!u) {
          (u = new h.a()).setValue(s(d.getValue('NavigationButtons.visibility'))),
      ...
      function r() {
        ...
        return (
          c ||
            ...
            (e = function () {
              var e = t.value();
              'alwaysOn' !== e && 'alwaysOff' !== e && (e = Modernizr.mobiletouch ? 'alwaysOn' : 'visibleOnMouseOver'),
                c && c.setValue(e);
            }),
            (t = n()).subscribe(c, e),
            e()),
      ...
      (function (t) {
        ...
        function o(t, e, i, s) {
          ...
          (this._options = Object.assign({}, u, s)),
            ...
            this._model.mainSeries().properties().visible.listeners().subscribe(this, this.updateLayout),
            (n = this._chart.properties().scalesProperties.textColor).listeners().subscribe(this, function (t) {
              this.$el.css('color', t.value());
            }),
            this.$el.css('color', n.value()),
            this._chart.properties().paneProperties.legendProperties.showLegend.subscribe(this, this.updateLayout),
        ...
        (o.prototype.destroy = function () {
          this._removeMouseEventHandlers(),
            ...
            this._model.mainSeries().properties().visible.listeners().unsubscribe(this, this.updateLayout);
        }),
          (o.prototype.updateThemedColors = function (t) {
            (this._iconColor = t), this._applyIconColors();
          }),
          (o.prototype._applyIconColors = function () {
            this.$el.find('.pane-legend-icon-container').css('color', this._iconColor || '');
          }),
            ...
            if (
              ...
              for (
                s = {
                  ...
                  (r = (o = e.orderedSources().slice()).indexOf(n)) > -1 && (o.splice(r, 1), o.push(n)),
                  l = o.length - 1;
                l >= 0;
                l--
              )
                (d = (a = o[l]).statusView()) &&
                  ...
                  (!u || s.showSeriesTitle || s.showSeriesOHLC || s.showStudyTitles || s.showStudyValues) &&
                    ((u && t.enabled('fundamental_widget')) ||
                      (!s.showLegend && u && c
                        ? this.$el.find('.expand-line').length ||
                          ...
                          this._options.sourceSelectionEnabled || p.addClass('legend-selection-disabled'),
                          p.appendTo(this.$el),
                          this._chartHasStudies()
                            ? ((_ = $(
                                '<a class="pane-legend-minbtn apply-common-tooltip apply" title="' +
                                  ...
                                  '"></a>'
                              ).append($(i('/vkn')).attr({ class: 'expand closed' }))),
                              p.append(_.on('click touchend', this.toggleTitles.bind(this))))
                            : p.addClass('pane-legend-line--without-child-studies'),
                          (p.source = a),
                          a.properties().visible.value() || p.addClass('disabled'),
                          (s = {
                            showStudyTitles: !1,
                              ...
                              ? (p.addClass('main'),
                                (_ = $(
                                  '<a class="pane-legend-minbtn apply-common-tooltip apply" title="' +
                                    ...
                                    '"></a>'
                                ).append($(i('scAS')).attr({ class: 'expand' }))),
                                p.append(_.on('click touchend', this.toggleTitles.bind(this))))
                              : p.addClass('pane-legend-line--without-child-studies')
                            : p.addClass('study'),
                          a.properties().visible.value() || p.addClass('disabled'),
          ...
          (o.prototype._generateItemsForRow = function (e, s, n) {
            ...
            if (
              (((y && n.showSeriesTitle) || (!y && n.showStudyTitles)) &&
                ((r = $('<span>')).addClass('pane-legend-line__wrap-description apply-overflow-tooltip'),
                (this._options.contextMenuEnabled && !this._chart.readOnly()) || r.addClass('no-context-menu'),
                ...
                !this._chart.readOnly() &&
                  ...
                  (y && w) ||
                    ...
                    $('<a class="pane-legend-icon apply-common-tooltip icon-hide" title="' + $.t('Show/Hide') + '">')
                      .append($(i('cgDJ')))
                      .appendTo(o)
                  ...
                  !y &&
                    ...
                    $('<a class="pane-legend-icon apply-common-tooltip format" title="' + $.t('Settings') + '">')
                      .append($(i('sGj7')))
                      .appendTo(o)
                      .on('click touchend', this._generateItemsForRow._onFormatClick.bind(this, g)),
                  !y &&
                    t.enabled('delete_button_in_legend') &&
                    $('<a class="pane-legend-icon apply-common-tooltip delete" title="' + $.t('Delete') + '">')
                      .append($(i('VLql')))
                      .appendTo(o)
                      .on('click touchend', this._generateItemsForRow._onDeleteClick.bind(this, g)))),
              (l = g.legendView()),
              this.isDataWindowValuesVisible(l) && l.isValuesVisible() && (!y || w))
            ) {
              for (
                h = [],
                  d = [],
                ...
                (p = $("<span class='pane-legend-item-value-wrap'>").appendTo(u)),
                  (_ = y ? $("<span class='pane-legend-item-value-title'>").appendTo(p) : null),
                  ...
                  h.push(v),
                  _ && d.push(_);
              (m = $("<span class='pane-legend-item-additional'>").appendTo(u.appendTo(e))),
                this._itemsBinding.push({
                  value: l,
                  cell: h,
          ...
          (o.prototype._generateItemsForRow._onFormatClick = function (t, e) {
            t.userEditEnabled() && this._chart.showChartPropertiesForSource(t, d.style),
            ...
            for (s = this._itemsBinding.length; s--; )
              (i = this._itemsBinding[s]),
                Array.isArray(i.cell) ||
                  ...
                  (r = i.value.color()),
                  (l = o !== this._model.mainSeries() && this._model.selection().isSelected(o) ? 'bold' : 'normal'),
                  'function' == typeof i.value.getSplitTitle
                    ? ((a = (u = i.value.getSplitTitle())[0].trim()), (h = u[1].trim()), (d = u[2].trim()))
                    : ((a = i.value.text().trim()), (h = ''), (d = '')),
                  t.enabled('fundamental_widget') &&
                    (a = ((p = (c = this._model.mainSeries()).symbolInfo()) ? p.name : c.actualSymbol()) + ' ' + a),
                  i.isCellInited ||
                    ((i.isCellInited = !0),
                    d || h
                      ...
                      : ((i.titleElement = document.createElement('div')),
                        i.titleElement.classList.add('apply-overflow-tooltip', 'pane-legend-title__container'),
                        i.cell[0].appendChild(i.titleElement),
                        (i.descriptionElement = document.createElement('div')),
                        i.descriptionElement.classList.add('pane-legend-title__description'),
                        i.titleElement.appendChild(i.descriptionElement))),
                  (this.valueChanged(n, 'color', r) || this.valueChanged(n, 'fontWeight', l)) &&
                    ((i.titleElement.style.color = r),
                    (i.titleElement.style.borderColor = r),
                    (i.titleElement.style.fontWeight = l)),
                  a !== i.description &&
                    ((i.descriptionElement.textContent = TradingView.clean(a, !0)), (i.description = a)),
                  i.intervalElement &&
                    h &&
                    h !== i.interval &&
          ...
          (o.prototype.update = function (t) {
            var e,
              ...
              p,
              _,
              v = !this._chart.isActive() && !this._chart.crossHairSyncEnabled(),
              m = v ? s : n;
            for (this._indicatorRows.forEach(m), this.updateTitle(), u = this._itemsBinding.length; u--; )
              if (
                ...
                for (
                  r.last || ((r.last = {}), r.last.dwView || (r.last.dwView = {})),
                    c = r.last,
                    a = r.value.items(),
                  ...
                  (d = a[h]),
                    ...
                    this.valueChanged(c[h], 'text', d.text()) && (e[h][0].textContent = d.text()),
                    e[h][0].classList.toggle('js-hidden', !_),
                    d.color() &&
                      this.valueChanged(c[h], 'color', d.color()) &&
                      e[h].css('color', l.resetTransparency(d.color())),
                    i &&
                      (this.valueChanged(c[h], 'sourceVisible', o) && this.setItemEnabled(i[h], o),
                      this.valueChanged(c[h], 'title', d.title()) && (i[h][0].textContent = d.title()),
    ...
    TGRH: function (t, e, i) {
      'use strict';
      var s, n, o, r, l, a, h, d, u, c, p, _, v, m, g, b, y, w, f, C, M, B, L, T;
      i.r(e),
          ...
          return (
            ...
            (t.prototype._init = function () {
              var t,
                ...
                i = this;
              if (
                ((this._widget = Object(o.a)(C).querySelector('.control-bar-wrapper')),
                (this._back = Object(o.a)(M).querySelector('.control-bar__btn--back-present')),
              ...
              (this._buttons = {
                ...
                this._chart.withModel(this, function () {
                  (i._chartModel = i._chart.model()),
                    (i._priceAxisChanged = i._chart.getPriceAxisWidthChangedByName(i._priceAxisName)),
                    (i._resetAvailabilityChanged = i._chartModel.model().isScalesResetAvailableChanged()),
                    i._priceAxisChanged.subscribe(i, i._updateBackBtnPosition),
                    i._resetAvailabilityChanged.subscribe(i, i._updateResetScalesButtonVisibility),
                    ...
                    (i._chartBackgroundProperty = i._chartModel.model().properties().paneProperties.background),
                    null !== i._chartBackgroundProperty && i._chartBackgroundProperty.subscribe(i, i._updateBgBarStyle),
                    i._updateBgBarStyle();
                });
            }),
            (t.prototype._initHandlers = function () {
              var t,
                ...
                o = Modernizr.mobiletouch ? ['touchend'] : ['mouseup', 'mouseout'];
              for (
            ...
            (t.prototype._check = function () {
              if (null !== this._chartModel && null !== this._back) {
                ...
                t !== this._backButtonVisible &&
                  ((this._backButtonVisible = t), this._back.classList.toggle(L, !this._backButtonVisible));
              }
            }),
                ...
                for (o = 0, r = n; o < r.length; o++)
                  (h = s - e > (l = r[o]).leftPartWidth),
                    ...
                    void 0 !== (c = this._getBtnGroup(l.className)) &&
                      ...
                      (c.classList.toggle('js-hidden', u), this._updateControlBarPosition());
            }),
            ...
            (t.prototype._updateControlBarPosition = function () {
              ...
              null !== this._widget &&
                ...
                ((t = 0),
                (t =
                  (e = this._controlBar.querySelectorAll('.js-btn-group:not(.js-hidden)')).length > 0
                    ? 86 * e.length
                    : 50),
            ...
            (t.prototype._move = function (t) {
              ...
              null !== this._chartModel &&
                ...
                0 === this._movingTimeout &&
                  ...
                  (i = 10),
                  (s = function () {
                    n._moveStep(e, 0, 50 * t, 1e3), (n._movingTimeout = setTimeout(s, i));
                  }),
              ...
              if (null !== this._chartModel) {
                ...
                'stop' === this._state && this._chartModel.beginUndoMacro(1 === t ? 'Move Left' : 'Move Right'),
                  null !== e.visibleBarsStrictRange() &&
                    ((i = e.indexToCoordinate(e.visibleBarsStrictRange().lastBar()) + e.barSpacing() / 2),
                    Math.abs(e.width() - i) > e.barSpacing() / 6 && this._chartModel.scrollChart(e.width() - i)),
                  (this._state = B.stop),
                  ...
                  this._movingTimeout ||
                    ...
                    (o = 400),
                    (r = function () {
                      l._moveByBarStep(t), s++, n > 100 && (n -= (s / 5) * 20), (l._movingTimeout = setTimeout(r, n));
                    }),
    ...
    koft: function (t, e, i) {
      ...
      (s.prototype.updateThemedColors = function (t) {
        t ? (this.jqDiv[0].style.color = t) : this.jqDiv[0].style.removeProperty('color');
      }),
          ...
          if (a)
            if (this._visible && this._chart.isActive()) {
              if (
                ...
                this.jqDiv.toggleClass('toppane', 0 === e || this._chart.isMaximizedPane()),
                (n = !1),
              ...
              e > 0 && !this._chart.isMaximizedPane() && !s
                ...
                e < this._model.panes().length - 1 && !this._chart.isMaximizedPane() && !s
                  ? (this._$downButton ||
                ...
                this._model.panes().length > 1 && !this._chart.isMaximizedPane() && !s
