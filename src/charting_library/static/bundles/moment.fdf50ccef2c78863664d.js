        ...
        e.exports = (function () {
          ...
          function y(e, t, n) {
            var i,
              ...
              o = 0;
            for (i = 0; i < a; i++) ((n && e[i] !== t[i]) || (!n && f(e[i]) !== f(t[i]))) && o++;
            return o + s;
          }
          function M() {}
          function w(e) {
          ...
          function Y(e, t) {
            var n;
            return e && (n = void 0 === t ? L(e) : D(e, t)) && (xe = n), xe._abbr;
          }
          function D(e, t) {
            return null !== t
              ? ((t.abbr = e), (Gt[e] = Gt[e] || new M()), Gt[e].set(t), Y(e), Gt[e])
              : (delete Gt[e], null);
          }
          function L(e) {
            var t;
            ...
            return (function (e) {
              for (var t, n, i, a, s = 0; s < e.length; ) {
                for (a = w(e[s]).split('-'), t = a.length, n = (n = w(e[s + 1])) ? n.split('-') : null; t > 0; ) {
          ...
          function v(e, n) {
            return function (i) {
              return null != i ? (b(this, e, i), t.updateOffset(this, n), this) : k(this, e);
            };
          }
          function k(e, t) {
          ...
          function P(e, t) {
            ...
            var i = 5;
            for (Et.lastIndex = 0; i >= 0 && Et.test(e); ) (e = e.replace(Et, n)), (Et.lastIndex = 0), (i -= 1);
            return e;
          }
          function x(e, t, n) {
            var i;
          ...
          function J(e, t) {
            ...
            return 'string' == typeof t && 'number' != typeof (t = e.localeData().monthsParse(t))
              ? e
              : ((n = Math.min(e.date(), G(e.year(), t))), e._d['set' + (e._isUTC ? 'UTC' : '') + 'Month'](t, n), e);
          }
          function N(e) {
            return null != e ? (J(this, e), t.updateOffset(this, !0), this) : k(this, 'Month');
          }
          function E(e) {
            var t,
              n = e._a;
              ...
              n &&
                ...
                ((t =
                  n[dn] < 0 || n[dn] > 11
                    ...
                    ? un
                    : n[ln] < 0 || n[ln] > 24 || (24 === n[ln] && (0 !== n[_n] || 0 !== n[cn] || 0 !== n[mn]))
                    ? ln
                    : n[_n] < 0 || n[_n] > 59
                    ? _n
                    : n[cn] < 0 || n[cn] > 59
                      ...
                      null != (t = e._w).GG || null != t.W || null != t.E
                        ...
                        (r = (function (e, t, n, i, a) {
                          ...
                          return (
                            r < a && (r += 7),
                            {
                              year: (s = 1 + o + 7 * (t - 1) - r + (n = null != n ? 1 * n : a)) > 0 ? e : e - 1,
          ...
          function X(e) {
            if (e._f !== t.ISO_8601) {
              ...
              var n,
                ...
                u = r.length,
                l = 0;
              for (a = P(e._f, e._locale).match(Nt) || [], n = 0; n < a.length; n++)
                (s = a[n]),
                  (i = (r.match(z(s, e)) || [])[0]) &&
                    ((o = r.substr(0, r.indexOf(i))).length > 0 && d(e).unusedInput.push(o),
                    (r = r.slice(r.indexOf(i) + i.length)),
                    (l += i.length)),
                  jt[s]
                    ? (i ? (d(e).empty = !1) : d(e).unusedTokens.push(s), U(s, i, e))
                    : e._strict && !i && d(e).unusedTokens.push(s);
              (d(e).charsLeftOver = u - l),
                r.length > 0 && d(e).unusedInput.push(r),
                !0 === d(e).bigHour && e._a[ln] <= 12 && e._a[ln] > 0 && (d(e).bigHour = void 0),
                (e._a[ln] =
                  ((_ = e._locale),
                  (c = e._a[ln]),
                  null == (m = e._meridiem)
                    ...
                    ? _.meridiemHour(c, m)
                    : null != _.isPM
                    ? ((h = _.isPM(m)) && c < 12 && (c += 12), h || 12 !== c || (c = 0), c)
                    : c)),
                B(e),
                E(e);
            } else Z(e);
                        ...
                        : (function (e) {
                            ...
                            void 0 === n
                              ...
                              ? (function (e) {
                                  var n = Ne.exec(e._i);
                                  null === n
                                    ? (Z(e), !1 === e._isValid && (delete e._isValid, t.createFromInputFallback(e)))
                                    : (e._d = new Date(+n[1]));
                                })(e)
                              : i(n)
                              ? ((e._a = (function (e, t) {
          ...
          function ee(e, t, n, i, a) {
            ...
            return (
              ...
              (o._f = t),
              (o._strict = i),
              (s = new c(E(K(o))))._nextDay && (s.add(1, 'd'), (s._nextDay = void 0)),
              s
            );
          }
          function te(e, t, n, i) {
          ...
          function ne(e, t) {
            var n, a;
            if ((1 === t.length && i(t[0]) && (t = t[0]), !t.length)) return te();
            ...
            return (
              ae(e)
                ...
                : 'object' == typeof u &&
                  ...
                  o.isBefore(r)
                    ? (d = ce(o, r))
                    : (((d = ce(r, o)).milliseconds = -d.milliseconds), (d.months = -d.months)),
          ...
          function ye(e) {
            var t;
            return void 0 === e ? this._locale._abbr : (null != (t = L(e)) && (this._locale = t), this);
          }
          function Me() {
            return this._locale;
          }
          ...
          function Se(e, t, n, i, a) {
            var s, o;
            if (('number' == typeof e && ((t = e), (e = void 0)), (e = e || ''), null != t)) return Te(e, t, n, a);
          ...
          for (
            W('M', ['MM', 2], 'Mo', function () {
              ...
              Ke = 'Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday'.split('_'),
          ...
          return (
            ...
            (dt.diff = function (e, t, n) {
              ...
              return (
                'year' === (t = T(t)) || 'month' === t || 'quarter' === t
                  ? ((s = this),
                    (u = 12 * ((o = _).year() - s.year()) + (o.month() - s.month())),
                    (l = s.clone().add(u, 'months')),
                    o - l < 0
                      ? ((r = s.clone().add(u - 1, 'months')), (d = (o - l) / (l - r)))
                      : ((r = s.clone().add(u + 1, 'months')), (d = (o - l) / (r - l))),
                    (a = -(u + d)),
            ...
            (dt.isSame = function (e, t) {
              ...
              return 'millisecond' === (t = T(t || 'millisecond'))
                ? +this == +(e = m(e) ? e : te(e))
                : ((n = +te(e)), +this.clone().startOf(t) <= n && n <= +this.clone().endOf(t));
            }),
            (dt.isValid = function () {
              return u(this);
            }),
            ...
            (dt.weekYear = function (e) {
              var t = q(this, this.localeData()._week.dow, this.localeData()._week.doy).year;
            ...
            (dt.parseZone = function () {
              return (
                this._tzm ? this.utcOffset(this._tzm) : 'string' == typeof this._i && this.utcOffset(oe(this._i)), this
              );
            }),
            ...
            (dt.dates = j('dates accessor is deprecated. Use date instead.', Xe)),
            (dt.months = j('months accessor is deprecated. Use month instead', N)),
            (dt.years = j('years accessor is deprecated. Use year instead', Ee)),
            (dt.zone = j(
            ...
            Y('en', {
              ...
              ordinal: function (e) {
                var t = e % 10,
                  n = 1 === f((e % 100) / 10) ? 'th' : 1 === t ? 'st' : 2 === t ? 'nd' : 3 === t ? 'rd' : 'th';
                return e + n;
              },
            }),
            (t.lang = j('moment.lang is deprecated. Use moment.locale instead.', Y)),
            (t.langData = j('moment.langData is deprecated. Use moment.localeData instead.', L)),
            (Mt = Math.abs),
            (wt = He('ms')),
            (pt = He('s')),
            (Yt = He('m')),
            ...
            (Ct.as = function (e) {
              ...
              if ('month' === (e = T(e)) || 'year' === e)
                return (t = this._days + i / 864e5), (n = this._months + be(t)), 'month' === e ? n : n / 12;
            ...
            (t.relativeTimeThreshold = function (e, t) {
              return void 0 !== xt[e] && (void 0 === t ? xt[e] : ((xt[e] = t), !0));
            }),
            t
          );
        })();
