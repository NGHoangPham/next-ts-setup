    ...
    SIoL: function (e, t, n) {
        ...
        for (
          void 0 === t && (t = {}),
            ...
            w = (function (e, t, n, i) {
              ...
              for (
                l = Object(a.ensureNotNull)(void 0 !== n ? e.indexOf(n, !0) : e.firstIndex()),
                  s = Object(a.ensureNotNull)(void 0 !== i ? e.indexOf(i, !0) : e.lastIndex()),
                  o = s,
                  r = l,
                  d = 0,
                  f = t;
                ...
                (h = f[d]),
                  null !== (p = h.search(l, c.PlotRowSearchMode.NearestRight)) && p.index < o && (o = p.index),
                  null !== (w = h.search(s, c.PlotRowSearchMode.NearestLeft)) && w.index > r && (r = w.index);
              return Object(a.assert)(o <= r, 'Range must contain at least 1 time point'), new u.BarsRange(o, r);
            ...
            v = s.schema.length,
            i.includeSeries &&
              (s.schema.push(o('open')), s.schema.push(o('high')), s.schema.push(o('low')), s.schema.push(o('close'))),
            b = s.schema.length,
            O = [],
            x = 0,
            N = p;
          ...
          (y = l((T = N[x]))), O.push(y), (n = s.schema).push.apply(n, y.fields);
        if (0 === (P = s.schema.length)) return s;
        for (S = m; S <= g; ++S) (I = new Float64Array(P)).fill(NaN), s.data.push(I);
        if (i.includeTime) for (S = m; S <= g; ++S) s.data[S - m][0] = Object(a.ensureNotNull)(d.valueAt(S));
        for (
          i.includeSeries &&
            h
              .bars()
              ...
              .each(function (e, t) {
                var n = s.data[e - m];
                return (n[v] = r(t[1])), (n[v + 1] = r(t[2])), (n[v + 2] = r(t[3])), (n[v + 3] = r(t[4])), !1;
              }),
            j = 0;
          j < p.length;
          ++j
      ...
      function l(e) {
        ...
        for (t = 0; t < r.plots.length; ++t) {
          if (((n = r.plots[t]), (i = void 0), (l = ''), Object(d.isLinePlot)(n)))
